...
| --- | --- | --- | --- | --- |
| `context` | `./knowledge/context.md` | Knowledge | 1 per project | Original idea, problem framing, scope, coarse success. |
| `actors` | `./knowledge/actors.md` | Knowledge | 1 per project | Canonical identity of every person and system that participates in use cases. |
| `usecase` | `./usecase.md` (+ `-issue` / `-knowledge` side files) | Issue + knowledge | N per project | How an actor achieves a goal in a specific situation. |
| `nfr` | `./knowledge/nfr.md` | Knowledge | N per project | Non-functional targets. |
| `spec` | `./knowledge/spec.md` | Knowledge | N per project | Implementation contracts. |
| `domain` | `./knowledge/domain.md` | Knowledge | N per project | Shared vocabulary and concepts. |
