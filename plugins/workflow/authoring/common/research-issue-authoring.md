...
Common rules that apply across both sides (definition, dual-role overview, when research is warranted, decision neutrality) live in `./research-authoring.md`. Read that file in addition to this one.

Companion contracts:

- `./issue-body.md`
- Issue rules: `./issue-authoring.md`
- Research rules common to both sides: `./research-authoring.md`
...
- Do not store the final research deliverable only in the issue body when a knowledge backend is configured.
