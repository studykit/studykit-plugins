...
- `./issue-authoring.md`
- `./task-authoring.md` when the parent is task-shaped
- `./epic-authoring.md` when the parent is coordination-only
...
Use when the parent is coordination-only and the work matches one of the recognized epic scopes defined in `./epic-authoring.md`.
...
Layout: the parent is an `epic`; each member links with the `parent` relationship intent. See `./epic-authoring.md` for parent body rules.
