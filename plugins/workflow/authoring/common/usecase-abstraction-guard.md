...
Companion to `./usecase-authoring.md` § Abstraction discipline. That
...
provider markup — those live in `./usecase-issue-authoring.md`,
`./usecase-knowledge-authoring.md`, `./issue-body.md`,
`./knowledge-body.md`, and the provider convention files (each side
file lists its own body shape; the dual-role overview is in
`./usecase-authoring.md`). The guard polices only the abstraction
