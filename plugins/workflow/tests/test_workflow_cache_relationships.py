...
from issue_relationships import main as github_issue_relationships_main  # noqa: E402
...
def test_jira_relationships_cli_no_flag_returns_flat_no_op(tmp_path: Path) -> None:
    from issue_relationships import main as jira_issue_relationships_main  # noqa: E402
