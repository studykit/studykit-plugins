...
- `a014618` — moved per-type authoring guides (`spec-authoring.md`, `task-feature-authoring.md`, …) from `rules/` to `references/`.
...
- **Anything touching frontmatter or validators** → [`references/frontmatter-schema.md`](references/frontmatter-schema.md). The project-root [`CLAUDE.md`](../../CLAUDE.md) calls this out as a hard prerequisite.
