...
<project-root>/
  a4/
    ...
    adr/<id>-<slug>.md         # ADRs (status: draft | final | superseded)
...
- Forward-link fields (e.g., `task.implements:`, `task.adr:`) are user input but path-validated by `validate_frontmatter.py`.
