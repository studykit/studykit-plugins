...
> **Authoring contracts:** `a4/roadmap.md` — `${CLAUDE_PLUGIN_ROOT}/references/roadmap-authoring.md`. Per-task files (always `kind: feature`): `${CLAUDE_PLUGIN_ROOT}/references/task-feature-authoring.md`. This skill orchestrates the batch.
