...
| `--kind <value>` | review: finding/gap/question · wiki: context/domain/architecture/actors/nfr/bootstrap · issue family folders accept their own folder name (e.g. `--kind task` matches `a4/task/`) |
| `--id <int>` | numeric id |
