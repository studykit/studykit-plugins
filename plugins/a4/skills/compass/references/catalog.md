...
Mode rationale (why some stages have only an interactive or only an autonomous form, and why `auto-usecase` is not a twin of `usecase`): see [`skill-modes.md`](${CLAUDE_PLUGIN_ROOT}/docs/skill-modes.md).
