...
- Do not surface existing `a4/idea/` open count or nudge the user about prior ideas. Capture is capture; review is separate (`/a4:compass` or `/a4:dashboard` shows the open-idea count).
