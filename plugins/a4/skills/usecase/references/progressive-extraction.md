...
3. Write `a4/usecase/<N>-<slug>.md` per `../../../references/usecase-authoring.md`. Required body sections: `## Goal`, `## Situation`, `## Flow` (numbered list), `## Expected Outcome`. Optional: `## Validation`, `## Error Handling`, `## Dependencies`, `## Change Logs`, `## Log` (hand-maintained).
