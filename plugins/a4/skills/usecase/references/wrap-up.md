...
The usecase author primary-authors `context.md`, `actors.md`, and `nfr.md` (per `../../../dev/wiki-authorship.md`). When iteration uncovers an issue in `domain.md` or `architecture.md`, **continue** with usecase work and emit a review item targeting the upstream wiki — do not edit it inline.
