...
2. Record the screen-navigation narrative inside `context.md`'s `## Screens` section (creating the section if absent — it is optional per `authoring/context-authoring.md`), with markdown links back to the participating UCs.
