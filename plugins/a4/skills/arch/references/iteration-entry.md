...
Skill-specific addendum on top of the shared iterate mechanics in `../../../docs/iterate-mechanics.md`. Read that file first for filter / backlog presentation / writer call / footnote / discipline rules.
