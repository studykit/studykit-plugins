...
- `${CLAUDE_PLUGIN_ROOT}/authoring/frontmatter-common.md` (writer-owned fields, id allocation, path-form), `${CLAUDE_PLUGIN_ROOT}/authoring/body-conventions.md` (heading form, link form), and `${CLAUDE_PLUGIN_ROOT}/authoring/wiki-body.md` (`## Change Logs`, Wiki Update Protocol) — universal authoring contract for wiki pages.
