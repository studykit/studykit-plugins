...
- **`a4/` path** — absolute path to the workspace, so you can enumerate tasks (`ls a4/feature/*.md a4/bug/*.md a4/spike/*.md a4/research/*.md` — task files live under one of the four task-family folders), identify task-to-test mappings, and write review items into `a4/review/`.
