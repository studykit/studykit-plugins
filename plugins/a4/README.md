...
- **Issues** are lifecycle-tracked items in type-scoped folders. Each carries independent `status` and `labels` in frontmatter — "what's open?" is answerable without reading prose.
