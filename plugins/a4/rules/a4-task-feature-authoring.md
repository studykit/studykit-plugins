...
- `../references/task-feature-authoring.md` — purpose, smell check (empty anchors), frontmatter, lifecycle, body shape, complete-preflight, common mistakes, "Don't" list.
- `a4-workspace-policies.md` — workspace-wide policies (also auto-loaded).

## Skill / scripts / schema

- Single ad-hoc → `/a4:task` (skill: `../skills/task/SKILL.md`).
- UC-driven batch → `/a4:roadmap` (skill: `../skills/roadmap/SKILL.md`).
- Discard → `/a4:task discard <id-or-slug> [reason]` (procedure: `../skills/task/references/discard.md`).
...
- Sibling rules: `a4-task-bug-authoring.md`, `a4-task-spike-authoring.md`
