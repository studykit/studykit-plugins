...
- Socratic interview → `/a4:usecase` (skill: `../skills/usecase/SKILL.md`) — primary author for `context.md`, `actors.md`, `nfr.md` too.
- Forward-shape draft → `/a4:auto-usecase` (skill: `../skills/auto-usecase/SKILL.md`).
...
- Abstraction guard → `../skills/usecase/references/abstraction-guard.md`
- Splitting guide → `../skills/usecase/references/usecase-splitting.md`
