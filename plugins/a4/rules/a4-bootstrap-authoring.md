...
- [`../references/bootstrap-authoring.md`](../references/bootstrap-authoring.md) — purpose, single-writer rule, frontmatter, body shape (incl. why `<verify>` lives only here), common mistakes, "Don't" list.
- [`a4-workspace-policies.md`](a4-workspace-policies.md) — workspace-wide policies (also auto-loaded).

## Skill / scripts / schema

- Author / edit → `/a4:auto-bootstrap` (skill: [`../skills/auto-bootstrap/SKILL.md`](../skills/auto-bootstrap/SKILL.md)). Sole writer; re-runs archive prior copy.
