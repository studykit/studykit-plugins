...
- Single ad-hoc → `/a4:task` (skill: `../skills/task/SKILL.md`). No `/a4:roadmap` path.
- Discard → `/a4:task discard <id-or-slug> [reason]` (procedure: `../skills/task/references/discard.md`). Sidecar archive is a manual `git mv`.
...
- Sibling rules: `a4-task-feature-authoring.md`, `a4-task-bug-authoring.md`
