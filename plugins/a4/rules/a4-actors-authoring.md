...
- [`../references/actors-authoring.md`](../references/actors-authoring.md) — purpose, authorship (incl. `/a4:arch` system-actor allowance), frontmatter, body shape, slug discipline, common mistakes, "Don't" list.
...
- System-actor add → `/a4:arch` (skill: [`../skills/arch/SKILL.md`](../skills/arch/SKILL.md)).
