...
- [`../references/domain-authoring.md`](../references/domain-authoring.md) — purpose, authorship (incl. `/a4:arch` limited allowance), frontmatter, body shape, common mistakes, "Don't" list, after-authoring steps.
- [`a4-workspace-policies.md`](a4-workspace-policies.md) — workspace-wide policies (also auto-loaded).

## Skill / scripts / schema

- Author / edit → `/a4:domain` (skill: [`../skills/domain/SKILL.md`](../skills/domain/SKILL.md)) — primary author.
- Limited in-situ edits → `/a4:arch` (skill: [`../skills/arch/SKILL.md`](../skills/arch/SKILL.md)) — Phase 3 b3 decision table.
