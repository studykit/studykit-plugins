...
- Does **not** write `a4/domain.md`. Domain Model authorship belongs to `/a4:domain` (per `../wiki-authorship.md`). The final summary recommends running `/a4:domain` after auto-usecase finishes.
