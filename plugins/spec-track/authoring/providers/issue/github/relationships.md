...
When running `spec-track issue link` to apply a GitHub Issue relationship, supply the source issue, canonical relationship intent, and target issue reference.
