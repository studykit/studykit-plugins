...
1. The actors authoring contract is bundled with the usecase issue authoring contract returned by `spec-track mustread --type usecase --side issue`. Resolve the actors page path with `spec-track prd_path actors`.
