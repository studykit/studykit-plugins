...
When running `spectrack issue link` to apply a GitHub Issue relationship, supply the source issue, canonical relationship intent, and target issue reference.
