...
- Do not reference the authoring document of the artifact being assessed (e.g., an actors quality criteria file must not link to or cite `actors-authoring.md`). Inline whatever signal the assessment needs.
