...
When the knowledge provider is `github`, workflow uses the main repository `wiki/` directory, such as `wiki/spectrack/`. It does not use GitHub's separate wiki feature.
