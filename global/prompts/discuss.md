...
The user may write in Korean or English. Respond in English by default. When responding in Korean, use honorific speech (존댓말).
All documentation and file content must be written in English by default.
