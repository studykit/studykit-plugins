...
- Plugin-owned normalized environment contracts, such as workflow's `SPECTRACK_*` values, may be read by script entrypoints as defaults, but deeper shared logic should still receive concrete values.
