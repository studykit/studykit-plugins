...
"namedViews\_var" is a variable referencing a NamedViews object. ```` ``` #include <Core/Application/NamedViews.h>  // Get the value of the property. Ptr<NamedView> propertyValue = namedViews_var->rightNamedView(); ``` ```` |
