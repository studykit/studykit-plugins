# MeshCombineFaceGroupsFeature.baseFeature Property![](../images/TestTubeLarge.png)
...
"meshCombineFaceGroupsFeature\_var" is a variable referencing a MeshCombineFaceGroupsFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFaceGroupsFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = meshCombineFaceGroupsFeature_var->baseFeature(); ``` ```` |
