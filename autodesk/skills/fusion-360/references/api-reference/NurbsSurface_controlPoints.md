# NurbsSurface.controlPoints Property
...
"nurbsSurface\_var" is a variable referencing a NurbsSurface object. ```` ``` #include <Core/Geometry/NurbsSurface.h>  // Get the value of the property. std::vector<Ptr<Point3D>> propertyValue = nurbsSurface_var->controlPoints(); ``` ```` |
