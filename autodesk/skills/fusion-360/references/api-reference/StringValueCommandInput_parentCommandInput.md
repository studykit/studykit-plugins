# StringValueCommandInput.parentCommandInput Property
...
"stringValueCommandInput\_var" is a variable referencing a StringValueCommandInput object. ```` ``` #include <Core/UserInterface/StringValueCommandInput.h>  // Get the value of the property. Ptr<CommandInput> propertyValue = stringValueCommandInput_var->parentCommandInput(); ``` ```` |
