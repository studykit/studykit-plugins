...
"offsetFacesFeature\_var" is a variable referencing an OffsetFacesFeature object. ```` ``` #include <Fusion/Features/OffsetFacesFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = offsetFacesFeature_var->linkedFeatures(); ``` ```` |
