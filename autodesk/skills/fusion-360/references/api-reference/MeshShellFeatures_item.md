# MeshShellFeatures.item Method![](../images/TestTubeLarge.png)
...
"meshShellFeatures\_var" is a variable referencing a [MeshShellFeatures](MeshShellFeatures.htm) object.```` ``` returnValue = meshShellFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshShellFeature](MeshShellFeature.htm) | Returns the specified item or null if an invalid index was specified. |
