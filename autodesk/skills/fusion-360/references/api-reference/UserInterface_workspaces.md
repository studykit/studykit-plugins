# UserInterface.workspaces Property
...
"userInterface\_var" is a variable referencing a UserInterface object. ```` ``` #include <Core/UserInterface/UserInterface.h>  // Get the value of the property. Ptr<Workspaces> propertyValue = userInterface_var->workspaces(); ``` ```` |

## Property Value

This is a read only property whose value is a [Workspaces](Workspaces.htm).
