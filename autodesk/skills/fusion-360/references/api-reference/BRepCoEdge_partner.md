...
"bRepCoEdge\_var" is a variable referencing a BRepCoEdge object. ```` ``` #include <Fusion/BRep/BRepCoEdge.h>  // Get the value of the property. Ptr<BRepCoEdge> propertyValue = bRepCoEdge_var->partner(); ``` ```` |
