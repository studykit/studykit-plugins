# Graph.connect Method![](../images/TestTubeLarge.png)
...
"graph\_var" is a variable referencing a [Graph](Graph.htm) object.```` ``` returnValue = graph_var.connect(outputNode, outputPinIndex, inputNode, inputPinIndex) ``` ```` |
