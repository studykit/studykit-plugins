...
"splitFaceFeature\_var" is a variable referencing a SplitFaceFeature object. ```` ``` #include <Fusion/Features/SplitFaceFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = splitFaceFeature_var->assemblyContext(); ``` ```` |
