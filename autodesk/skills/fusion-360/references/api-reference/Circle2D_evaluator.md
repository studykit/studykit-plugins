...
"circle2D\_var" is a variable referencing a Circle2D object. ```` ``` #include <Core/Geometry/Circle2D.h>  // Get the value of the property. Ptr<CurveEvaluator2D> propertyValue = circle2D_var->evaluator(); ``` ```` |
