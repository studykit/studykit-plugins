...
"sketchDiameterDimension\_var" is a variable referencing a SketchDiameterDimension object. ```` ``` #include <Fusion/Sketch/SketchDiameterDimension.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchDiameterDimension_var->assemblyContext(); ``` ```` |
