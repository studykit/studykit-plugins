...
"bRepWire\_var" is a variable referencing a BRepWire object. ```` ``` #include <Fusion/BRep/BRepWire.h>  // Get the value of the property. Ptr<BRepVertices> propertyValue = bRepWire_var->vertices(); ``` ```` |
