# CustomFeatureParameter.valueType Property![](../images/TestTubeLarge.png)
...
"customFeatureParameter\_var" is a variable referencing a CustomFeatureParameter object. ```` ``` #include <Fusion/Features/CustomFeatureParameter.h>  // Get the value of the property. ParameterValueTypes propertyValue = customFeatureParameter_var->valueType(); ``` ```` |
