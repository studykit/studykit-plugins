# SketchConcentricCircleDimension.textPosition Property
...
"sketchConcentricCircleDimension\_var" is a variable referencing a SketchConcentricCircleDimension object. ```` ``` #include <Fusion/Sketch/SketchConcentricCircleDimension.h>  // Get the value of the property. Ptr<Point3D> propertyValue = sketchConcentricCircleDimension_var->textPosition();  // Set the value of the property, where value_var is a Point3D. bool returnValue = sketchConcentricCircleDimension_var->textPosition(value_var); ``` ```` |
