# MeshReduceFeatures.createInput Method![](../images/TestTubeLarge.png)
...
"meshReduceFeatures\_var" is a variable referencing a [MeshReduceFeatures](MeshReduceFeatures.htm) object.```` ``` returnValue = meshReduceFeatures_var.createInput(mesh) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshReduceFeatureInput](MeshReduceFeatureInput.htm) | Returns the newly created MeshReduceFeatureInput object or null if the creation failed. |
