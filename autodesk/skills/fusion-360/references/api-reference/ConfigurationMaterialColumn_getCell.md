...
"configurationMaterialColumn\_var" is a variable referencing a [ConfigurationMaterialColumn](ConfigurationMaterialColumn.htm) object.```` ``` returnValue = configurationMaterialColumn_var.getCell(rowIndex) ``` ```` |
...
| --- | --- |
| Type | Description |
| [ConfigurationMaterialCell](ConfigurationMaterialCell.htm) | Returns the specified cell if successful and null if an invalid index was specified. |
