...
"concentricConstraint\_var" is a variable referencing a ConcentricConstraint object. ```` ``` #include <Fusion/Sketch/ConcentricConstraint.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = concentricConstraint_var->assemblyContext(); ``` ```` |
