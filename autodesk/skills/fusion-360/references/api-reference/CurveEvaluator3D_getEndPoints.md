...
| startPoint | [Point3D](Point3D.htm) | The output start point of the curve. If the curve is unbounded at the start, this value will be null. |
| endPoint | [Point3D](Point3D.htm) | The output end point of the curve. If the curve is unbounded at the end, this value will be null. |
