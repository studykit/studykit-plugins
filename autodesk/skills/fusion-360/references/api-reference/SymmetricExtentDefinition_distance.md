...
"symmetricExtentDefinition\_var" is a variable referencing a SymmetricExtentDefinition object. ```` ``` #include <Fusion/Features/SymmetricExtentDefinition.h>  // Get the value of the property. Ptr<Base> propertyValue = symmetricExtentDefinition_var->distance(); ``` ```` |
