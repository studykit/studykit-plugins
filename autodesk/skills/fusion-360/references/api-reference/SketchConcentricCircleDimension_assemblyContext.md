...
"sketchConcentricCircleDimension\_var" is a variable referencing a SketchConcentricCircleDimension object. ```` ``` #include <Fusion/Sketch/SketchConcentricCircleDimension.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchConcentricCircleDimension_var->assemblyContext(); ``` ```` |
