...
"dataEvent\_var" is a variable referencing a DataEvent object. ```` ``` #include <Core/Dashboard/DataEvent.h>  // Get the value of the property. boolean propertyValue = dataEvent_var->isValid(); ``` ```` |
