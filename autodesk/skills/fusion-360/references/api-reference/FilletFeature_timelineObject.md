...
"filletFeature\_var" is a variable referencing a FilletFeature object. ```` ``` #include <Fusion/Features/FilletFeature.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = filletFeature_var->timelineObject(); ``` ```` |
