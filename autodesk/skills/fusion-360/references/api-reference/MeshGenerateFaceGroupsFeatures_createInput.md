# MeshGenerateFaceGroupsFeatures.createInput Method![](../images/TestTubeLarge.png)
...
"meshGenerateFaceGroupsFeatures\_var" is a variable referencing a [MeshGenerateFaceGroupsFeatures](MeshGenerateFaceGroupsFeatures.htm) object.```` ``` returnValue = meshGenerateFaceGroupsFeatures_var.createInput(mesh) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshGenerateFaceGroupsFeatureInput](MeshGenerateFaceGroupsFeatureInput.htm) | Returns the newly created MeshGenerateFaceGroupsFeatureInput object or null if the creation failed. |
