...
"filletFeature\_var" is a variable referencing a FilletFeature object. ```` ``` #include <Fusion/Features/FilletFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = filletFeature_var->linkedFeatures(); ``` ```` |
