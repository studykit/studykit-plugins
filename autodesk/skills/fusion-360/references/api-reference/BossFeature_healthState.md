# BossFeature.healthState Property
...
"bossFeature\_var" is a variable referencing a BossFeature object. ```` ``` #include <Fusion/Plastic/BossFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = bossFeature_var->healthState(); ``` ```` |
