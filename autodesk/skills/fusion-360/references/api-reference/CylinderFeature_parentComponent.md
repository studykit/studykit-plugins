# CylinderFeature.parentComponent Property
...
"cylinderFeature\_var" is a variable referencing a CylinderFeature object. ```` ``` #include <Fusion/Features/CylinderFeature.h>  // Get the value of the property. Ptr<Component> propertyValue = cylinderFeature_var->parentComponent(); ``` ```` |
