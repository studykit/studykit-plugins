...
"arrange3DEnvelopeInput\_var" is a variable referencing an Arrange3DEnvelopeInput object. ```` ``` #include <Fusion/Arrange/Arrange3DEnvelopeInput.h>  // Get the value of the property. boolean propertyValue = arrange3DEnvelopeInput_var->isPartialArrangeAllowed();  // Set the value of the property, where value_var is a boolean. bool returnValue = arrange3DEnvelopeInput_var->isPartialArrangeAllowed(value_var); ``` ```` |
