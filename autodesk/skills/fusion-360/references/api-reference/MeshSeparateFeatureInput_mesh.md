# MeshSeparateFeatureInput.mesh Property![](../images/TestTubeLarge.png)
...
"meshSeparateFeatureInput\_var" is a variable referencing a MeshSeparateFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshSeparateFeatureInput.h>  // Get the value of the property. Ptr<Base> propertyValue = meshSeparateFeatureInput_var->mesh();  // Set the value of the property, where value_var is a Base. bool returnValue = meshSeparateFeatureInput_var->mesh(value_var); ``` ```` |
