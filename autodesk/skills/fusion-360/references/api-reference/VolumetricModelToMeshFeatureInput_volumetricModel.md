# VolumetricModelToMeshFeatureInput.volumetricModel Property![](../images/TestTubeLarge.png)
...
"volumetricModelToMeshFeatureInput\_var" is a variable referencing a VolumetricModelToMeshFeatureInput object. ```` ``` #include <Fusion/Features/VolumetricModelToMeshFeatureInput.h>  // Get the value of the property. Ptr<Base> propertyValue = volumetricModelToMeshFeatureInput_var->volumetricModel();  // Set the value of the property, where value_var is a Base. bool returnValue = volumetricModelToMeshFeatureInput_var->volumetricModel(value_var); ``` ```` |
