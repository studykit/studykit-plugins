# MeshCombineFeature.assemblyContext Property![](../images/TestTubeLarge.png)
...
"meshCombineFeature\_var" is a variable referencing a MeshCombineFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = meshCombineFeature_var->assemblyContext(); ``` ```` |
