# UserParameter.userParameters Property
...
"userParameter\_var" is a variable referencing a UserParameter object. ```` ``` #include <Fusion/Fusion/UserParameter.h>  // Get the value of the property. Ptr<UserParameters> propertyValue = userParameter_var->userParameters(); ``` ```` |
