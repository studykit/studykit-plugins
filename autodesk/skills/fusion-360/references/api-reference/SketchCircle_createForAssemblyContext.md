...
"sketchCircle\_var" is a variable referencing a [SketchCircle](SketchCircle.htm) object.```` ``` returnValue = sketchCircle_var.createForAssemblyContext(occurrence) ``` ```` |
...
| --- | --- |
| Type | Description |
| [SketchCircle](SketchCircle.htm) | Returns the proxy object or null if this isn't the NativeObject. |
