...
"perpendicularToSurfaceConstraint\_var" is a variable referencing a PerpendicularToSurfaceConstraint object. ```` ``` #include <Fusion/Sketch/PerpendicularToSurfaceConstraint.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = perpendicularToSurfaceConstraint_var->assemblyContext(); ``` ```` |
