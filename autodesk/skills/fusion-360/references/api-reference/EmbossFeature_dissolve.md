# EmbossFeature.dissolve Method![](../images/TestTubeLarge.png)
...
"embossFeature\_var" is a variable referencing an [EmbossFeature](EmbossFeature.htm) object.```` ``` returnValue = embossFeature_var.dissolve() ``` ```` |
