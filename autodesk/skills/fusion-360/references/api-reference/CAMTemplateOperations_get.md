# CAMTemplateOperations.get Method![](../images/TestTubeLarge.png)
...
"cAMTemplateOperations\_var" is a variable referencing a [CAMTemplateOperations](CAMTemplateOperations.htm) object.```` ``` returnValue = cAMTemplateOperations_var.get(operationIndex) ``` ```` |
