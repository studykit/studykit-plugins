...
"path\_var" is a variable referencing a Path object. ```` ``` #include <Fusion/Features/Path.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = path_var->assemblyContext(); ``` ```` |
