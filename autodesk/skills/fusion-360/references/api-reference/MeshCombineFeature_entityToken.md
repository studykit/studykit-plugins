# MeshCombineFeature.entityToken Property![](../images/TestTubeLarge.png)
...
"meshCombineFeature\_var" is a variable referencing a MeshCombineFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFeature.h>  // Get the value of the property. string propertyValue = meshCombineFeature_var->entityToken(); ``` ```` |
