# Design.libraryPlasticRules Property
...
"design\_var" is a variable referencing a Design object. ```` ``` #include <Fusion/Fusion/Design.h>  // Get the value of the property. Ptr<PlasticRules> propertyValue = design_var->libraryPlasticRules(); ``` ```` |
