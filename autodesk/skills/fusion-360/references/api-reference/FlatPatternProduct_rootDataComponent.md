# FlatPatternProduct.rootDataComponent Property![](../images/TestTubeLarge.png)
...
"flatPatternProduct\_var" is a variable referencing a FlatPatternProduct object. ```` ``` #include <Fusion/SheetMetal/FlatPatternProduct.h>  // Get the value of the property. Ptr<DataComponent> propertyValue = flatPatternProduct_var->rootDataComponent(); ``` ```` |
