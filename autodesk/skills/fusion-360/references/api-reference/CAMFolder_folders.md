...
"cAMFolder\_var" is a variable referencing a CAMFolder object. ```` ``` #include <Cam/CAM/CAMFolder.h>  // Get the value of the property. Ptr<CAMFolders> propertyValue = cAMFolder_var->folders(); ``` ```` |
