# NurbsSurface.knotCountU Property
...
"nurbsSurface\_var" is a variable referencing a NurbsSurface object. ```` ``` #include <Core/Geometry/NurbsSurface.h>  // Get the value of the property. integer propertyValue = nurbsSurface_var->knotCountU(); ``` ```` |
