# EmbossFeature.horizontalDistance Property![](../images/TestTubeLarge.png)
...
"embossFeature\_var" is a variable referencing an EmbossFeature object. ```` ``` #include <Fusion/Features/EmbossFeature.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = embossFeature_var->horizontalDistance(); ``` ```` |
