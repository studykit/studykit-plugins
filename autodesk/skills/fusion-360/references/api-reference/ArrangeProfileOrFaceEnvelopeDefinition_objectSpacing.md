# ArrangeProfileOrFaceEnvelopeDefinition.objectSpacing Property
...
"arrangeProfileOrFaceEnvelopeDefinition\_var" is a variable referencing an ArrangeProfileOrFaceEnvelopeDefinition object. ```` ``` #include <Fusion/Arrange/ArrangeProfileOrFaceEnvelopeDefinition.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = arrangeProfileOrFaceEnvelopeDefinition_var->objectSpacing(); ``` ```` |
