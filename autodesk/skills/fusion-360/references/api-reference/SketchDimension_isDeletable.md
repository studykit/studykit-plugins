# SketchDimension.isDeletable Property
...
"sketchDimension\_var" is a variable referencing a SketchDimension object. ```` ``` #include <Fusion/Sketch/SketchDimension.h>  // Get the value of the property. boolean propertyValue = sketchDimension_var->isDeletable(); ``` ```` |
