# CAMLibrary.doesPathExist Method![](../images/TestTubeLarge.png)
...
"cAMLibrary\_var" is a variable referencing a [CAMLibrary](CAMLibrary.htm) object.```` ``` returnValue = cAMLibrary_var.doesPathExist(url) ``` ```` |
