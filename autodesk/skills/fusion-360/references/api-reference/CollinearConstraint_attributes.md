# CollinearConstraint.attributes Property
...
"collinearConstraint\_var" is a variable referencing a CollinearConstraint object. ```` ``` #include <Fusion/Sketch/CollinearConstraint.h>  // Get the value of the property. Ptr<Attributes> propertyValue = collinearConstraint_var->attributes(); ``` ```` |
