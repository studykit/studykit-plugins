...
"throughAllExtentDefinition\_var" is a variable referencing a ThroughAllExtentDefinition object. |

"throughAllExtentDefinition\_var" is a variable referencing a ThroughAllExtentDefinition object. ```` ``` #include <Fusion/Features/ThroughAllExtentDefinition.h>  // Get the value of the property. Ptr<Feature> propertyValue = throughAllExtentDefinition_var->parentFeature(); ``` ```` |
