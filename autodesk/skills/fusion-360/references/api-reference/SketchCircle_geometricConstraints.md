# SketchCircle.geometricConstraints Property
...
"sketchCircle\_var" is a variable referencing a SketchCircle object. ```` ``` #include <Fusion/Sketch/SketchCircle.h>  // Get the value of the property. Ptr<GeometricConstraintList> propertyValue = sketchCircle_var->geometricConstraints(); ``` ```` |
