...
"sketchControlPointSpline\_var" is a variable referencing a SketchControlPointSpline object. ```` ``` #include <Fusion/Sketch/SketchControlPointSpline.h>  // Get the value of the property. boolean propertyValue = sketchControlPointSpline_var->isConstruction();  // Set the value of the property, where value_var is a boolean. bool returnValue = sketchControlPointSpline_var->isConstruction(value_var); ``` ```` |
