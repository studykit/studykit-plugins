# MeshSeparateFeature.baseFeature Property![](../images/TestTubeLarge.png)
...
"meshSeparateFeature\_var" is a variable referencing a MeshSeparateFeature object. ```` ``` #include <Fusion/MeshBody/MeshSeparateFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = meshSeparateFeature_var->baseFeature(); ``` ```` |
