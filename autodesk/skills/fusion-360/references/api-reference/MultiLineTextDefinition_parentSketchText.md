...
"multiLineTextDefinition\_var" is a variable referencing a MultiLineTextDefinition object. ```` ``` #include <Fusion/Sketch/MultiLineTextDefinition.h>  // Get the value of the property. Ptr<SketchText> propertyValue = multiLineTextDefinition_var->parentSketchText(); ``` ```` |
