...
"timelineObject\_var" is a variable referencing a TimelineObject object. ```` ``` #include <Fusion/Fusion/TimelineObject.h>  // Get the value of the property. string propertyValue = timelineObject_var->errorOrWarningMessage(); ``` ```` |
