# MeshCombineFaceGroupsFeature.entityToken Property![](../images/TestTubeLarge.png)
...
"meshCombineFaceGroupsFeature\_var" is a variable referencing a MeshCombineFaceGroupsFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFaceGroupsFeature.h>  // Get the value of the property. string propertyValue = meshCombineFaceGroupsFeature_var->entityToken(); ``` ```` |
