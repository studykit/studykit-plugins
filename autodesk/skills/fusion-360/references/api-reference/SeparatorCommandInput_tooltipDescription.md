# SeparatorCommandInput.tooltipDescription Property
...
"separatorCommandInput\_var" is a variable referencing a SeparatorCommandInput object. ```` ``` #include <Core/UserInterface/SeparatorCommandInput.h>  // Get the value of the property. string propertyValue = separatorCommandInput_var->tooltipDescription();  // Set the value of the property, where value_var is a string. bool returnValue = separatorCommandInput_var->tooltipDescription(value_var); ``` ```` |
