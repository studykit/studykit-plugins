...
"replaceFaceFeature\_var" is a variable referencing a ReplaceFaceFeature object. ```` ``` #include <Fusion/Features/ReplaceFaceFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = replaceFaceFeature_var->baseFeature(); ``` ```` |
