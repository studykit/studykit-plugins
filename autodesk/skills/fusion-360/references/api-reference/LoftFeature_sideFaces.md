...
"loftFeature\_var" is a variable referencing a LoftFeature object. ```` ``` #include <Fusion/Features/LoftFeature.h>  // Get the value of the property. Ptr<BRepFaces> propertyValue = loftFeature_var->sideFaces(); ``` ```` |
