# NurbsCurve3D.evaluator Property
...
"nurbsCurve3D\_var" is a variable referencing a NurbsCurve3D object. ```` ``` #include <Core/Geometry/NurbsCurve3D.h>  // Get the value of the property. Ptr<CurveEvaluator3D> propertyValue = nurbsCurve3D_var->evaluator(); ``` ```` |
