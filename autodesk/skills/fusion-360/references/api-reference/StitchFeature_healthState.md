# StitchFeature.healthState Property
...
"stitchFeature\_var" is a variable referencing a StitchFeature object. ```` ``` #include <Fusion/Features/StitchFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = stitchFeature_var->healthState(); ``` ```` |
