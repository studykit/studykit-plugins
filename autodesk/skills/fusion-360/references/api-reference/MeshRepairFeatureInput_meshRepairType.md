# MeshRepairFeatureInput.meshRepairType Property![](../images/TestTubeLarge.png)
...
"meshRepairFeatureInput\_var" is a variable referencing a MeshRepairFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshRepairFeatureInput.h>  // Get the value of the property. MeshRepairTypes propertyValue = meshRepairFeatureInput_var->meshRepairType();  // Set the value of the property, where value_var is a MeshRepairTypes. bool returnValue = meshRepairFeatureInput_var->meshRepairType(value_var); ``` ```` |

## Property Value

This is a read/write property whose value is a [MeshRepairTypes](MeshRepairTypes.htm).
