...
"configurationVisibilityColumn\_var" is a variable referencing a [ConfigurationVisibilityColumn](ConfigurationVisibilityColumn.htm) object.```` ``` returnValue = configurationVisibilityColumn_var.getCellByRowName(rowName) ``` ```` |
...
| --- | --- |
| Type | Description |
| [ConfigurationVisibilityCell](ConfigurationVisibilityCell.htm) | Returns the specified cell if successful and null if the name is not found. |
