# VolumetricSample.point Property![](../images/TestTubeLarge.png)
...
"volumetricSample\_var" is a variable referencing a VolumetricSample object. ```` ``` #include <Volume/Volumetric/VolumetricSample.h>  // Get the value of the property. Ptr<Point3D> propertyValue = volumetricSample_var->point(); ``` ```` |
