# MeshCombineFeature.healthState Property![](../images/TestTubeLarge.png)
...
"meshCombineFeature\_var" is a variable referencing a MeshCombineFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = meshCombineFeature_var->healthState(); ``` ```` |
