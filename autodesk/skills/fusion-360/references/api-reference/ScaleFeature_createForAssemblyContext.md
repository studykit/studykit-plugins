...
"scaleFeature\_var" is a variable referencing a [ScaleFeature](ScaleFeature.htm) object.```` ``` returnValue = scaleFeature_var.createForAssemblyContext(occurrence) ``` ```` |
...
| --- | --- |
| Type | Description |
| [ScaleFeature](ScaleFeature.htm) | Returns the proxy object or null if this isn't the NativeObject. |
