...
"verticalConstraint\_var" is a variable referencing a VerticalConstraint object. ```` ``` #include <Fusion/Sketch/VerticalConstraint.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = verticalConstraint_var->assemblyContext(); ``` ```` |
