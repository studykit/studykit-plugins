# MeshCombineFaceGroupsFeatures.item Method![](../images/TestTubeLarge.png)
...
"meshCombineFaceGroupsFeatures\_var" is a variable referencing a [MeshCombineFaceGroupsFeatures](MeshCombineFaceGroupsFeatures.htm) object.```` ``` returnValue = meshCombineFaceGroupsFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshCombineFaceGroupsFeature](MeshCombineFaceGroupsFeature.htm) | Returns the specified item or null if an invalid index was specified. |
