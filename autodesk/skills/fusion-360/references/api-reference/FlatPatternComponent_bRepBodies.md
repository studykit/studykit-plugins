# FlatPatternComponent.bRepBodies Property
...
"flatPatternComponent\_var" is a variable referencing a FlatPatternComponent object. ```` ``` #include <Fusion/SheetMetal/FlatPatternComponent.h>  // Get the value of the property. Ptr<BRepBodies> propertyValue = flatPatternComponent_var->bRepBodies(); ``` ```` |
