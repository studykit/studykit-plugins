# FaceGroup.centroid Property![](../images/TestTubeLarge.png)
...
"faceGroup\_var" is a variable referencing a FaceGroup object. ```` ``` #include <Fusion/MeshBody/FaceGroup.h>  // Get the value of the property. Ptr<Point3D> propertyValue = faceGroup_var->centroid(); ``` ```` |
