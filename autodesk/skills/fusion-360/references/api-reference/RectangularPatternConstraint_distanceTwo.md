# RectangularPatternConstraint.distanceTwo Property
...
"rectangularPatternConstraint\_var" is a variable referencing a RectangularPatternConstraint object. ```` ``` #include <Fusion/Sketch/RectangularPatternConstraint.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = rectangularPatternConstraint_var->distanceTwo(); ``` ```` |
