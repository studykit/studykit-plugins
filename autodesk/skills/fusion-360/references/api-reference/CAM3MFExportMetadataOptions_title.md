# CAM3MFExportMetadataOptions.title Property
...
"cAM3MFExportMetadataOptions\_var" is a variable referencing a CAM3MFExportMetadataOptions object. ```` ``` #include <Cam/CAM/CAM3MFExportMetadataOptions.h>  // Get the value of the property. string propertyValue = cAM3MFExportMetadataOptions_var->title();  // Set the value of the property, where value_var is a string. bool returnValue = cAM3MFExportMetadataOptions_var->title(value_var); ``` ```` |
