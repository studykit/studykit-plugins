# GeometricRelationship.isSuppressed Property![](../images/TestTubeLarge.png)
...
"geometricRelationship\_var" is a variable referencing a GeometricRelationship object. ```` ``` #include <Fusion/Components/GeometricRelationship.h>  // Get the value of the property. boolean propertyValue = geometricRelationship_var->isSuppressed();  // Set the value of the property, where value_var is a boolean. bool returnValue = geometricRelationship_var->isSuppressed(value_var); ``` ```` |
