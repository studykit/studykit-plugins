# MeshSmoothFeatures.item Method![](../images/TestTubeLarge.png)
...
"meshSmoothFeatures\_var" is a variable referencing a [MeshSmoothFeatures](MeshSmoothFeatures.htm) object.```` ``` returnValue = meshSmoothFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshSmoothFeature](MeshSmoothFeature.htm) | Returns the specified item or null if an invalid index was specified. |
