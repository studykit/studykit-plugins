# MeshRemeshFeature.linkedFeatures Property![](../images/TestTubeLarge.png)
...
"meshRemeshFeature\_var" is a variable referencing a MeshRemeshFeature object. ```` ``` #include <Fusion/MeshBody/MeshRemeshFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = meshRemeshFeature_var->linkedFeatures(); ``` ```` |
