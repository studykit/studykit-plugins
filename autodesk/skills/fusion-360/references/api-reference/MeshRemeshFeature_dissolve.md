# MeshRemeshFeature.dissolve Method![](../images/TestTubeLarge.png)
...
"meshRemeshFeature\_var" is a variable referencing a [MeshRemeshFeature](MeshRemeshFeature.htm) object.```` ``` returnValue = meshRemeshFeature_var.dissolve() ``` ```` |
