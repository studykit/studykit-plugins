...
"mouseEventArgs\_var" is a variable referencing a MouseEventArgs object. ```` ``` #include <Core/UserInterface/MouseEventArgs.h>  // Get the value of the property. KeyboardModifiers propertyValue = mouseEventArgs_var->keyboardModifiers(); ``` ```` |

## Property Value

This is a read only property whose value is a [KeyboardModifiers](KeyboardModifiers.htm).
