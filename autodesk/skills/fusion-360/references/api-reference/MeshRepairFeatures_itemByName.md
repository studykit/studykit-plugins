# MeshRepairFeatures.itemByName Method![](../images/TestTubeLarge.png)
...
"meshRepairFeatures\_var" is a variable referencing a [MeshRepairFeatures](MeshRepairFeatures.htm) object.```` ``` returnValue = meshRepairFeatures_var.itemByName(name) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshRepairFeature](MeshRepairFeature.htm) | Returns the specified item or null if the specified name was not found. |
