# InteractionsMachineElement.resetMachineInteractionPairs Method![](../images/TestTubeLarge.png)
...
"interactionsMachineElement\_var" is a variable referencing an [InteractionsMachineElement](InteractionsMachineElement.htm) object.```` ``` returnValue = interactionsMachineElement_var.resetMachineInteractionPairs() ``` ```` |
