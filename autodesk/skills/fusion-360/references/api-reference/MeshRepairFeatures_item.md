# MeshRepairFeatures.item Method![](../images/TestTubeLarge.png)
...
"meshRepairFeatures\_var" is a variable referencing a [MeshRepairFeatures](MeshRepairFeatures.htm) object.```` ``` returnValue = meshRepairFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshRepairFeature](MeshRepairFeature.htm) | Returns the specified item or null if an invalid index was specified. |
