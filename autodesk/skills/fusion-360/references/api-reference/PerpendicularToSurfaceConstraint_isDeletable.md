# PerpendicularToSurfaceConstraint.isDeletable Property
...
"perpendicularToSurfaceConstraint\_var" is a variable referencing a PerpendicularToSurfaceConstraint object. ```` ``` #include <Fusion/Sketch/PerpendicularToSurfaceConstraint.h>  // Get the value of the property. boolean propertyValue = perpendicularToSurfaceConstraint_var->isDeletable(); ``` ```` |
