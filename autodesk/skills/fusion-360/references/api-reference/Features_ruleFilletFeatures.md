...
"features\_var" is a variable referencing a Features object. ```` ``` #include <Fusion/Features/Features.h>  // Get the value of the property. Ptr<RuleFilletFeatures> propertyValue = features_var->ruleFilletFeatures(); ``` ```` |

## Property Value

This is a read only property whose value is a [RuleFilletFeatures](RuleFilletFeatures.htm).
