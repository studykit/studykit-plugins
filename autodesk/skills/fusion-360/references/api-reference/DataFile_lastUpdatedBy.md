# DataFile.lastUpdatedBy Property
...
"dataFile\_var" is a variable referencing a DataFile object. ```` ``` #include <Core/Dashboard/DataFile.h>  // Get the value of the property. Ptr<User> propertyValue = dataFile_var->lastUpdatedBy(); ``` ```` |
