...
"geometricConstraint\_var" is a variable referencing a GeometricConstraint object. ```` ``` #include <Fusion/Sketch/GeometricConstraint.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = geometricConstraint_var->assemblyContext(); ``` ```` |
