...
"flatPatternComponent\_var" is a variable referencing a [FlatPatternComponent](FlatPatternComponent.htm) object.```` ``` returnValue = flatPatternComponent_var.transformOccurrences(occurrences, transforms, ignoreJoints) ``` ```` |
