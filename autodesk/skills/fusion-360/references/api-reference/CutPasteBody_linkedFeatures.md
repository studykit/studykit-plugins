...
"cutPasteBody\_var" is a variable referencing a CutPasteBody object. ```` ``` #include <Fusion/Features/CutPasteBody.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = cutPasteBody_var->linkedFeatures(); ``` ```` |
