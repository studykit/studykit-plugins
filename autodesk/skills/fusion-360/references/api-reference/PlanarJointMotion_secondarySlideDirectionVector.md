...
"planarJointMotion\_var" is a variable referencing a PlanarJointMotion object. ```` ``` #include <Fusion/Components/PlanarJointMotion.h>  // Get the value of the property. Ptr<Vector3D> propertyValue = planarJointMotion_var->secondarySlideDirectionVector(); ``` ```` |
