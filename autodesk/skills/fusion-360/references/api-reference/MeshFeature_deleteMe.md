# MeshFeature.deleteMe Method![](../images/TestTubeLarge.png)
...
"meshFeature\_var" is a variable referencing a [MeshFeature](MeshFeature.htm) object.```` ``` returnValue = meshFeature_var.deleteMe() ``` ```` |
