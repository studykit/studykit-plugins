# RectangularPatternFeature.quantityOne Property
...
"rectangularPatternFeature\_var" is a variable referencing a RectangularPatternFeature object. ```` ``` #include <Fusion/Features/RectangularPatternFeature.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = rectangularPatternFeature_var->quantityOne(); ``` ```` |
