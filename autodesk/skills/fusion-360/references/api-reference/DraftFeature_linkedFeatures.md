...
"draftFeature\_var" is a variable referencing a DraftFeature object. ```` ``` #include <Fusion/Features/DraftFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = draftFeature_var->linkedFeatures(); ``` ```` |
