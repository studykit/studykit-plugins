# VolumetricModel.removeCustomSDFCallback Method![](../images/TestTubeLarge.png)
...
"volumetricModel\_var" is a variable referencing a [VolumetricModel](VolumetricModel.htm) object.```` ``` returnValue = volumetricModel_var.removeCustomSDFCallback(id) ``` ```` |
