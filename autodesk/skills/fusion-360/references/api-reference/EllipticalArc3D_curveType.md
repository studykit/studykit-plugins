# EllipticalArc3D.curveType Property
...
"ellipticalArc3D\_var" is a variable referencing an EllipticalArc3D object. ```` ``` #include <Core/Geometry/EllipticalArc3D.h>  // Get the value of the property. Curve3DTypes propertyValue = ellipticalArc3D_var->curveType(); ``` ```` |
