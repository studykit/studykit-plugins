# VolumetricScalarSample.point Property![](../images/TestTubeLarge.png)
...
"volumetricScalarSample\_var" is a variable referencing a VolumetricScalarSample object. ```` ``` #include <Volume/Volumetric/VolumetricScalarSample.h>  // Get the value of the property. Ptr<Point3D> propertyValue = volumetricScalarSample_var->point(); ``` ```` |
