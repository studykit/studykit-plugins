...
"sketchEllipse\_var" is a variable referencing a SketchEllipse object. ```` ``` #include <Fusion/Sketch/SketchEllipse.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchEllipse_var->assemblyContext(); ``` ```` |
