# PostLibrary.doesPathExist Method![](../images/TestTubeLarge.png)
...
"postLibrary\_var" is a variable referencing a [PostLibrary](PostLibrary.htm) object.```` ``` returnValue = postLibrary_var.doesPathExist(url) ``` ```` |
