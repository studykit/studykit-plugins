...
"configurationThemeCell\_var" is a variable referencing a ConfigurationThemeCell object. ```` ``` #include <Fusion/Configurations/ConfigurationThemeCell.h>  // Get the value of the property. Ptr<ConfigurationRow> propertyValue = configurationThemeCell_var->parentRow(); ``` ```` |
