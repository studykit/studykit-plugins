# MeshRepairFeature.name Property![](../images/TestTubeLarge.png)
...
"meshRepairFeature\_var" is a variable referencing a MeshRepairFeature object. ```` ``` #include <Fusion/MeshBody/MeshRepairFeature.h>  // Get the value of the property. string propertyValue = meshRepairFeature_var->name();  // Set the value of the property, where value_var is a string. bool returnValue = meshRepairFeature_var->name(value_var); ``` ```` |
