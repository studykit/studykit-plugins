# GraphNode.properties Property![](../images/TestTubeLarge.png)
...
"graphNode\_var" is a variable referencing a GraphNode object. ```` ``` #include <Volume/Volumetric/GraphNode.h>  // Get the value of the property. Ptr<GraphNodeProperties> propertyValue = graphNode_var->properties(); ``` ```` |

## Property Value

This is a read only property whose value is a [GraphNodeProperties](GraphNodeProperties.htm).
