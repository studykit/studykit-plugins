# NurbsCurve3D.knotCount Property
...
"nurbsCurve3D\_var" is a variable referencing a NurbsCurve3D object. ```` ``` #include <Core/Geometry/NurbsCurve3D.h>  // Get the value of the property. integer propertyValue = nurbsCurve3D_var->knotCount(); ``` ```` |
