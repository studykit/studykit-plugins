# MeshBody.orientedMinimumBoundingBox Property![](../images/TestTubeLarge.png)
...
"meshBody\_var" is a variable referencing a MeshBody object. ```` ``` #include <Fusion/MeshBody/MeshBody.h>  // Get the value of the property. Ptr<OrientedBoundingBox3D> propertyValue = meshBody_var->orientedMinimumBoundingBox(); ``` ```` |
