# PostConfiguration.description Property
...
"postConfiguration\_var" is a variable referencing a PostConfiguration object. ```` ``` #include <Cam/Post/PostConfiguration.h>  // Get the value of the property. string propertyValue = postConfiguration_var->description(); ``` ```` |
