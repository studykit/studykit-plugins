...
"splitBodyFeature\_var" is a variable referencing a SplitBodyFeature object. ```` ``` #include <Fusion/Features/SplitBodyFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = splitBodyFeature_var->linkedFeatures(); ``` ```` |
