# ConstructionAxis.attributes Property
...
"constructionAxis\_var" is a variable referencing a ConstructionAxis object. ```` ``` #include <Fusion/Construction/ConstructionAxis.h>  // Get the value of the property. Ptr<Attributes> propertyValue = constructionAxis_var->attributes(); ``` ```` |
