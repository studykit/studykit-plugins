# SketchControlPointSpline.geometricConstraints Property
...
"sketchControlPointSpline\_var" is a variable referencing a SketchControlPointSpline object. ```` ``` #include <Fusion/Sketch/SketchControlPointSpline.h>  // Get the value of the property. Ptr<GeometricConstraintList> propertyValue = sketchControlPointSpline_var->geometricConstraints(); ``` ```` |
