# CustomFeatureDefinition.id Property![](../images/TestTubeLarge.png)
...
"customFeatureDefinition\_var" is a variable referencing a CustomFeatureDefinition object. ```` ``` #include <Fusion/Features/CustomFeatureDefinition.h>  // Get the value of the property. string propertyValue = customFeatureDefinition_var->id(); ``` ```` |
