# VolumetricModelToMeshFeature.elementSize Property![](../images/TestTubeLarge.png)
...
"volumetricModelToMeshFeature\_var" is a variable referencing a VolumetricModelToMeshFeature object. ```` ``` #include <Fusion/Features/VolumetricModelToMeshFeature.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = volumetricModelToMeshFeature_var->elementSize(); ``` ```` |
