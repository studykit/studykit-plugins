# CustomFeature.baseFeature Property![](../images/TestTubeLarge.png)
...
"customFeature\_var" is a variable referencing a CustomFeature object. ```` ``` #include <Fusion/Features/CustomFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = customFeature_var->baseFeature(); ``` ```` |
