# ParallelConstraint.lineTwo Property
...
"parallelConstraint\_var" is a variable referencing a ParallelConstraint object. ```` ``` #include <Fusion/Sketch/ParallelConstraint.h>  // Get the value of the property. Ptr<SketchLine> propertyValue = parallelConstraint_var->lineTwo(); ``` ```` |
