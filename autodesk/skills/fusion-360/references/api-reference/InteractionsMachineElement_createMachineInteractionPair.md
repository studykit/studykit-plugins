# InteractionsMachineElement.createMachineInteractionPair Method![](../images/TestTubeLarge.png)
...
"interactionsMachineElement\_var" is a variable referencing an [InteractionsMachineElement](InteractionsMachineElement.htm) object.```` ``` returnValue = interactionsMachineElement_var.createMachineInteractionPair(item1, item2) ``` ```` |
...
| item1 | [MachineItem](MachineItem.htm) |  |
| item2 | [MachineItem](MachineItem.htm) |  |
