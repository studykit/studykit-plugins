...
"arc2D\_var" is a variable referencing an Arc2D object. ```` ``` #include <Core/Geometry/Arc2D.h>  // Get the value of the property. Ptr<Point2D> propertyValue = arc2D_var->endPoint(); ``` ```` |
