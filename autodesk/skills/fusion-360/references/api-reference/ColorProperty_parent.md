...
"colorProperty\_var" is a variable referencing a ColorProperty object. ```` ``` #include <Core/Application/ColorProperty.h>  // Get the value of the property. Ptr<Base> propertyValue = colorProperty_var->parent(); ``` ```` |
