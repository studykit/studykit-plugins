...
"joint\_var" is a variable referencing a Joint object. ```` ``` #include <Fusion/Components/Joint.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = joint_var->assemblyContext(); ``` ```` |
