# MidPointConstraint.attributes Property
...
"midPointConstraint\_var" is a variable referencing a MidPointConstraint object. ```` ``` #include <Fusion/Sketch/MidPointConstraint.h>  // Get the value of the property. Ptr<Attributes> propertyValue = midPointConstraint_var->attributes(); ``` ```` |
