...
"stitchFeature\_var" is a variable referencing a StitchFeature object. ```` ``` #include <Fusion/Features/StitchFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = stitchFeature_var->assemblyContext(); ``` ```` |
