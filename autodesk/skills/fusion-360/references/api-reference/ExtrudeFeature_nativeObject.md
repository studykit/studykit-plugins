...
"extrudeFeature\_var" is a variable referencing an ExtrudeFeature object. ```` ``` #include <Fusion/Features/ExtrudeFeature.h>  // Get the value of the property. Ptr<ExtrudeFeature> propertyValue = extrudeFeature_var->nativeObject(); ``` ```` |

## Property Value

This is a read only property whose value is an [ExtrudeFeature](ExtrudeFeature.htm).
