# MeshRepairFeature.dissolve Method![](../images/TestTubeLarge.png)
...
"meshRepairFeature\_var" is a variable referencing a [MeshRepairFeature](MeshRepairFeature.htm) object.```` ``` returnValue = meshRepairFeature_var.dissolve() ``` ```` |
