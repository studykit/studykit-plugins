...
"ruleFilletFeature\_var" is a variable referencing a RuleFilletFeature object. ```` ``` #include <Fusion/Features/RuleFilletFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = ruleFilletFeature_var->assemblyContext(); ``` ```` |
