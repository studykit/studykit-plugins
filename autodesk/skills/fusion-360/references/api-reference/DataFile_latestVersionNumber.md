...
"dataFile\_var" is a variable referencing a DataFile object. ```` ``` #include <Core/Dashboard/DataFile.h>  // Get the value of the property. integer propertyValue = dataFile_var->latestVersionNumber(); ``` ```` |
