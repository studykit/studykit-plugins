# VolumetricModelToMeshFeature.nativeObject Property![](../images/TestTubeLarge.png)
...
"volumetricModelToMeshFeature\_var" is a variable referencing a VolumetricModelToMeshFeature object. ```` ``` #include <Fusion/Features/VolumetricModelToMeshFeature.h>  // Get the value of the property. Ptr<VolumetricModelToMeshFeature> propertyValue = volumetricModelToMeshFeature_var->nativeObject(); ``` ```` |

## Property Value

This is a read only property whose value is a [VolumetricModelToMeshFeature](VolumetricModelToMeshFeature.htm).
