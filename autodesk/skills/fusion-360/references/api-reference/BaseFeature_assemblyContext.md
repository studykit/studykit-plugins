...
"baseFeature\_var" is a variable referencing a BaseFeature object. ```` ``` #include <Fusion/Features/BaseFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = baseFeature_var->assemblyContext(); ``` ```` |
