...
"ribFeature\_var" is a variable referencing a RibFeature object. ```` ``` #include <Fusion/Features/RibFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = ribFeature_var->linkedFeatures(); ``` ```` |
