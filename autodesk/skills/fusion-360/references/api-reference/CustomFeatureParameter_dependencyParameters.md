# CustomFeatureParameter.dependencyParameters Property![](../images/TestTubeLarge.png)
...
"customFeatureParameter\_var" is a variable referencing a CustomFeatureParameter object. ```` ``` #include <Fusion/Features/CustomFeatureParameter.h>  // Get the value of the property. Ptr<ParameterList> propertyValue = customFeatureParameter_var->dependencyParameters(); ``` ```` |
