# PlanarJointMotion.primarySlideLimits Property
...
"planarJointMotion\_var" is a variable referencing a PlanarJointMotion object. ```` ``` #include <Fusion/Components/PlanarJointMotion.h>  // Get the value of the property. Ptr<JointLimits> propertyValue = planarJointMotion_var->primarySlideLimits(); ``` ```` |
