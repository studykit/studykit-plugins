# GeometricRelationship.isTemporary Property![](../images/TestTubeLarge.png)
...
"geometricRelationship\_var" is a variable referencing a GeometricRelationship object. ```` ``` #include <Fusion/Components/GeometricRelationship.h>  // Get the value of the property. boolean propertyValue = geometricRelationship_var->isTemporary(); ``` ```` |
