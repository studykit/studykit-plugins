# GraphNodeProperties.item Method![](../images/TestTubeLarge.png)
...
"graphNodeProperties\_var" is a variable referencing a [GraphNodeProperties](GraphNodeProperties.htm) object.```` ``` returnValue = graphNodeProperties_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [GraphNodeProperty](GraphNodeProperty.htm) | Returns the specified item or null if an invalid index was specified. |
