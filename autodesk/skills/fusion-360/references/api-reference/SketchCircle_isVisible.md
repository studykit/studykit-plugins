...
"sketchCircle\_var" is a variable referencing a SketchCircle object. ```` ``` #include <Fusion/Sketch/SketchCircle.h>  // Get the value of the property. boolean propertyValue = sketchCircle_var->isVisible(); ``` ```` |
