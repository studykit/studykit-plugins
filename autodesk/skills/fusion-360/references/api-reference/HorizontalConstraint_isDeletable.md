# HorizontalConstraint.isDeletable Property
...
"horizontalConstraint\_var" is a variable referencing a HorizontalConstraint object. ```` ``` #include <Fusion/Sketch/HorizontalConstraint.h>  // Get the value of the property. boolean propertyValue = horizontalConstraint_var->isDeletable(); ``` ```` |
