...
"nCProgram\_var" is a variable referencing a NCProgram object. ```` ``` #include <Cam/NCProgram/NCProgram.h>  // Get the value of the property. boolean propertyValue = nCProgram_var->hasError(); ``` ```` |
