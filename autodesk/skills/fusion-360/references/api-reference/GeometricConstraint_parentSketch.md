# GeometricConstraint.parentSketch Property
...
"geometricConstraint\_var" is a variable referencing a GeometricConstraint object. ```` ``` #include <Fusion/Sketch/GeometricConstraint.h>  // Get the value of the property. Ptr<Sketch> propertyValue = geometricConstraint_var->parentSketch(); ``` ```` |
