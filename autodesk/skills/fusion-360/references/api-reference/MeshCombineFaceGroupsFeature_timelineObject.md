# MeshCombineFaceGroupsFeature.timelineObject Property![](../images/TestTubeLarge.png)
...
"meshCombineFaceGroupsFeature\_var" is a variable referencing a MeshCombineFaceGroupsFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFaceGroupsFeature.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = meshCombineFaceGroupsFeature_var->timelineObject(); ``` ```` |
