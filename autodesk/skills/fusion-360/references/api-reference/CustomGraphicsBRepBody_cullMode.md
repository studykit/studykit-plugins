...
"customGraphicsBRepBody\_var" is a variable referencing a CustomGraphicsBRepBody object.  ```` ``` # Get the value of the property. propertyValue = customGraphicsBRepBody_var.cullMode  # Set the value of the property. customGraphicsBRepBody_var.cullMode = propertyValue ``` ```` |

"customGraphicsBRepBody\_var" is a variable referencing a CustomGraphicsBRepBody object. ```` ``` #include <Fusion/Graphics/CustomGraphicsBRepBody.h>  // Get the value of the property. CustomGraphicsCullModes propertyValue = customGraphicsBRepBody_var->cullMode();  // Set the value of the property, where value_var is a CustomGraphicsCullModes. bool returnValue = customGraphicsBRepBody_var->cullMode(value_var); ``` ```` |
