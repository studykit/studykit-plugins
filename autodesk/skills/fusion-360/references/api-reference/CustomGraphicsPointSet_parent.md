# CustomGraphicsPointSet.parent Property
...
"customGraphicsPointSet\_var" is a variable referencing a CustomGraphicsPointSet object. ```` ``` #include <Fusion/Graphics/CustomGraphicsPointSet.h>  // Get the value of the property. Ptr<Base> propertyValue = customGraphicsPointSet_var->parent(); ``` ```` |
