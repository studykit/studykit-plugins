# VolumetricModelToMeshFeatureInput.meshingApproach Property![](../images/TestTubeLarge.png)
...
"volumetricModelToMeshFeatureInput\_var" is a variable referencing a VolumetricModelToMeshFeatureInput object. ```` ``` #include <Fusion/Features/VolumetricModelToMeshFeatureInput.h>  // Get the value of the property. VolumetricMeshingApproachTypes propertyValue = volumetricModelToMeshFeatureInput_var->meshingApproach();  // Set the value of the property, where value_var is a VolumetricMeshingApproachTypes. bool returnValue = volumetricModelToMeshFeatureInput_var->meshingApproach(value_var); ``` ```` |

## Property Value

This is a read/write property whose value is a [VolumetricMeshingApproachTypes](VolumetricMeshingApproachTypes.htm).
