# CAMTemplateOperations.count Property![](../images/TestTubeLarge.png)
...
"cAMTemplateOperations\_var" is a variable referencing a CAMTemplateOperations object. ```` ``` #include <Cam/CAMTemplate/CAMTemplateOperations.h>  // Get the value of the property. integer propertyValue = cAMTemplateOperations_var->count(); ``` ```` |
