# SplitBodyFeature.healthState Property
...
"splitBodyFeature\_var" is a variable referencing a SplitBodyFeature object. ```` ``` #include <Fusion/Features/SplitBodyFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = splitBodyFeature_var->healthState(); ``` ```` |
