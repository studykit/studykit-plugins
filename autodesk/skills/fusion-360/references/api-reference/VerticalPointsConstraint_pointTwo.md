...
"verticalPointsConstraint\_var" is a variable referencing a VerticalPointsConstraint object. ```` ``` #include <Fusion/Sketch/VerticalPointsConstraint.h>  // Get the value of the property. Ptr<SketchPoint> propertyValue = verticalPointsConstraint_var->pointTwo(); ``` ```` |
