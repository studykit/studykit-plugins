# NurbsCurve3D.curveType Property
...
"nurbsCurve3D\_var" is a variable referencing a NurbsCurve3D object. ```` ``` #include <Core/Geometry/NurbsCurve3D.h>  // Get the value of the property. Curve3DTypes propertyValue = nurbsCurve3D_var->curveType(); ``` ```` |
