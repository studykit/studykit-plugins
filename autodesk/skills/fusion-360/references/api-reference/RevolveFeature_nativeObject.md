# RevolveFeature.nativeObject Property
...
"revolveFeature\_var" is a variable referencing a RevolveFeature object. ```` ``` #include <Fusion/Features/RevolveFeature.h>  // Get the value of the property. Ptr<RevolveFeature> propertyValue = revolveFeature_var->nativeObject(); ``` ```` |

## Property Value

This is a read only property whose value is a [RevolveFeature](RevolveFeature.htm).
