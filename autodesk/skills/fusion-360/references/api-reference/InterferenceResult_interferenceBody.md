...
"interferenceResult\_var" is a variable referencing an InterferenceResult object. ```` ``` #include <Fusion/Fusion/InterferenceResult.h>  // Get the value of the property. Ptr<BRepBody> propertyValue = interferenceResult_var->interferenceBody(); ``` ```` |
