...
"offsetFeature\_var" is a variable referencing an OffsetFeature object. ```` ``` #include <Fusion/Features/OffsetFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = offsetFeature_var->assemblyContext(); ``` ```` |
