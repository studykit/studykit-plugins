...
"sphereFeature\_var" is a variable referencing a [SphereFeature](SphereFeature.htm) object.```` ``` returnValue = sphereFeature_var.deleteMe() ``` ```` |

"sphereFeature\_var" is a variable referencing a [SphereFeature](SphereFeature.htm) object. |
