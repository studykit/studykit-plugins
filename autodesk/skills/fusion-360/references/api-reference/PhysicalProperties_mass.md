...
"physicalProperties\_var" is a variable referencing a PhysicalProperties object. ```` ``` #include <Fusion/Fusion/PhysicalProperties.h>  // Get the value of the property. double propertyValue = physicalProperties_var->mass(); ``` ```` |
