# ModelParameter.valueType Property![](../images/TestTubeLarge.png)
...
"modelParameter\_var" is a variable referencing a ModelParameter object. ```` ``` #include <Fusion/Fusion/ModelParameter.h>  // Get the value of the property. ParameterValueTypes propertyValue = modelParameter_var->valueType(); ``` ```` |
