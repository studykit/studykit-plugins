...
"recognizedHoleSegment\_var" is a variable referencing a RecognizedHoleSegment object. ```` ``` #include <Cam/HoleRecognition/RecognizedHoleSegment.h>  // Get the value of the property. HoleSegmentType propertyValue = recognizedHoleSegment_var->holeSegmentType(); ``` ```` |

## Property Value

This is a read only property whose value is a [HoleSegmentType](HoleSegmentType.htm).
