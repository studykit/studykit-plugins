# MachineAxisInput.toolChangePosition Property![](../images/TestTubeLarge.png)
...
"machineAxisInput\_var" is a variable referencing a MachineAxisInput object. ```` ``` #include <Cam/Machine/MachineAxisInput.h>  // Get the value of the property. double propertyValue = machineAxisInput_var->toolChangePosition();  // Set the value of the property, where value_var is a double. bool returnValue = machineAxisInput_var->toolChangePosition(value_var); ``` ```` |
