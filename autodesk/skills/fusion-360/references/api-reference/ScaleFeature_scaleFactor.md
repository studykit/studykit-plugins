...
"scaleFeature\_var" is a variable referencing a ScaleFeature object. ```` ``` #include <Fusion/Features/ScaleFeature.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = scaleFeature_var->scaleFactor(); ``` ```` |
