...
"holeFeature\_var" is a variable referencing a HoleFeature object. ```` ``` #include <Fusion/Features/HoleFeature.h>  // Get the value of the property. Ptr<Point3D> propertyValue = holeFeature_var->position(); ``` ```` |
