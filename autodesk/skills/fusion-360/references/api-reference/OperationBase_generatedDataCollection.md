# OperationBase.generatedDataCollection Property
...
"operationBase\_var" is a variable referencing an OperationBase object. ```` ``` #include <Cam/Operations/OperationBase.h>  // Get the value of the property. Ptr<GeneratedDataCollection> propertyValue = operationBase_var->generatedDataCollection(); ``` ```` |
