# Parameter.valueType Property![](../images/TestTubeLarge.png)
...
"parameter\_var" is a variable referencing a Parameter object. ```` ``` #include <Fusion/Fusion/Parameter.h>  // Get the value of the property. ParameterValueTypes propertyValue = parameter_var->valueType(); ``` ```` |
