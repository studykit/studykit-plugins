...
"manufacturingModelInput\_var" is a variable referencing a ManufacturingModelInput object. |

"manufacturingModelInput\_var" is a variable referencing a ManufacturingModelInput object. ```` ``` #include <Cam/ManufacturingModels/ManufacturingModelInput.h>  // Get the value of the property. string propertyValue = manufacturingModelInput_var->name();  // Set the value of the property, where value_var is a string. bool returnValue = manufacturingModelInput_var->name(value_var); ``` ```` |
