...
"design\_var" is a variable referencing a Design object. ```` ``` #include <Fusion/Fusion/Design.h>  // Get the value of the property. Ptr<Attributes> propertyValue = design_var->attributes(); ``` ```` |
