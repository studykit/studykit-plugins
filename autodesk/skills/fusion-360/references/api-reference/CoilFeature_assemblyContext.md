...
"coilFeature\_var" is a variable referencing a CoilFeature object. ```` ``` #include <Fusion/Features/CoilFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = coilFeature_var->assemblyContext(); ``` ```` |
