# AdditiveFFFLimitsMachineElement.maximumZAcceleration Property
...
"additiveFFFLimitsMachineElement\_var" is a variable referencing an AdditiveFFFLimitsMachineElement object. ```` ``` #include <Cam/Machine/AdditiveFFFLimitsMachineElement.h>  // Get the value of the property. double propertyValue = additiveFFFLimitsMachineElement_var->maximumZAcceleration();  // Set the value of the property, where value_var is a double. bool returnValue = additiveFFFLimitsMachineElement_var->maximumZAcceleration(value_var); ``` ```` |
