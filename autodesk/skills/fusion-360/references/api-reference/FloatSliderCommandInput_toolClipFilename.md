# FloatSliderCommandInput.toolClipFilename Property
...
"floatSliderCommandInput\_var" is a variable referencing a FloatSliderCommandInput object. ```` ``` #include <Core/UserInterface/FloatSliderCommandInput.h>  // Get the value of the property. string propertyValue = floatSliderCommandInput_var->toolClipFilename();  // Set the value of the property, where value_var is a string. bool returnValue = floatSliderCommandInput_var->toolClipFilename(value_var); ``` ```` |
