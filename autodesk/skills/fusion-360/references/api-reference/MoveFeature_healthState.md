...
"moveFeature\_var" is a variable referencing a MoveFeature object. ```` ``` #include <Fusion/Features/MoveFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = moveFeature_var->healthState(); ``` ```` |
