# TessellateFeature.entityToken Property![](../images/TestTubeLarge.png)
...
"tessellateFeature\_var" is a variable referencing a TessellateFeature object. ```` ``` #include <Fusion/MeshBody/TessellateFeature.h>  // Get the value of the property. string propertyValue = tessellateFeature_var->entityToken(); ``` ```` |
