# MeshRemeshFeature.assemblyContext Property![](../images/TestTubeLarge.png)
...
"meshRemeshFeature\_var" is a variable referencing a MeshRemeshFeature object. ```` ``` #include <Fusion/MeshBody/MeshRemeshFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = meshRemeshFeature_var->assemblyContext(); ``` ```` |
