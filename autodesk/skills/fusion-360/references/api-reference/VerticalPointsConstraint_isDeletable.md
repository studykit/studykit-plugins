# VerticalPointsConstraint.isDeletable Property
...
"verticalPointsConstraint\_var" is a variable referencing a VerticalPointsConstraint object. ```` ``` #include <Fusion/Sketch/VerticalPointsConstraint.h>  // Get the value of the property. boolean propertyValue = verticalPointsConstraint_var->isDeletable(); ``` ```` |
