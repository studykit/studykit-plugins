...
"threadDataQuery\_var" is a variable referencing a ThreadDataQuery object. ```` ``` #include <Fusion/Features/ThreadDataQuery.h>  // Get the value of the property. string propertyValue = threadDataQuery_var->defaultInchThreadType(); ``` ```` |
