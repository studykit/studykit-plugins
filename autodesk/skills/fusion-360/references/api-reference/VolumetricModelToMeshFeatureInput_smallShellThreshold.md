# VolumetricModelToMeshFeatureInput.smallShellThreshold Property![](../images/TestTubeLarge.png)
...
"volumetricModelToMeshFeatureInput\_var" is a variable referencing a VolumetricModelToMeshFeatureInput object. ```` ``` #include <Fusion/Features/VolumetricModelToMeshFeatureInput.h>  // Get the value of the property. Ptr<ValueInput> propertyValue = volumetricModelToMeshFeatureInput_var->smallShellThreshold();  // Set the value of the property, where value_var is a ValueInput. bool returnValue = volumetricModelToMeshFeatureInput_var->smallShellThreshold(value_var); ``` ```` |
