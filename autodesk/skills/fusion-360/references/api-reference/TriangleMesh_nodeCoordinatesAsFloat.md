...
"triangleMesh\_var" is a variable referencing a TriangleMesh object. ```` ``` #include <Fusion/MeshData/TriangleMesh.h>  // Get the value of the property. std::vector<float> propertyValue = triangleMesh_var->nodeCoordinatesAsFloat(); ``` ```` |
