...
"triadCommandInput\_var" is a variable referencing a [TriadCommandInput](TriadCommandInput.htm) object.```` ``` returnValue = triadCommandInput_var.setPlanarMoveVisibility(isVisible) ``` ```` |
