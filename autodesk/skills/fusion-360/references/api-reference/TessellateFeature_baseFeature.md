# TessellateFeature.baseFeature Property![](../images/TestTubeLarge.png)
...
"tessellateFeature\_var" is a variable referencing a TessellateFeature object. ```` ``` #include <Fusion/MeshBody/TessellateFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = tessellateFeature_var->baseFeature(); ``` ```` |
