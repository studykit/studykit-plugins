# Design.parentDocument Property
...
"design\_var" is a variable referencing a Design object. ```` ``` #include <Fusion/Fusion/Design.h>  // Get the value of the property. Ptr<Document> propertyValue = design_var->parentDocument(); ``` ```` |
