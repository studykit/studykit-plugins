# PostProcessingMachineElement.postParameters Property![](../images/TestTubeLarge.png)
...
"postProcessingMachineElement\_var" is a variable referencing a PostProcessingMachineElement object. ```` ``` #include <Cam/Machine/PostProcessingMachineElement.h>  // Get the value of the property. Ptr<CAMParameters> propertyValue = postProcessingMachineElement_var->postParameters(); ``` ```` |
