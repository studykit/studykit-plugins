# EmbossFeatures.itemByName Method![](../images/TestTubeLarge.png)
...
"embossFeatures\_var" is a variable referencing an [EmbossFeatures](EmbossFeatures.htm) object.```` ``` returnValue = embossFeatures_var.itemByName(name) ``` ```` |
...
| --- | --- |
| Type | Description |
| [EmbossFeature](EmbossFeature.htm) | Returns the specified item or null if the specified name was not found. |
