# VolumetricCustomFeatures Object ![Preview](../images/TestTubeLarge.png)
...
| --- | --- |
| Name | Description |
| [count](VolumetricCustomFeatures_count.htm) | The number of features in the collection. |
| [isValid](VolumetricCustomFeatures_isValid.htm) | Indicates if this object is still valid, i.e. hasn't been deleted or some other action done to invalidate the reference. |
| [objectType](VolumetricCustomFeatures_objectType.htm) | This property is supported by all objects in the API and returns a string that contains the full name (namespace::objecttype) describing the type of the object. |

## Accessed From

[Features.volumetricCustomFeatures](Features_volumetricCustomFeatures.htm)
