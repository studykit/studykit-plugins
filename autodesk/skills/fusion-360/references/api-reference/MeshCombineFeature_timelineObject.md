# MeshCombineFeature.timelineObject Property![](../images/TestTubeLarge.png)
...
"meshCombineFeature\_var" is a variable referencing a MeshCombineFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFeature.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = meshCombineFeature_var->timelineObject(); ``` ```` |
