# CAMParameter.fullTitle Property![](../images/TestTubeLarge.png)
...
"cAMParameter\_var" is a variable referencing a CAMParameter object. ```` ``` #include <Cam/Operations/CAMParameter.h>  // Get the value of the property. string propertyValue = cAMParameter_var->fullTitle(); ``` ```` |
