...
"choiceProperty\_var" is a variable referencing a ChoiceProperty object. ```` ``` #include <Core/Application/ChoiceProperty.h>  // Get the value of the property. Ptr<Base> propertyValue = choiceProperty_var->parent(); ``` ```` |
