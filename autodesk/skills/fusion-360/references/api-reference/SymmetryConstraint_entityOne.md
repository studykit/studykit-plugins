# SymmetryConstraint.entityOne Property
...
"symmetryConstraint\_var" is a variable referencing a SymmetryConstraint object. ```` ``` #include <Fusion/Sketch/SymmetryConstraint.h>  // Get the value of the property. Ptr<SketchEntity> propertyValue = symmetryConstraint_var->entityOne(); ``` ```` |
