...
"status\_var" is a variable referencing a Status object. ```` ``` #include <Core/Application/Status.h>  // Get the value of the property. boolean propertyValue = status_var->isError(); ``` ```` |
