...
"rectangularPatternFeature\_var" is a variable referencing a [RectangularPatternFeature](RectangularPatternFeature.htm) object.```` ``` returnValue = rectangularPatternFeature_var.createForAssemblyContext(occurrence) ``` ```` |
...
| --- | --- |
| Type | Description |
| [RectangularPatternFeature](RectangularPatternFeature.htm) | Returns the proxy object or null if this isn't the NativeObject. |
