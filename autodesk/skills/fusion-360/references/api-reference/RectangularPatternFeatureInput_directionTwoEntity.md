# RectangularPatternFeatureInput.directionTwoEntity Property
...
"rectangularPatternFeatureInput\_var" is a variable referencing a RectangularPatternFeatureInput object. ```` ``` #include <Fusion/Features/RectangularPatternFeatureInput.h>  // Get the value of the property. Ptr<Base> propertyValue = rectangularPatternFeatureInput_var->directionTwoEntity();  // Set the value of the property, where value_var is a Base. bool returnValue = rectangularPatternFeatureInput_var->directionTwoEntity(value_var); ``` ```` |
