# AssemblyConstraints.item Method![](../images/TestTubeLarge.png)
...
"assemblyConstraints\_var" is a variable referencing an [AssemblyConstraints](AssemblyConstraints.htm) object.```` ``` returnValue = assemblyConstraints_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [AssemblyConstraint](AssemblyConstraint.htm) | Returns the specified item or null if an invalid index was specified. |
