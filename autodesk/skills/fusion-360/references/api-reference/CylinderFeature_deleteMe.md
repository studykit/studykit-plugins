# CylinderFeature.deleteMe Method
...
"cylinderFeature\_var" is a variable referencing a [CylinderFeature](CylinderFeature.htm) object.```` ``` returnValue = cylinderFeature_var.deleteMe() ``` ```` |
