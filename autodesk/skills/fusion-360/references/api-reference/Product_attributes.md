...
"product\_var" is a variable referencing a Product object. ```` ``` #include <Core/Application/Product.h>  // Get the value of the property. Ptr<Attributes> propertyValue = product_var->attributes(); ``` ```` |
