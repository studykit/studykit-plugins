# MachineLibrary.childAssetURLs Method
...
"machineLibrary\_var" is a variable referencing a [MachineLibrary](MachineLibrary.htm) object.```` ``` returnValue = machineLibrary_var.childAssetURLs(url) ``` ```` |
