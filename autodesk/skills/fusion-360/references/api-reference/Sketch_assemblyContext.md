...
"sketch\_var" is a variable referencing a Sketch object. ```` ``` #include <Fusion/Sketch/Sketch.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketch_var->assemblyContext(); ``` ```` |
