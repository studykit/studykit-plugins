# HemFeatureInput.setTeardropHem Method![](../images/TestTubeLarge.png)
...
"hemFeatureInput\_var" is a variable referencing a [HemFeatureInput](HemFeatureInput.htm) object.```` ``` returnValue = hemFeatureInput_var.setTeardropHem(edge, radius, length, gap, isFlipped, bendPositionType) ``` ```` |
...
| radius | [ValueInput](ValueInput.htm) | The radius of the teardrop hem. |
| length | [ValueInput](ValueInput.htm) | The angle of the teardrop hem. |
