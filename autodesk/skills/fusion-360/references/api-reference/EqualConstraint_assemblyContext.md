...
"equalConstraint\_var" is a variable referencing an EqualConstraint object. ```` ``` #include <Fusion/Sketch/EqualConstraint.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = equalConstraint_var->assemblyContext(); ``` ```` |
