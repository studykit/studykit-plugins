# VolumetricCustomFeature.linkedFeatures Property![](../images/TestTubeLarge.png)
...
"volumetricCustomFeature\_var" is a variable referencing a VolumetricCustomFeature object. ```` ``` #include <Fusion/Features/VolumetricCustomFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = volumetricCustomFeature_var->linkedFeatures(); ``` ```` |
