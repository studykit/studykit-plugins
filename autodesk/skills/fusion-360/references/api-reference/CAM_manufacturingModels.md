...
"cAM\_var" is a variable referencing a CAM object. ```` ``` #include <Cam/CAM/CAM.h>  // Get the value of the property. Ptr<ManufacturingModels> propertyValue = cAM_var->manufacturingModels(); ``` ```` |

## Property Value

This is a read only property whose value is a [ManufacturingModels](ManufacturingModels.htm).
