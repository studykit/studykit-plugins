...
"bRepLump\_var" is a variable referencing a BRepLump object. ```` ``` #include <Fusion/BRep/BRepLump.h>  // Get the value of the property. Ptr<BRepEdges> propertyValue = bRepLump_var->edges(); ``` ```` |
