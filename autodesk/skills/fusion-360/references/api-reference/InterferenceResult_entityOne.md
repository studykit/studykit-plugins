...
"interferenceResult\_var" is a variable referencing an InterferenceResult object. ```` ``` #include <Fusion/Fusion/InterferenceResult.h>  // Get the value of the property. Ptr<Base> propertyValue = interferenceResult_var->entityOne(); ``` ```` |
