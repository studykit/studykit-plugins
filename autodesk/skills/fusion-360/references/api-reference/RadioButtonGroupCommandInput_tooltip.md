# RadioButtonGroupCommandInput.tooltip Property
...
"radioButtonGroupCommandInput\_var" is a variable referencing a RadioButtonGroupCommandInput object. ```` ``` #include <Core/UserInterface/RadioButtonGroupCommandInput.h>  // Get the value of the property. string propertyValue = radioButtonGroupCommandInput_var->tooltip();  // Set the value of the property, where value_var is a string. bool returnValue = radioButtonGroupCommandInput_var->tooltip(value_var); ``` ```` |
