...
"patchFeatureInput\_var" is a variable referencing a [PatchFeatureInput](PatchFeatureInput.htm) object.```` ``` returnValue = patchFeatureInput_var.setContinuity(continuity, weight, isContinuityDirectionFlipped) ``` ```` |

"patchFeatureInput\_var" is a variable referencing a [PatchFeatureInput](PatchFeatureInput.htm) object. |
