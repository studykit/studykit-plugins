# GraphNode.description Property![](../images/TestTubeLarge.png)
...
"graphNode\_var" is a variable referencing a GraphNode object. ```` ``` #include <Volume/Volumetric/GraphNode.h>  // Get the value of the property. string propertyValue = graphNode_var->description(); ``` ```` |
