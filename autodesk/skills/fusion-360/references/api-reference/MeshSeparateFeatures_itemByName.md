# MeshSeparateFeatures.itemByName Method![](../images/TestTubeLarge.png)
...
"meshSeparateFeatures\_var" is a variable referencing a [MeshSeparateFeatures](MeshSeparateFeatures.htm) object.```` ``` returnValue = meshSeparateFeatures_var.itemByName(name) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshSeparateFeature](MeshSeparateFeature.htm) | Returns the specified item or null if the specified name was not found. |
