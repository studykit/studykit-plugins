...
"constructionPlane\_var" is a variable referencing a ConstructionPlane object. ```` ``` #include <Fusion/Construction/ConstructionPlane.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = constructionPlane_var->assemblyContext(); ``` ```` |
