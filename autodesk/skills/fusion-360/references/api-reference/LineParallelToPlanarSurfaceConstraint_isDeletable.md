# LineParallelToPlanarSurfaceConstraint.isDeletable Property
...
"lineParallelToPlanarSurfaceConstraint\_var" is a variable referencing a LineParallelToPlanarSurfaceConstraint object. ```` ``` #include <Fusion/Sketch/LineParallelToPlanarSurfaceConstraint.h>  // Get the value of the property. boolean propertyValue = lineParallelToPlanarSurfaceConstraint_var->isDeletable(); ``` ```` |
