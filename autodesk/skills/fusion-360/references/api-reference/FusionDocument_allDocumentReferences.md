# FusionDocument.allDocumentReferences Property
...
"fusionDocument\_var" is a variable referencing a FusionDocument object. ```` ``` #include <Fusion/Fusion/FusionDocument.h>  // Get the value of the property. Ptr<DocumentReferences> propertyValue = fusionDocument_var->allDocumentReferences(); ``` ```` |
