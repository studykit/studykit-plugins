...
"sketchPoint\_var" is a variable referencing a SketchPoint object.  ```` ``` # Get the value of the property. propertyValue = sketchPoint_var.entityToken ``` ```` |

"sketchPoint\_var" is a variable referencing a SketchPoint object. ```` ``` #include <Fusion/Sketch/SketchPoint.h>  // Get the value of the property. string propertyValue = sketchPoint_var->entityToken(); ``` ```` |
