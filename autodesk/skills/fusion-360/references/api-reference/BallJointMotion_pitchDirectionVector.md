# BallJointMotion.pitchDirectionVector Property
...
"ballJointMotion\_var" is a variable referencing a BallJointMotion object. ```` ``` #include <Fusion/Components/BallJointMotion.h>  // Get the value of the property. Ptr<Vector3D> propertyValue = ballJointMotion_var->pitchDirectionVector(); ``` ```` |
