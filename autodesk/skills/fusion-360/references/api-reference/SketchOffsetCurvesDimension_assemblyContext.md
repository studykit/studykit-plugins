...
"sketchOffsetCurvesDimension\_var" is a variable referencing a SketchOffsetCurvesDimension object. ```` ``` #include <Fusion/Sketch/SketchOffsetCurvesDimension.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchOffsetCurvesDimension_var->assemblyContext(); ``` ```` |
