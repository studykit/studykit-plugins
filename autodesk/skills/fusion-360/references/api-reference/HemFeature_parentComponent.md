# HemFeature.parentComponent Property![](../images/TestTubeLarge.png)
...
"hemFeature\_var" is a variable referencing a HemFeature object. ```` ``` #include <Fusion/SheetMetal/HemFeature.h>  // Get the value of the property. Ptr<Component> propertyValue = hemFeature_var->parentComponent(); ``` ```` |
