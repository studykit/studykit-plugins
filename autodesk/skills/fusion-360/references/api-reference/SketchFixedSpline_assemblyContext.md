...
"sketchFixedSpline\_var" is a variable referencing a SketchFixedSpline object. ```` ``` #include <Fusion/Sketch/SketchFixedSpline.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchFixedSpline_var->assemblyContext(); ``` ```` |
