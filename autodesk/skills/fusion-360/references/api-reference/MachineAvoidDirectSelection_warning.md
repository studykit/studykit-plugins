# MachineAvoidDirectSelection.warning Property
...
"machineAvoidDirectSelection\_var" is a variable referencing a MachineAvoidDirectSelection object. ```` ``` #include <Cam/MachineAvoidSelections/MachineAvoidDirectSelection.h>  // Get the value of the property. string propertyValue = machineAvoidDirectSelection_var->warning(); ``` ```` |
