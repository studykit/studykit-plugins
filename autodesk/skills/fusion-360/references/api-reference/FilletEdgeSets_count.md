...
"filletEdgeSets\_var" is a variable referencing a FilletEdgeSets object. ```` ``` #include <Fusion/Features/FilletEdgeSets.h>  // Get the value of the property. uinteger propertyValue = filletEdgeSets_var->count(); ``` ```` |
