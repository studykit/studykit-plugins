...
"manufacturingModels\_var" is a variable referencing a [ManufacturingModels](ManufacturingModels.htm) object.```` ``` returnValue = manufacturingModels_var.createInput() ``` ```` |
...
| --- | --- |
| Type | Description |
| [ManufacturingModelInput](ManufacturingModelInput.htm) | Returns new ManufacturingModelInput object. |
