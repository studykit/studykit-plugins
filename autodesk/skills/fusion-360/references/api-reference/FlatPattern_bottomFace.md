# FlatPattern.bottomFace Property
...
"flatPattern\_var" is a variable referencing a FlatPattern object. ```` ``` #include <Fusion/SheetMetal/FlatPattern.h>  // Get the value of the property. Ptr<BRepFace> propertyValue = flatPattern_var->bottomFace(); ``` ```` |
