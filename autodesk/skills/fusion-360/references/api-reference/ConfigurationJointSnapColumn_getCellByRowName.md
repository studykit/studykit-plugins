...
"configurationJointSnapColumn\_var" is a variable referencing a [ConfigurationJointSnapColumn](ConfigurationJointSnapColumn.htm) object.```` ``` returnValue = configurationJointSnapColumn_var.getCellByRowName(rowName) ``` ```` |
