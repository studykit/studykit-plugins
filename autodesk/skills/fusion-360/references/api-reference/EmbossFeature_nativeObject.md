# EmbossFeature.nativeObject Property![](../images/TestTubeLarge.png)
...
"embossFeature\_var" is a variable referencing an EmbossFeature object. ```` ``` #include <Fusion/Features/EmbossFeature.h>  // Get the value of the property. Ptr<EmbossFeature> propertyValue = embossFeature_var->nativeObject(); ``` ```` |

## Property Value

This is a read only property whose value is an [EmbossFeature](EmbossFeature.htm).
