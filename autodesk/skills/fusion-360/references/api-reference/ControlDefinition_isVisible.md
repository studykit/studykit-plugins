# ControlDefinition.isVisible Property
...
"controlDefinition\_var" is a variable referencing a ControlDefinition object. ```` ``` #include <Core/UserInterface/ControlDefinition.h>  // Get the value of the property. boolean propertyValue = controlDefinition_var->isVisible();  // Set the value of the property, where value_var is a boolean. bool returnValue = controlDefinition_var->isVisible(value_var); ``` ```` |
