# IntegerGraphNodeProperty.name Property![](../images/TestTubeLarge.png)
...
"integerGraphNodeProperty\_var" is a variable referencing an IntegerGraphNodeProperty object. ```` ``` #include <Volume/Volumetric/IntegerGraphNodeProperty.h>  // Get the value of the property. string propertyValue = integerGraphNodeProperty_var->name(); ``` ```` |
