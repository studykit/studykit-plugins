# HemFeatureInput.setDoubleHem Method![](../images/TestTubeLarge.png)
...
"hemFeatureInput\_var" is a variable referencing a [HemFeatureInput](HemFeatureInput.htm) object.```` ``` returnValue = hemFeatureInput_var.setDoubleHem(edge, gap, length, setback, isFlipped, bendPositionType) ``` ```` |
...
| length | [ValueInput](ValueInput.htm) | The length of the double hem. |
| setback | [ValueInput](ValueInput.htm) | The setback of the double hem. |
