# WorkingModel.materials Property
...
"workingModel\_var" is a variable referencing a WorkingModel object. ```` ``` #include <Fusion/Fusion/WorkingModel.h>  // Get the value of the property. Ptr<Materials> propertyValue = workingModel_var->materials(); ``` ```` |
