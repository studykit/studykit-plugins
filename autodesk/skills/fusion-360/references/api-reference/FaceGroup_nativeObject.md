# FaceGroup.nativeObject Property![](../images/TestTubeLarge.png)
...
"faceGroup\_var" is a variable referencing a FaceGroup object. ```` ``` #include <Fusion/MeshBody/FaceGroup.h>  // Get the value of the property. Ptr<FaceGroup> propertyValue = faceGroup_var->nativeObject(); ``` ```` |

## Property Value

This is a read only property whose value is a [FaceGroup](FaceGroup.htm).
