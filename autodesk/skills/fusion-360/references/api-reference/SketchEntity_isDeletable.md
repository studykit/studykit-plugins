...
"sketchEntity\_var" is a variable referencing a SketchEntity object. ```` ``` #include <Fusion/Sketch/SketchEntity.h>  // Get the value of the property. boolean propertyValue = sketchEntity_var->isDeletable(); ``` ```` |
