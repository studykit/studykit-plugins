# MeshShellFeature.baseFeature Property![](../images/TestTubeLarge.png)
...
"meshShellFeature\_var" is a variable referencing a MeshShellFeature object. ```` ``` #include <Fusion/MeshBody/MeshShellFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = meshShellFeature_var->baseFeature(); ``` ```` |
