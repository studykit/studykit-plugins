# MeshFeature.timelineObject Property![](../images/TestTubeLarge.png)
...
"meshFeature\_var" is a variable referencing a MeshFeature object. ```` ``` #include <Fusion/MeshBody/MeshFeature.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = meshFeature_var->timelineObject(); ``` ```` |
