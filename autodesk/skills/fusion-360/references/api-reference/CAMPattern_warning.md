...
"cAMPattern\_var" is a variable referencing a CAMPattern object. ```` ``` #include <Cam/CAM/CAMPattern.h>  // Get the value of the property. string propertyValue = cAMPattern_var->warning(); ``` ```` |
