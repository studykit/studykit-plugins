...
"cAMAdditiveBuildExportFilter\_var" is a variable referencing a CAMAdditiveBuildExportFilter object. ```` ``` #include <Cam/CAM/CAMAdditiveBuildExportFilter.h>  // Get the value of the property. string propertyValue = cAMAdditiveBuildExportFilter_var->id(); ``` ```` |
