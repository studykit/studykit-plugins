# MeshShellFeatures.itemByName Method![](../images/TestTubeLarge.png)
...
"meshShellFeatures\_var" is a variable referencing a [MeshShellFeatures](MeshShellFeatures.htm) object.```` ``` returnValue = meshShellFeatures_var.itemByName(name) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshShellFeature](MeshShellFeature.htm) | Returns the specified item or null if the specified name was not found. |
