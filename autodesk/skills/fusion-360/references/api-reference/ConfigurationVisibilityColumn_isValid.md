...
"configurationVisibilityColumn\_var" is a variable referencing a ConfigurationVisibilityColumn object. ```` ``` #include <Fusion/Configurations/ConfigurationVisibilityColumn.h>  // Get the value of the property. boolean propertyValue = configurationVisibilityColumn_var->isValid(); ``` ```` |
