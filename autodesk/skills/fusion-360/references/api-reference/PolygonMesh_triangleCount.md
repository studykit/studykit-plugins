# PolygonMesh.triangleCount Property
...
"polygonMesh\_var" is a variable referencing a PolygonMesh object. ```` ``` #include <Fusion/MeshData/PolygonMesh.h>  // Get the value of the property. integer propertyValue = polygonMesh_var->triangleCount(); ``` ```` |
