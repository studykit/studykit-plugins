# MeshRepairFeature.mesh Property![](../images/TestTubeLarge.png)
...
"meshRepairFeature\_var" is a variable referencing a MeshRepairFeature object. ```` ``` #include <Fusion/MeshBody/MeshRepairFeature.h>  // Get the value of the property. Ptr<Base> propertyValue = meshRepairFeature_var->mesh();  // Set the value of the property, where value_var is a Base. bool returnValue = meshRepairFeature_var->mesh(value_var); ``` ```` |
