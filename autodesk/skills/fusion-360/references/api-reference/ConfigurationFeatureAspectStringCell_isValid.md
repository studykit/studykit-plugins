...
"configurationFeatureAspectStringCell\_var" is a variable referencing a ConfigurationFeatureAspectStringCell object. ```` ``` #include <Fusion/Configurations/ConfigurationFeatureAspectStringCell.h>  // Get the value of the property. boolean propertyValue = configurationFeatureAspectStringCell_var->isValid(); ``` ```` |
