# CustomFeatureParameter.parentCustomFeature Property![](../images/TestTubeLarge.png)
...
"customFeatureParameter\_var" is a variable referencing a CustomFeatureParameter object. ```` ``` #include <Fusion/Features/CustomFeatureParameter.h>  // Get the value of the property. Ptr<CustomFeature> propertyValue = customFeatureParameter_var->parentCustomFeature(); ``` ```` |
