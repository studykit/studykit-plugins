...
"markingMenuEventArgs\_var" is a variable referencing a MarkingMenuEventArgs object. ```` ``` #include <Core/UserInterface/MarkingMenuEventArgs.h>  // Get the value of the property. Ptr<LinearMarkingMenu> propertyValue = markingMenuEventArgs_var->linearMarkingMenu(); ``` ```` |

## Property Value

This is a read only property whose value is a [LinearMarkingMenu](LinearMarkingMenu.htm).
