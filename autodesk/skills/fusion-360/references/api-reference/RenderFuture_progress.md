...
"renderFuture\_var" is a variable referencing a RenderFuture object. ```` ``` #include <Fusion/Render/RenderFuture.h>  // Get the value of the property. double propertyValue = renderFuture_var->progress(); ``` ```` |
