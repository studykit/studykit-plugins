# ConfigurationPlasticRuleCell.parentRow Property
...
"configurationPlasticRuleCell\_var" is a variable referencing a ConfigurationPlasticRuleCell object. ```` ``` #include <Fusion/Configurations/ConfigurationPlasticRuleCell.h>  // Get the value of the property. Ptr<ConfigurationRow> propertyValue = configurationPlasticRuleCell_var->parentRow(); ``` ```` |
