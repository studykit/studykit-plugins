# BRepBody.isSheetMetal Property
...
"bRepBody\_var" is a variable referencing a BRepBody object. ```` ``` #include <Fusion/BRep/BRepBody.h>  // Get the value of the property. boolean propertyValue = bRepBody_var->isSheetMetal(); ``` ```` |
