# VolumetricModelToMeshFeatures.createInput Method![](../images/TestTubeLarge.png)
...
"volumetricModelToMeshFeatures\_var" is a variable referencing a [VolumetricModelToMeshFeatures](VolumetricModelToMeshFeatures.htm) object.```` ``` returnValue = volumetricModelToMeshFeatures_var.createInput(volumetricModel) ``` ```` |
...
| --- | --- |
| Type | Description |
| [VolumetricModelToMeshFeatureInput](VolumetricModelToMeshFeatureInput.htm) | Returns the newly created VolumetricModelToMeshFeatureInput object or null if the creation failed. |
