# EmbossFeatures.AddEngraveFromFace Method
...
EmbossFeatures.**AddEngraveFromFace**( ***Profile*** As [Profile](../Profile/Profile.md), ***Distance*** As Variant, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), [***TopFaceColor***] As Variant, [***WrapFace***] As Variant ) As [EmbossFeature](../EmbossFeature/EmbossFeature.md)
