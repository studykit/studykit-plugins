# SketchDrivenPatternFeatureProxy.Parent Property
...
SketchDrivenPatternFeatureProxy.**Parent**() As [ComponentDefinition](../ComponentDefinition/ComponentDefinition.md)
