...
AssemblyComponentDefinition.**TransformOccurrences**( ***Occurrences*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), ***Transforms*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), [***IgnoreConstraints***] As Boolean )
