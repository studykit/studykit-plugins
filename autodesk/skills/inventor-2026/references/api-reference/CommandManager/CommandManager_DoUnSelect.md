# CommandManager.DoUnSelect Method
...
CommandManager.**DoUnSelect**( ***Entity*** As Object )
...
| Entity | Object | Input Autodesk Inventor object, including custom graphics object, that needs to be understood as being de-selected by the active selection process in progress. This entity may have been picked by a means not known to native Autodesk Inventor (say a foreign browser). |
