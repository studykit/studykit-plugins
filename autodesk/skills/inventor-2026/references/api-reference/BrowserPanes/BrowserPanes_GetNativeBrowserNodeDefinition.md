...
BrowserPanes.**GetNativeBrowserNodeDefinition**( ***NativeObject*** As Object ) As [NativeBrowserNodeDefinition](../NativeBrowserNodeDefinition/NativeBrowserNodeDefinition.md)
