# RotateRotateConstraintProxy.ConvertToRotateTranslateConstraint Method

Parent Object: [RotateRotateConstraintProxy](../RotateRotateConstraintProxy/RotateRotateConstraintProxy.md)
...
RotateRotateConstraintProxy.**ConvertToRotateTranslateConstraint**( ***EntityOne*** As Object, ***EntityTwo*** As Object, ***Ratio*** As Variant, ***ForwardDirection*** As Boolean, [***BiasPointOne***] As Variant, [***BiasPointTwo***] As Variant ) As [RotateTranslateConstraint](../RotateTranslateConstraint/RotateTranslateConstraint.md)
