# AngularModelDimensionDefinition.GetInspectionDimensionData Method
...
AngularModelDimensionDefinition.**GetInspectionDimensionData**( ***Shape*** As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), ***Label*** As String, ***Rate*** As String )
