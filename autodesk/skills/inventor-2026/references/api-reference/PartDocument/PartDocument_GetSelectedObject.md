# PartDocument.GetSelectedObject Method
...
| Selection | [GenericObject](../GenericObject/GenericObject.md) | Input GenericObject that was obtained through a selection. |
