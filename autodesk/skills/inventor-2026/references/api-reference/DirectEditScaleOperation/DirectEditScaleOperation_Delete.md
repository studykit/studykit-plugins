# DirectEditScaleOperation.Delete Method
...
DirectEditScaleOperation.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
