# ContourRollFeature.RemoveParticipant Method
...
ContourRollFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
