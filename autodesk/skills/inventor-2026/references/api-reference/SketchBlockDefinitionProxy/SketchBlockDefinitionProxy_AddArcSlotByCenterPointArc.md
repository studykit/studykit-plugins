...
SketchBlockDefinitionProxy.**AddArcSlotByCenterPointArc**( ***CenterPoint*** As Object, ***StartPoint*** As Object, ***SweepAngle*** As Double, ***Width*** As Double ) As [SketchEntitiesEnumerator](../SketchEntitiesEnumerator/SketchEntitiesEnumerator.md)
