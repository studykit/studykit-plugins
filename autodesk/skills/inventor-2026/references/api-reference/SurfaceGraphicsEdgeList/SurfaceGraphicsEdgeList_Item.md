...
Parent Object: [SurfaceGraphicsEdgeList](../SurfaceGraphicsEdgeList/SurfaceGraphicsEdgeList.md)
...
SurfaceGraphicsEdgeList.**Item**( ***Index*** As Variant ) As [SurfaceGraphicsEdge](../SurfaceGraphicsEdge/SurfaceGraphicsEdge.md)

## Property Value

This is a read only property whose value is a [SurfaceGraphicsEdge](../SurfaceGraphicsEdge/SurfaceGraphicsEdge.md).
