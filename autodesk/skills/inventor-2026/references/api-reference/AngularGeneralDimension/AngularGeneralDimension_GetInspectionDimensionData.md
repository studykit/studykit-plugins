# AngularGeneralDimension.GetInspectionDimensionData Method
...
AngularGeneralDimension.**GetInspectionDimensionData**( ***Shape*** As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), ***Label*** As String, ***Rate*** As String )
