# DerivedPartUniformScaleDef.IncludeAllWorkFeatures Property
...
DerivedPartUniformScaleDef.**IncludeAllWorkFeatures**() As [DerivedComponentOptionEnum](../DerivedComponentOptionEnum.md)
