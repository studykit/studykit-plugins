...
PartsList.**PartsListColumns**() As [PartsListColumns](../PartsListColumns/PartsListColumns.md)

## Property Value

This is a read only property whose value is a [PartsListColumns](../PartsListColumns/PartsListColumns.md).
