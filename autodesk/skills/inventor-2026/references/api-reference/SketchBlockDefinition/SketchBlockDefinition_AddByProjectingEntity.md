# SketchBlockDefinition.AddByProjectingEntity Method
...
SketchBlockDefinition.**AddByProjectingEntity**( ***Entity*** As Object ) As [SketchEntity](../SketchEntity/SketchEntity.md)
