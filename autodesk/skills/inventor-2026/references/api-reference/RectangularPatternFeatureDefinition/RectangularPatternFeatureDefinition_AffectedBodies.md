# RectangularPatternFeatureDefinition.AffectedBodies Property
...
RectangularPatternFeatureDefinition.**AffectedBodies**() As [ObjectCollection](../ObjectCollection/ObjectCollection.md)
