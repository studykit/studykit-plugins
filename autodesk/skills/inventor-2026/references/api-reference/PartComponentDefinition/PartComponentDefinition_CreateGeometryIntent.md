# PartComponentDefinition.CreateGeometryIntent Method
...
PartComponentDefinition.**CreateGeometryIntent**( ***Geometry*** As Object, [***Intent***] As Variant ) As [GeometryIntent](../GeometryIntent/GeometryIntent.md)
