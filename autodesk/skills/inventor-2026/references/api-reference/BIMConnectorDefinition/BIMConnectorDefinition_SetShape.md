...
BIMConnectorDefinition.**SetShape**( ***Geometry*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), [***ConnectorShape***] As [BIMConnectorShapeEnum](../BIMConnectorShapeEnum.md) )
