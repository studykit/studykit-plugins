# SketchEquationCurve3D.GetEquation Method
...
SketchEquationCurve3D.**GetEquation**( ***CoordinateSystemType*** As [CoordinateSystemTypeEnum](../CoordinateSystemTypeEnum.md), ***XValueOrRadius*** As String, ***YValueOrTheta*** As String, ***ZValueOrPhi*** As String, ***MinValue*** As [Parameter](../Parameter/Parameter.md), ***MaxValue*** As [Parameter](../Parameter/Parameter.md) )
