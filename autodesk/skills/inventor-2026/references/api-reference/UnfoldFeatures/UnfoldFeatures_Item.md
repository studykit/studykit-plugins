...
Parent Object: [UnfoldFeatures](../UnfoldFeatures/UnfoldFeatures.md)
...
UnfoldFeatures.**Item**( ***Index*** As Variant ) As [UnfoldFeature](../UnfoldFeature/UnfoldFeature.md)

## Property Value

This is a read only property whose value is a [UnfoldFeature](../UnfoldFeature/UnfoldFeature.md).
