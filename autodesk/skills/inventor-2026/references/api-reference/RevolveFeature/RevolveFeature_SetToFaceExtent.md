# RevolveFeature.SetToFaceExtent Method
...
RevolveFeature.**SetToFaceExtent**( ***ToFace*** As Object, ***ExtendToFace*** As Boolean, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), ***MinimumSolution*** As Boolean )
