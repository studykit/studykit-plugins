...
EllipticalArc.**PutEllipticalArcData**( ***Center***() As Double, ***MajorAxis***() As Double, ***MinorAxis***() As Double, ***MajorRadius*** As Double, ***MinorRadius*** As Double, ***StartAngle*** As Double, ***SweepAngle*** As Double )
