...
Parent Object: [StylesManager](../StylesManager/StylesManager.md)
...
StylesManager.**GetStyleNameFromKey**( ***ReferenceKey***() As Byte, ***InternalName*** As String, ***DisplayName*** As String )
