...
Parent Object: [EllipticalCone](../EllipticalCone/EllipticalCone.md)
...
EllipticalCone.**GetEllipticalConeData**( ***BasePoint***() As Double, ***AxisVector***() As Double, ***MajorAxis***() As Double, ***MinorMajorRatio*** As Double, ***HalfAngle*** As Double, ***IsExpanding*** As Boolean )
