# SurfaceBody.CalculateFacetsWithOptions Method
...
SurfaceBody.**CalculateFacetsWithOptions**( ***ChordalTolerance*** As Double, ***Options*** As [NameValueMap](../NameValueMap/NameValueMap.md), ***VertexCount*** As Long, ***FacetCount*** As Long, ***VertexCoordinates***() As Double, ***NormalVectors***() As Double, ***VertexIndices***() As Long, [***TextureCoordinates***] As Variant )
