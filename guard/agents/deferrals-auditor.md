...
one place the paths part company, and **your skill states which rule applies.** Read it before
you judge one, and do not carry another path's rule across. What holds either way is
