...
"configurationThemeColumn\_var" is a variable referencing a [ConfigurationThemeColumn](ConfigurationThemeColumn.htm) object.```` ``` returnValue = configurationThemeColumn_var.getCell(rowIndex) ``` ```` |
...
| --- | --- |
| Type | Description |
| [ConfigurationThemeCell](ConfigurationThemeCell.htm) | Returns the specified cell if successful and null if an invalid index was specified. |
