...
"pipeFeature\_var" is a variable referencing a PipeFeature object. ```` ``` #include <Fusion/Features/PipeFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = pipeFeature_var->baseFeature(); ``` ```` |
