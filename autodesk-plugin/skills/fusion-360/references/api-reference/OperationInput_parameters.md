...
"operationInput\_var" is a variable referencing an OperationInput object. ```` ``` #include <Cam/Operations/OperationInput.h>  // Get the value of the property. Ptr<CAMParameters> propertyValue = operationInput_var->parameters(); ``` ```` |
