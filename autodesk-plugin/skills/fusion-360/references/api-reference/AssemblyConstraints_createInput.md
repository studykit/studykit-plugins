# AssemblyConstraints.createInput Method![](../images/TestTubeLarge.png)
...
"assemblyConstraints\_var" is a variable referencing an [AssemblyConstraints](AssemblyConstraints.htm) object.```` ``` returnValue = assemblyConstraints_var.createInput() ``` ```` |
...
| --- | --- |
| Type | Description |
| [AssemblyConstraintInput](AssemblyConstraintInput.htm) | Returns an AssemblyConstraintInput. |
