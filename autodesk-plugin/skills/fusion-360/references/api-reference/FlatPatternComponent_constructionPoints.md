# FlatPatternComponent.constructionPoints Property
...
"flatPatternComponent\_var" is a variable referencing a FlatPatternComponent object. ```` ``` #include <Fusion/SheetMetal/FlatPatternComponent.h>  // Get the value of the property. Ptr<ConstructionPoints> propertyValue = flatPatternComponent_var->constructionPoints(); ``` ```` |
