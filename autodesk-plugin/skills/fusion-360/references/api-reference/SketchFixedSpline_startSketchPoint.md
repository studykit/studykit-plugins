# SketchFixedSpline.startSketchPoint Property
...
"sketchFixedSpline\_var" is a variable referencing a SketchFixedSpline object. ```` ``` #include <Fusion/Sketch/SketchFixedSpline.h>  // Get the value of the property. Ptr<SketchPoint> propertyValue = sketchFixedSpline_var->startSketchPoint(); ``` ```` |
