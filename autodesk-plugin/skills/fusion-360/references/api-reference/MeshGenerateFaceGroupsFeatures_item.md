# MeshGenerateFaceGroupsFeatures.item Method![](../images/TestTubeLarge.png)
...
"meshGenerateFaceGroupsFeatures\_var" is a variable referencing a [MeshGenerateFaceGroupsFeatures](MeshGenerateFaceGroupsFeatures.htm) object.```` ``` returnValue = meshGenerateFaceGroupsFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshGenerateFaceGroupsFeature](MeshGenerateFaceGroupsFeature.htm) | Returns the specified item or null if an invalid index was specified. |
