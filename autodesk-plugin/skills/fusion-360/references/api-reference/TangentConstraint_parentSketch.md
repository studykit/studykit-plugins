...
"tangentConstraint\_var" is a variable referencing a TangentConstraint object. ```` ``` #include <Fusion/Sketch/TangentConstraint.h>  // Get the value of the property. Ptr<Sketch> propertyValue = tangentConstraint_var->parentSketch(); ``` ```` |
