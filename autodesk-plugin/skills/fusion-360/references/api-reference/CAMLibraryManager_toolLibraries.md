...
"cAMLibraryManager\_var" is a variable referencing a CAMLibraryManager object. ```` ``` #include <Cam/Global/CAMLibraryManager.h>  // Get the value of the property. Ptr<ToolLibraries> propertyValue = cAMLibraryManager_var->toolLibraries(); ``` ```` |

## Property Value

This is a read only property whose value is a [ToolLibraries](ToolLibraries.htm).
