...
"ruledSurfaceFeature\_var" is a variable referencing a RuledSurfaceFeature object. ```` ``` #include <Fusion/Features/RuledSurfaceFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = ruledSurfaceFeature_var->assemblyContext(); ``` ```` |
