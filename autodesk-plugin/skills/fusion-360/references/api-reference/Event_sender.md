...
"event\_var" is a variable referencing an Event object. ```` ``` #include <Core/Application/Event.h>  // Get the value of the property. Ptr<Base> propertyValue = event_var->sender(); ``` ```` |
