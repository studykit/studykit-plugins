# BaseFeature.parentComponent Property
...
"baseFeature\_var" is a variable referencing a BaseFeature object. ```` ``` #include <Fusion/Features/BaseFeature.h>  // Get the value of the property. Ptr<Component> propertyValue = baseFeature_var->parentComponent(); ``` ```` |
