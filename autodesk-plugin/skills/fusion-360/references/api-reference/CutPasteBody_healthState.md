# CutPasteBody.healthState Property
...
"cutPasteBody\_var" is a variable referencing a CutPasteBody object. ```` ``` #include <Fusion/Features/CutPasteBody.h>  // Get the value of the property. FeatureHealthStates propertyValue = cutPasteBody_var->healthState(); ``` ```` |
