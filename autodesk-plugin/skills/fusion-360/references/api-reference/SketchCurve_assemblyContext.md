...
"sketchCurve\_var" is a variable referencing a SketchCurve object. ```` ``` #include <Fusion/Sketch/SketchCurve.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchCurve_var->assemblyContext(); ``` ```` |
