# VolumetricCustomFeature.parentComponent Property![](../images/TestTubeLarge.png)
...
"volumetricCustomFeature\_var" is a variable referencing a VolumetricCustomFeature object. ```` ``` #include <Fusion/Features/VolumetricCustomFeature.h>  // Get the value of the property. Ptr<Component> propertyValue = volumetricCustomFeature_var->parentComponent(); ``` ```` |
