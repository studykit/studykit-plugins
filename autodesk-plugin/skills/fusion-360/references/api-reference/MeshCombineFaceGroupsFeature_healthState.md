# MeshCombineFaceGroupsFeature.healthState Property![](../images/TestTubeLarge.png)
...
"meshCombineFaceGroupsFeature\_var" is a variable referencing a MeshCombineFaceGroupsFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFaceGroupsFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = meshCombineFaceGroupsFeature_var->healthState(); ``` ```` |
