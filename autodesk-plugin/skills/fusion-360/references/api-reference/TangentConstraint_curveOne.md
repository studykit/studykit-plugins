# TangentConstraint.curveOne Property
...
"tangentConstraint\_var" is a variable referencing a TangentConstraint object. ```` ``` #include <Fusion/Sketch/TangentConstraint.h>  // Get the value of the property. Ptr<SketchCurve> propertyValue = tangentConstraint_var->curveOne(); ``` ```` |
