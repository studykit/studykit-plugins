# SketchEllipticalArc.geometricConstraints Property
...
"sketchEllipticalArc\_var" is a variable referencing a SketchEllipticalArc object. ```` ``` #include <Fusion/Sketch/SketchEllipticalArc.h>  // Get the value of the property. Ptr<GeometricConstraintList> propertyValue = sketchEllipticalArc_var->geometricConstraints(); ``` ```` |
