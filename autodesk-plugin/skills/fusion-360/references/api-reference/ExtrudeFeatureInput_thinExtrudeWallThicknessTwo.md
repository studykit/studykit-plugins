...
"extrudeFeatureInput\_var" is a variable referencing an ExtrudeFeatureInput object. ```` ``` #include <Fusion/Features/ExtrudeFeatureInput.h>  // Get the value of the property. Ptr<ValueInput> propertyValue = extrudeFeatureInput_var->thinExtrudeWallThicknessTwo();  // Set the value of the property, where value_var is a ValueInput. bool returnValue = extrudeFeatureInput_var->thinExtrudeWallThicknessTwo(value_var); ``` ```` |
