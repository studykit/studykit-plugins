# SketchOffsetCurvesDimension.parentSketch Property
...
"sketchOffsetCurvesDimension\_var" is a variable referencing a SketchOffsetCurvesDimension object. ```` ``` #include <Fusion/Sketch/SketchOffsetCurvesDimension.h>  // Get the value of the property. Ptr<Sketch> propertyValue = sketchOffsetCurvesDimension_var->parentSketch(); ``` ```` |
