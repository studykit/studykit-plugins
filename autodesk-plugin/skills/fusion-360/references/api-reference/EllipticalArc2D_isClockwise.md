# EllipticalArc2D.isClockwise Property
...
"ellipticalArc2D\_var" is a variable referencing an EllipticalArc2D object. ```` ``` #include <Core/Geometry/EllipticalArc2D.h>  // Get the value of the property. boolean propertyValue = ellipticalArc2D_var->isClockwise(); ``` ```` |
