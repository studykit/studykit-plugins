...
"sketchEllipse\_var" is a variable referencing a SketchEllipse object. ```` ``` #include <Fusion/Sketch/SketchEllipse.h>  // Get the value of the property. boolean propertyValue = sketchEllipse_var->isDeletable(); ``` ```` |
