# MachineToolStation.toolInterface Property![](../images/TestTubeLarge.png)
...
"machineToolStation\_var" is a variable referencing a MachineToolStation object. ```` ``` #include <Cam/Machine/MachineToolStation.h>  // Get the value of the property. string propertyValue = machineToolStation_var->toolInterface();  // Set the value of the property, where value_var is a string. bool returnValue = machineToolStation_var->toolInterface(value_var); ``` ```` |
