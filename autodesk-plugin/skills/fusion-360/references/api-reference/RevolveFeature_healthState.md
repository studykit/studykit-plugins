# RevolveFeature.healthState Property
...
"revolveFeature\_var" is a variable referencing a RevolveFeature object. ```` ``` #include <Fusion/Features/RevolveFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = revolveFeature_var->healthState(); ``` ```` |
