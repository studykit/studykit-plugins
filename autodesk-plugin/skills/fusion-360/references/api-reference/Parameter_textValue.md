# Parameter.textValue Property![](../images/TestTubeLarge.png)
...
"parameter\_var" is a variable referencing a Parameter object. ```` ``` #include <Fusion/Fusion/Parameter.h>  // Get the value of the property. string propertyValue = parameter_var->textValue();  // Set the value of the property, where value_var is a string. bool returnValue = parameter_var->textValue(value_var); ``` ```` |
