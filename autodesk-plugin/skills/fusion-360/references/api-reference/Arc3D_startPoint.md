...
"arc3D\_var" is a variable referencing an Arc3D object. ```` ``` #include <Core/Geometry/Arc3D.h>  // Get the value of the property. Ptr<Point3D> propertyValue = arc3D_var->startPoint(); ``` ```` |
