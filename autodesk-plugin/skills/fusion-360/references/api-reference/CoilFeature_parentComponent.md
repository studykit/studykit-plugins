# CoilFeature.parentComponent Property
...
"coilFeature\_var" is a variable referencing a CoilFeature object. ```` ``` #include <Fusion/Features/CoilFeature.h>  // Get the value of the property. Ptr<Component> propertyValue = coilFeature_var->parentComponent(); ``` ```` |
