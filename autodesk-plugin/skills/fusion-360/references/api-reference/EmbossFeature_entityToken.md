# EmbossFeature.entityToken Property![](../images/TestTubeLarge.png)
...
"embossFeature\_var" is a variable referencing an EmbossFeature object. ```` ``` #include <Fusion/Features/EmbossFeature.h>  // Get the value of the property. string propertyValue = embossFeature_var->entityToken(); ``` ```` |
