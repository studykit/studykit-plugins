...
"filletEdgeSets\_var" is a variable referencing a [FilletEdgeSets](FilletEdgeSets.htm) object.```` ``` returnValue = filletEdgeSets_var.item(index) ``` ```` |

"filletEdgeSets\_var" is a variable referencing a [FilletEdgeSets](FilletEdgeSets.htm) object. |
...
| --- | --- |
| Type | Description |
| [FilletEdgeSet](FilletEdgeSet.htm) | Returns the specified item or null if an invalid index was specified. |
