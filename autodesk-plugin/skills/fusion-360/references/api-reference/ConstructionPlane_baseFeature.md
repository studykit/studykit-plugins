...
"constructionPlane\_var" is a variable referencing a ConstructionPlane object. ```` ``` #include <Fusion/Construction/ConstructionPlane.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = constructionPlane_var->baseFeature(); ``` ```` |
