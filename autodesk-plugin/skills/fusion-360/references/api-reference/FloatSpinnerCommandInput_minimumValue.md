# FloatSpinnerCommandInput.minimumValue Property
...
"floatSpinnerCommandInput\_var" is a variable referencing a FloatSpinnerCommandInput object. ```` ``` #include <Core/UserInterface/FloatSpinnerCommandInput.h>  // Get the value of the property. double propertyValue = floatSpinnerCommandInput_var->minimumValue(); ``` ```` |
