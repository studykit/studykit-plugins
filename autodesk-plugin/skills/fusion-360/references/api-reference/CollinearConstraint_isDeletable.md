# CollinearConstraint.isDeletable Property
...
"collinearConstraint\_var" is a variable referencing a CollinearConstraint object. ```` ``` #include <Fusion/Sketch/CollinearConstraint.h>  // Get the value of the property. boolean propertyValue = collinearConstraint_var->isDeletable(); ``` ```` |
