# MeshShellFeatures.createInput Method![](../images/TestTubeLarge.png)
...
"meshShellFeatures\_var" is a variable referencing a [MeshShellFeatures](MeshShellFeatures.htm) object.```` ``` returnValue = meshShellFeatures_var.createInput(mesh) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshShellFeatureInput](MeshShellFeatureInput.htm) | Returns the newly created MeshShellFeatureInput object or null if the creation failed. |
