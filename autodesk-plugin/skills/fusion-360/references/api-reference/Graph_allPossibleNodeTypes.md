# Graph.allPossibleNodeTypes Property![](../images/TestTubeLarge.png)
...
"graph\_var" is a variable referencing a Graph object. ```` ``` #include <Volume/Volumetric/Graph.h>  // Get the value of the property. std::vector<string> propertyValue = graph_var->allPossibleNodeTypes(); ``` ```` |
