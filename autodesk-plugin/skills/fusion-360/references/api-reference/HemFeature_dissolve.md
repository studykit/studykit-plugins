# HemFeature.dissolve Method![](../images/TestTubeLarge.png)
...
"hemFeature\_var" is a variable referencing a [HemFeature](HemFeature.htm) object.```` ``` returnValue = hemFeature_var.dissolve() ``` ```` |
