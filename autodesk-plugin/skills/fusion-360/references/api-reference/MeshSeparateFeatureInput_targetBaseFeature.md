# MeshSeparateFeatureInput.targetBaseFeature Property![](../images/TestTubeLarge.png)
...
"meshSeparateFeatureInput\_var" is a variable referencing a MeshSeparateFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshSeparateFeatureInput.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = meshSeparateFeatureInput_var->targetBaseFeature();  // Set the value of the property, where value_var is a BaseFeature. bool returnValue = meshSeparateFeatureInput_var->targetBaseFeature(value_var); ``` ```` |
