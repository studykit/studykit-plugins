...
"cAMLibraryManager\_var" is a variable referencing a CAMLibraryManager object. ```` ``` #include <Cam/Global/CAMLibraryManager.h>  // Get the value of the property. Ptr<CAMTemplateLibrary> propertyValue = cAMLibraryManager_var->templateLibrary(); ``` ```` |

## Property Value

This is a read only property whose value is a [CAMTemplateLibrary](CAMTemplateLibrary.htm).
