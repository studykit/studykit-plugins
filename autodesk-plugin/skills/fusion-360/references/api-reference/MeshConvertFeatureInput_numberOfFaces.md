# MeshConvertFeatureInput.numberOfFaces Property![](../images/TestTubeLarge.png)
...
"meshConvertFeatureInput\_var" is a variable referencing a MeshConvertFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshConvertFeatureInput.h>  // Get the value of the property. Ptr<ValueInput> propertyValue = meshConvertFeatureInput_var->numberOfFaces();  // Set the value of the property, where value_var is a ValueInput. bool returnValue = meshConvertFeatureInput_var->numberOfFaces(value_var); ``` ```` |
