# IntegerSpinnerCommandInput.minimumValue Property
...
"integerSpinnerCommandInput\_var" is a variable referencing an IntegerSpinnerCommandInput object. ```` ``` #include <Core/UserInterface/IntegerSpinnerCommandInput.h>  // Get the value of the property. integer propertyValue = integerSpinnerCommandInput_var->minimumValue(); ``` ```` |
