...
"line3D\_var" is a variable referencing a Line3D object. ```` ``` #include <Core/Geometry/Line3D.h>  // Get the value of the property. Ptr<NurbsCurve3D> propertyValue = line3D_var->asNurbsCurve(); ``` ```` |
