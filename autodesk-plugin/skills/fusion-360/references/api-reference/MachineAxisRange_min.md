...
"machineAxisRange\_var" is a variable referencing a MachineAxisRange object. ```` ``` #include <Cam/Machine/MachineAxisRange.h>  // Get the value of the property. double propertyValue = machineAxisRange_var->min(); ``` ```` |
