...
"flangeFeature\_var" is a variable referencing a FlangeFeature object. ```` ``` #include <Fusion/SheetMetal/FlangeFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = flangeFeature_var->assemblyContext(); ``` ```` |
