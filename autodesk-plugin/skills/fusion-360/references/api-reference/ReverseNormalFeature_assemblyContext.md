...
"reverseNormalFeature\_var" is a variable referencing a ReverseNormalFeature object. ```` ``` #include <Fusion/Features/ReverseNormalFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = reverseNormalFeature_var->assemblyContext(); ``` ```` |
