...
"toolbarTabs\_var" is a variable referencing a ToolbarTabs object. ```` ``` #include <Core/UserInterface/ToolbarTabs.h>  // Get the value of the property. boolean propertyValue = toolbarTabs_var->isValid(); ``` ```` |
