...
"cAMLibraryManager\_var" is a variable referencing a CAMLibraryManager object. ```` ``` #include <Cam/Global/CAMLibraryManager.h>  // Get the value of the property. Ptr<MachineLibrary> propertyValue = cAMLibraryManager_var->machineLibrary(); ``` ```` |

## Property Value

This is a read only property whose value is a [MachineLibrary](MachineLibrary.htm).
