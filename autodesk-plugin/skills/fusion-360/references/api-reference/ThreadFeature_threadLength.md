...
"threadFeature\_var" is a variable referencing a ThreadFeature object. ```` ``` #include <Fusion/Features/ThreadFeature.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = threadFeature_var->threadLength(); ``` ```` |
