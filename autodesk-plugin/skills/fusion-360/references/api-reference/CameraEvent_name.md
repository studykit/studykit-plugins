...
"cameraEvent\_var" is a variable referencing a CameraEvent object. ```` ``` #include <Core/Application/CameraEvent.h>  // Get the value of the property. string propertyValue = cameraEvent_var->name(); ``` ```` |
