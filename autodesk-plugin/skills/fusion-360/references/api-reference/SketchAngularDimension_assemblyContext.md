...
"sketchAngularDimension\_var" is a variable referencing a SketchAngularDimension object. ```` ``` #include <Fusion/Sketch/SketchAngularDimension.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchAngularDimension_var->assemblyContext(); ``` ```` |
