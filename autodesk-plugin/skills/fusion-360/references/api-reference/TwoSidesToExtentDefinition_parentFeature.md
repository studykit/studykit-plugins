...
"twoSidesToExtentDefinition\_var" is a variable referencing a TwoSidesToExtentDefinition object. ```` ``` #include <Fusion/Features/TwoSidesToExtentDefinition.h>  // Get the value of the property. Ptr<Feature> propertyValue = twoSidesToExtentDefinition_var->parentFeature(); ``` ```` |
