# FloatSliderCommandInput.id Property
...
"floatSliderCommandInput\_var" is a variable referencing a FloatSliderCommandInput object. ```` ``` #include <Core/UserInterface/FloatSliderCommandInput.h>  // Get the value of the property. string propertyValue = floatSliderCommandInput_var->id(); ``` ```` |
