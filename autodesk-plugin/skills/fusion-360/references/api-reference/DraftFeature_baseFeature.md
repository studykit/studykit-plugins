# DraftFeature.baseFeature Property
...
"draftFeature\_var" is a variable referencing a DraftFeature object. ```` ``` #include <Fusion/Features/DraftFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = draftFeature_var->baseFeature(); ``` ```` |
