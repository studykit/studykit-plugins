# MeshRepairFeatureInput.mesh Property![](../images/TestTubeLarge.png)
...
"meshRepairFeatureInput\_var" is a variable referencing a MeshRepairFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshRepairFeatureInput.h>  // Get the value of the property. Ptr<Base> propertyValue = meshRepairFeatureInput_var->mesh();  // Set the value of the property, where value_var is a Base. bool returnValue = meshRepairFeatureInput_var->mesh(value_var); ``` ```` |
