...
"machineLibrary\_var" is a variable referencing a [MachineLibrary](MachineLibrary.htm) object.```` ``` returnValue = machineLibrary_var.childMachines(url) ``` ```` |
...
| url | [URL](URL.htm) | The URL of the folder to get machines from. |
