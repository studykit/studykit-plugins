# MeshSeparateFeatures.item Method![](../images/TestTubeLarge.png)
...
"meshSeparateFeatures\_var" is a variable referencing a [MeshSeparateFeatures](MeshSeparateFeatures.htm) object.```` ``` returnValue = meshSeparateFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshSeparateFeature](MeshSeparateFeature.htm) | Returns the specified item or null if an invalid index was specified. |
