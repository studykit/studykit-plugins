...
"toolQuery\_var" is a variable referencing a ToolQuery object. ```` ``` #include <Cam/Tools/ToolQuery.h>  // Get the value of the property. Ptr<NamedValues> propertyValue = toolQuery_var->criteria(); ``` ```` |

## Property Value

This is a read only property whose value is a [NamedValues](NamedValues.htm).
