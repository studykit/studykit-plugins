...
"bRepCoEdge\_var" is a variable referencing a BRepCoEdge object. ```` ``` #include <Fusion/BRep/BRepCoEdge.h>  // Get the value of the property. Ptr<CurveEvaluator2D> propertyValue = bRepCoEdge_var->evaluator(); ``` ```` |
