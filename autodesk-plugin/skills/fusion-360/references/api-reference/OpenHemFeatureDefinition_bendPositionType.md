# OpenHemFeatureDefinition.bendPositionType Property![](../images/TestTubeLarge.png)
...
"openHemFeatureDefinition\_var" is a variable referencing an OpenHemFeatureDefinition object. ```` ``` #include <Fusion/SheetMetal/OpenHemFeatureDefinition.h>  // Get the value of the property. BendPositionTypes propertyValue = openHemFeatureDefinition_var->bendPositionType();  // Set the value of the property, where value_var is a BendPositionTypes. bool returnValue = openHemFeatureDefinition_var->bendPositionType(value_var); ``` ```` |
