...
"sketchRadialDimension\_var" is a variable referencing a SketchRadialDimension object. ```` ``` #include <Fusion/Sketch/SketchRadialDimension.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchRadialDimension_var->assemblyContext(); ``` ```` |
