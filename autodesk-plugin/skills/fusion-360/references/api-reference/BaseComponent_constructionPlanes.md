# BaseComponent.constructionPlanes Property
...
"baseComponent\_var" is a variable referencing a BaseComponent object. ```` ``` #include <Fusion/Components/BaseComponent.h>  // Get the value of the property. Ptr<ConstructionPlanes> propertyValue = baseComponent_var->constructionPlanes(); ``` ```` |
