# MeshRepairFeature.isSuppressed Property![](../images/TestTubeLarge.png)
...
"meshRepairFeature\_var" is a variable referencing a MeshRepairFeature object. ```` ``` #include <Fusion/MeshBody/MeshRepairFeature.h>  // Get the value of the property. boolean propertyValue = meshRepairFeature_var->isSuppressed();  // Set the value of the property, where value_var is a boolean. bool returnValue = meshRepairFeature_var->isSuppressed(value_var); ``` ```` |
