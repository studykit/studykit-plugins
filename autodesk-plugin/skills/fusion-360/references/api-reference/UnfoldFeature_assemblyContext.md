...
"unfoldFeature\_var" is a variable referencing a UnfoldFeature object. ```` ``` #include <Fusion/SheetMetal/UnfoldFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = unfoldFeature_var->assemblyContext(); ``` ```` |
