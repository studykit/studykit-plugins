# SplitFaceFeature.nativeObject Property
...
"splitFaceFeature\_var" is a variable referencing a SplitFaceFeature object. ```` ``` #include <Fusion/Features/SplitFaceFeature.h>  // Get the value of the property. Ptr<SplitFaceFeature> propertyValue = splitFaceFeature_var->nativeObject(); ``` ```` |

## Property Value

This is a read only property whose value is a [SplitFaceFeature](SplitFaceFeature.htm).
