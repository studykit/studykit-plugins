# CustomFeatureParameter.value Property![](../images/TestTubeLarge.png)
...
"customFeatureParameter\_var" is a variable referencing a CustomFeatureParameter object. ```` ``` #include <Fusion/Features/CustomFeatureParameter.h>  // Get the value of the property. double propertyValue = customFeatureParameter_var->value();  // Set the value of the property, where value_var is a double. bool returnValue = customFeatureParameter_var->value(value_var); ``` ```` |
