# ConcentricConstraint.entityOne Property
...
"concentricConstraint\_var" is a variable referencing a ConcentricConstraint object. ```` ``` #include <Fusion/Sketch/ConcentricConstraint.h>  // Get the value of the property. Ptr<SketchCurve> propertyValue = concentricConstraint_var->entityOne(); ``` ```` |
