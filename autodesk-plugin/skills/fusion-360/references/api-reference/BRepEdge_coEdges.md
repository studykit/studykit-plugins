...
"bRepEdge\_var" is a variable referencing a BRepEdge object. ```` ``` #include <Fusion/BRep/BRepEdge.h>  // Get the value of the property. Ptr<BRepCoEdges> propertyValue = bRepEdge_var->coEdges(); ``` ```` |
