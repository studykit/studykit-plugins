...
"configurationAppearanceColumns\_var" is a variable referencing a [ConfigurationAppearanceColumns](ConfigurationAppearanceColumns.htm) object.```` ``` returnValue = configurationAppearanceColumns_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [ConfigurationAppearanceColumn](ConfigurationAppearanceColumn.htm) | Returns the specified column or null if an invalid index was specified. |
