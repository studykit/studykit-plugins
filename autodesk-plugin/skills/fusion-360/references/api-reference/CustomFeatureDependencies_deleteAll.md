# CustomFeatureDependencies.deleteAll Method![](../images/TestTubeLarge.png)
...
"customFeatureDependencies\_var" is a variable referencing a [CustomFeatureDependencies](CustomFeatureDependencies.htm) object.```` ``` returnValue = customFeatureDependencies_var.deleteAll() ``` ```` |
