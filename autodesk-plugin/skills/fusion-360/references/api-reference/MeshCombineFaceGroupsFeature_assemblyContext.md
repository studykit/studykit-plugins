# MeshCombineFaceGroupsFeature.assemblyContext Property![](../images/TestTubeLarge.png)
...
"meshCombineFaceGroupsFeature\_var" is a variable referencing a MeshCombineFaceGroupsFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFaceGroupsFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = meshCombineFaceGroupsFeature_var->assemblyContext(); ``` ```` |
