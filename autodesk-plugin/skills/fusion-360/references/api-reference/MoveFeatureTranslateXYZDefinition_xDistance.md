# MoveFeatureTranslateXYZDefinition.xDistance Property
...
"moveFeatureTranslateXYZDefinition\_var" is a variable referencing a MoveFeatureTranslateXYZDefinition object. ```` ``` #include <Fusion/Features/MoveFeatureTranslateXYZDefinition.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = moveFeatureTranslateXYZDefinition_var->xDistance(); ``` ```` |
