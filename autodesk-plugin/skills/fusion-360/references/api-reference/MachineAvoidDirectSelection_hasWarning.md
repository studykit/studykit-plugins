# MachineAvoidDirectSelection.hasWarning Property
...
"machineAvoidDirectSelection\_var" is a variable referencing a MachineAvoidDirectSelection object. ```` ``` #include <Cam/MachineAvoidSelections/MachineAvoidDirectSelection.h>  // Get the value of the property. boolean propertyValue = machineAvoidDirectSelection_var->hasWarning(); ``` ```` |
