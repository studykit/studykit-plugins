# ControllerConfigurationMachineElement.nonTcpRapidInterpolationMode Property![](../images/TestTubeLarge.png)
...
"controllerConfigurationMachineElement\_var" is a variable referencing a ControllerConfigurationMachineElement object. ```` ``` #include <Cam/Machine/ControllerConfigurationMachineElement.h>  // Get the value of the property. MachineNonTCPInterpolationMode propertyValue = controllerConfigurationMachineElement_var->nonTcpRapidInterpolationMode();  // Set the value of the property, where value_var is a MachineNonTCPInterpolationMode. bool returnValue = controllerConfigurationMachineElement_var->nonTcpRapidInterpolationMode(value_var); ``` ```` |

## Property Value

This is a read/write property whose value is a [MachineNonTCPInterpolationMode](MachineNonTCPInterpolationMode.htm).
