...
"measureResults\_var" is a variable referencing a MeasureResults object. ```` ``` #include <Core/Application/MeasureResults.h>  // Get the value of the property. Ptr<Point3D> propertyValue = measureResults_var->positionTwo(); ``` ```` |
