# RectangularPatternFeature.directionOne Property
...
"rectangularPatternFeature\_var" is a variable referencing a RectangularPatternFeature object. ```` ``` #include <Fusion/Features/RectangularPatternFeature.h>  // Get the value of the property. Ptr<Vector3D> propertyValue = rectangularPatternFeature_var->directionOne(); ``` ```` |
