# TessellateFeatures.itemByName Method![](../images/TestTubeLarge.png)
...
"tessellateFeatures\_var" is a variable referencing a [TessellateFeatures](TessellateFeatures.htm) object.```` ``` returnValue = tessellateFeatures_var.itemByName(name) ``` ```` |
...
| --- | --- |
| Type | Description |
| [TessellateFeature](TessellateFeature.htm) | Returns the specified item or null if the specified name was not found. |
