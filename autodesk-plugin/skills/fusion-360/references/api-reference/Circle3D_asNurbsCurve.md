# Circle3D.asNurbsCurve Property
...
"circle3D\_var" is a variable referencing a Circle3D object. ```` ``` #include <Core/Geometry/Circle3D.h>  // Get the value of the property. Ptr<NurbsCurve3D> propertyValue = circle3D_var->asNurbsCurve(); ``` ```` |
