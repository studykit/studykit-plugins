# MeshSeparateFeature.isKeepBody Property![](../images/TestTubeLarge.png)
...
"meshSeparateFeature\_var" is a variable referencing a MeshSeparateFeature object. ```` ``` #include <Fusion/MeshBody/MeshSeparateFeature.h>  // Get the value of the property. boolean propertyValue = meshSeparateFeature_var->isKeepBody();  // Set the value of the property, where value_var is a boolean. bool returnValue = meshSeparateFeature_var->isKeepBody(value_var); ``` ```` |
