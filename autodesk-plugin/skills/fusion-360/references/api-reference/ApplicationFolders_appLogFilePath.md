# ApplicationFolders.appLogFilePath Property
...
"applicationFolders\_var" is a variable referencing an ApplicationFolders object. ```` ``` #include <Core/Application/ApplicationFolders.h>  // Get the value of the property. string propertyValue = applicationFolders_var->appLogFilePath(); ``` ```` |
