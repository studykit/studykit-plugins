# MeshReduceFeatures.itemByName Method![](../images/TestTubeLarge.png)
...
"meshReduceFeatures\_var" is a variable referencing a [MeshReduceFeatures](MeshReduceFeatures.htm) object.```` ``` returnValue = meshReduceFeatures_var.itemByName(name) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshReduceFeature](MeshReduceFeature.htm) | Returns the specified item or null if the specified name was not found. |
