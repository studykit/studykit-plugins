# ScalarControlPointMapGraphNodeProperty.clear Method![](../images/TestTubeLarge.png)
...
"scalarControlPointMapGraphNodeProperty\_var" is a variable referencing a [ScalarControlPointMapGraphNodeProperty](ScalarControlPointMapGraphNodeProperty.htm) object.```` ``` returnValue = scalarControlPointMapGraphNodeProperty_var.clear() ``` ```` |
