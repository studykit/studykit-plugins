# MeshRemeshFeatures.item Method![](../images/TestTubeLarge.png)
...
"meshRemeshFeatures\_var" is a variable referencing a [MeshRemeshFeatures](MeshRemeshFeatures.htm) object.```` ``` returnValue = meshRemeshFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshRemeshFeature](MeshRemeshFeature.htm) | Returns the specified item or null if an invalid index was specified. |
