# MeshShellFeature.linkedFeatures Property![](../images/TestTubeLarge.png)
...
"meshShellFeature\_var" is a variable referencing a MeshShellFeature object. ```` ``` #include <Fusion/MeshBody/MeshShellFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = meshShellFeature_var->linkedFeatures(); ``` ```` |
