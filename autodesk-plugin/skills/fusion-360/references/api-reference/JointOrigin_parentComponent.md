# JointOrigin.parentComponent Property
...
"jointOrigin\_var" is a variable referencing a JointOrigin object. ```` ``` #include <Fusion/Components/JointOrigin.h>  // Get the value of the property. Ptr<Component> propertyValue = jointOrigin_var->parentComponent(); ``` ```` |
