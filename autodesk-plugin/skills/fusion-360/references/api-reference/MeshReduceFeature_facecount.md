# MeshReduceFeature.facecount Property![](../images/TestTubeLarge.png)
...
"meshReduceFeature\_var" is a variable referencing a MeshReduceFeature object. ```` ``` #include <Fusion/MeshBody/MeshReduceFeature.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = meshReduceFeature_var->facecount(); ``` ```` |
