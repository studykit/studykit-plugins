# SketchText.parentSketch Property
...
"sketchText\_var" is a variable referencing a SketchText object. ```` ``` #include <Fusion/Sketch/SketchText.h>  // Get the value of the property. Ptr<Sketch> propertyValue = sketchText_var->parentSketch(); ``` ```` |
