# TessellateFeature.aspectRatio Property![](../images/TestTubeLarge.png)
...
"tessellateFeature\_var" is a variable referencing a TessellateFeature object. ```` ``` #include <Fusion/MeshBody/TessellateFeature.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = tessellateFeature_var->aspectRatio(); ``` ```` |
