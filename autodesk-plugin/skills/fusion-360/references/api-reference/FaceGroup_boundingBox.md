# FaceGroup.boundingBox Property![](../images/TestTubeLarge.png)
...
"faceGroup\_var" is a variable referencing a FaceGroup object. ```` ``` #include <Fusion/MeshBody/FaceGroup.h>  // Get the value of the property. Ptr<BoundingBox3D> propertyValue = faceGroup_var->boundingBox(); ``` ```` |
