...
"boundaryFillFeature\_var" is a variable referencing a BoundaryFillFeature object. ```` ``` #include <Fusion/Features/BoundaryFillFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = boundaryFillFeature_var->linkedFeatures(); ``` ```` |
