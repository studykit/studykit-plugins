# BooleanGraphNodeProperty.name Property![](../images/TestTubeLarge.png)
...
"booleanGraphNodeProperty\_var" is a variable referencing a BooleanGraphNodeProperty object. ```` ``` #include <Volume/Volumetric/BooleanGraphNodeProperty.h>  // Get the value of the property. string propertyValue = booleanGraphNodeProperty_var->name(); ``` ```` |
