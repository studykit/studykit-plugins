...
"sketchConicCurve\_var" is a variable referencing a SketchConicCurve object. ```` ``` #include <Fusion/Sketch/SketchConicCurve.h>  // Get the value of the property. Ptr<Base> propertyValue = sketchConicCurve_var->referencedEntity(); ``` ```` |
