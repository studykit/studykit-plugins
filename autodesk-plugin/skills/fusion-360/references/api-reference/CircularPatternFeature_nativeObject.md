# CircularPatternFeature.nativeObject Property
...
"circularPatternFeature\_var" is a variable referencing a CircularPatternFeature object. ```` ``` #include <Fusion/Features/CircularPatternFeature.h>  // Get the value of the property. Ptr<CircularPatternFeature> propertyValue = circularPatternFeature_var->nativeObject(); ``` ```` |

## Property Value

This is a read only property whose value is a [CircularPatternFeature](CircularPatternFeature.htm).
