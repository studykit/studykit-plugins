...
"timelineObject\_var" is a variable referencing a [TimelineObject](TimelineObject.htm) object.```` ``` returnValue = timelineObject_var.rollTo(rollBefore) ``` ```` |

"timelineObject\_var" is a variable referencing a [TimelineObject](TimelineObject.htm) object. |
