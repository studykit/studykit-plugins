...
"arrangeEnvelopeInput\_var" is a variable referencing an ArrangeEnvelopeInput object. |

"arrangeEnvelopeInput\_var" is a variable referencing an ArrangeEnvelopeInput object. ```` ``` #include <Fusion/Arrange/ArrangeEnvelopeInput.h>  // Get the value of the property. boolean propertyValue = arrangeEnvelopeInput_var->isPartialArrangeAllowed();  // Set the value of the property, where value_var is a boolean. bool returnValue = arrangeEnvelopeInput_var->isPartialArrangeAllowed(value_var); ``` ```` |
