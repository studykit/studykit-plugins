...
"optimizedOrientationResults\_var" is a variable referencing an [OptimizedOrientationResults](OptimizedOrientationResults.htm) object.```` ``` returnValue = optimizedOrientationResults_var.item(index) ``` ```` |

"optimizedOrientationResults\_var" is a variable referencing an [OptimizedOrientationResults](OptimizedOrientationResults.htm) object. |
