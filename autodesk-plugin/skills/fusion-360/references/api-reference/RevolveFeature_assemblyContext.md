...
"revolveFeature\_var" is a variable referencing a RevolveFeature object. ```` ``` #include <Fusion/Features/RevolveFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = revolveFeature_var->assemblyContext(); ``` ```` |
