# IntegerSpinnerCommandInput.id Property
...
"integerSpinnerCommandInput\_var" is a variable referencing an IntegerSpinnerCommandInput object. ```` ``` #include <Core/UserInterface/IntegerSpinnerCommandInput.h>  // Get the value of the property. string propertyValue = integerSpinnerCommandInput_var->id(); ``` ```` |
