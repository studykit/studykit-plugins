# GeometricRelationship.entityTwo Property![](../images/TestTubeLarge.png)
...
"geometricRelationship\_var" is a variable referencing a GeometricRelationship object. ```` ``` #include <Fusion/Components/GeometricRelationship.h>  // Get the value of the property. Ptr<Base> propertyValue = geometricRelationship_var->entityTwo();  // Set the value of the property, where value_var is a Base. bool returnValue = geometricRelationship_var->entityTwo(value_var); ``` ```` |
