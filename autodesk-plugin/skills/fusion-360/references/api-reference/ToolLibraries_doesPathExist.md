# ToolLibraries.doesPathExist Method![](../images/TestTubeLarge.png)
...
"toolLibraries\_var" is a variable referencing a [ToolLibraries](ToolLibraries.htm) object.```` ``` returnValue = toolLibraries_var.doesPathExist(url) ``` ```` |
