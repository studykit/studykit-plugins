# StringGraphNodeProperty.description Property![](../images/TestTubeLarge.png)
...
"stringGraphNodeProperty\_var" is a variable referencing a StringGraphNodeProperty object. ```` ``` #include <Volume/Volumetric/StringGraphNodeProperty.h>  // Get the value of the property. string propertyValue = stringGraphNodeProperty_var->description(); ``` ```` |
