# GraphNodeProperty.name Property![](../images/TestTubeLarge.png)
...
"graphNodeProperty\_var" is a variable referencing a GraphNodeProperty object. ```` ``` #include <Volume/Volumetric/GraphNodeProperty.h>  // Get the value of the property. string propertyValue = graphNodeProperty_var->name(); ``` ```` |
