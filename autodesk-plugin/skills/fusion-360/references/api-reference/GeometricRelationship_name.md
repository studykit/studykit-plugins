# GeometricRelationship.name Property![](../images/TestTubeLarge.png)
...
"geometricRelationship\_var" is a variable referencing a GeometricRelationship object. ```` ``` #include <Fusion/Components/GeometricRelationship.h>  // Get the value of the property. string propertyValue = geometricRelationship_var->name(); ``` ```` |
