...
"profileLoop\_var" is a variable referencing a ProfileLoop object. ```` ``` #include <Fusion/Sketch/ProfileLoop.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = profileLoop_var->assemblyContext(); ``` ```` |
