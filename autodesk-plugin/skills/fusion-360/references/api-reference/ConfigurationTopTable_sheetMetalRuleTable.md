...
"configurationTopTable\_var" is a variable referencing a ConfigurationTopTable object. ```` ``` #include <Fusion/Configurations/ConfigurationTopTable.h>  // Get the value of the property. Ptr<ConfigurationSheetMetalRuleTable> propertyValue = configurationTopTable_var->sheetMetalRuleTable(); ``` ```` |

## Property Value

This is a read only property whose value is a [ConfigurationSheetMetalRuleTable](ConfigurationSheetMetalRuleTable.htm).
