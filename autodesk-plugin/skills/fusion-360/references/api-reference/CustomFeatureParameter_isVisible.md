# CustomFeatureParameter.isVisible Property![](../images/TestTubeLarge.png)
...
"customFeatureParameter\_var" is a variable referencing a CustomFeatureParameter object. ```` ``` #include <Fusion/Features/CustomFeatureParameter.h>  // Get the value of the property. boolean propertyValue = customFeatureParameter_var->isVisible();  // Set the value of the property, where value_var is a boolean. bool returnValue = customFeatureParameter_var->isVisible(value_var); ``` ```` |
