...
"moveFeatureInput\_var" is a variable referencing a [MoveFeatureInput](MoveFeatureInput.htm) object.```` ``` returnValue = moveFeatureInput_var.defineAsPointToPosition(point, xDistance, yDistance, zDistance, isDesignSpace) ``` ```` |
