...
"variableRadiusFilletEdgeSet\_var" is a variable referencing a VariableRadiusFilletEdgeSet object. ```` ``` #include <Fusion/Features/VariableRadiusFilletEdgeSet.h>  // Get the value of the property. SurfaceContinuityTypes propertyValue = variableRadiusFilletEdgeSet_var->continuity();  // Set the value of the property, where value_var is a SurfaceContinuityTypes. bool returnValue = variableRadiusFilletEdgeSet_var->continuity(value_var); ``` ```` |
