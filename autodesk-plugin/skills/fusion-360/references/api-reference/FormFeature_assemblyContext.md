...
"formFeature\_var" is a variable referencing a FormFeature object. ```` ``` #include <Fusion/Features/FormFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = formFeature_var->assemblyContext(); ``` ```` |
