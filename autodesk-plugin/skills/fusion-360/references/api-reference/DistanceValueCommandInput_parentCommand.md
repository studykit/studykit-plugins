# DistanceValueCommandInput.parentCommand Property
...
"distanceValueCommandInput\_var" is a variable referencing a DistanceValueCommandInput object. ```` ``` #include <Core/UserInterface/DistanceValueCommandInput.h>  // Get the value of the property. Ptr<Command> propertyValue = distanceValueCommandInput_var->parentCommand(); ``` ```` |
