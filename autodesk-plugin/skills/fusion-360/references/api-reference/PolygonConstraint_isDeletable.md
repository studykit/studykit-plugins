...
"polygonConstraint\_var" is a variable referencing a PolygonConstraint object. ```` ``` #include <Fusion/Sketch/PolygonConstraint.h>  // Get the value of the property. boolean propertyValue = polygonConstraint_var->isDeletable(); ``` ```` |
