# AssemblyConstraint.deleteMe Method![](../images/TestTubeLarge.png)
...
"assemblyConstraint\_var" is a variable referencing an [AssemblyConstraint](AssemblyConstraint.htm) object.```` ``` returnValue = assemblyConstraint_var.deleteMe() ``` ```` |
