...
"extendFeature\_var" is a variable referencing an ExtendFeature object. ```` ``` #include <Fusion/Features/ExtendFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = extendFeature_var->assemblyContext(); ``` ```` |
