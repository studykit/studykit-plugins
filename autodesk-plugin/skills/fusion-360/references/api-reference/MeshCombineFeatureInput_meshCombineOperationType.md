# MeshCombineFeatureInput.meshCombineOperationType Property![](../images/TestTubeLarge.png)
...
"meshCombineFeatureInput\_var" is a variable referencing a MeshCombineFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshCombineFeatureInput.h>  // Get the value of the property. MeshCombineOperationTypes propertyValue = meshCombineFeatureInput_var->meshCombineOperationType();  // Set the value of the property, where value_var is a MeshCombineOperationTypes. bool returnValue = meshCombineFeatureInput_var->meshCombineOperationType(value_var); ``` ```` |
