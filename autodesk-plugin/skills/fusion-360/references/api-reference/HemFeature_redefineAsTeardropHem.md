# HemFeature.redefineAsTeardropHem Method![](../images/TestTubeLarge.png)
...
"hemFeature\_var" is a variable referencing a [HemFeature](HemFeature.htm) object.```` ``` returnValue = hemFeature_var.redefineAsTeardropHem(radius, length, gap, isFlipped, bendPositionType) ``` ```` |
...
| length | [ValueInput](ValueInput.htm) | The length of the teardrop hem. |
