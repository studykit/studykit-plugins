# MeshSmoothFeatureInput.mesh Property![](../images/TestTubeLarge.png)
...
"meshSmoothFeatureInput\_var" is a variable referencing a MeshSmoothFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshSmoothFeatureInput.h>  // Get the value of the property. Ptr<Base> propertyValue = meshSmoothFeatureInput_var->mesh();  // Set the value of the property, where value_var is a Base. bool returnValue = meshSmoothFeatureInput_var->mesh(value_var); ``` ```` |
