# VolumetricModel.createSampler Method![](../images/TestTubeLarge.png)
...
"volumetricModel\_var" is a variable referencing a [VolumetricModel](VolumetricModel.htm) object.```` ``` returnValue = volumetricModel_var.createSampler() ``` ```` |
...
| --- | --- |
| Type | Description |
| [VolumetricSampler](VolumetricSampler.htm) | Returns a VolumetricSampler object that will sample this VolumetricModel. |
