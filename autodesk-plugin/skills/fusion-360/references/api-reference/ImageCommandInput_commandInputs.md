# ImageCommandInput.commandInputs Property
...
"imageCommandInput\_var" is a variable referencing an ImageCommandInput object. ```` ``` #include <Core/UserInterface/ImageCommandInput.h>  // Get the value of the property. Ptr<CommandInputs> propertyValue = imageCommandInput_var->commandInputs(); ``` ```` |
