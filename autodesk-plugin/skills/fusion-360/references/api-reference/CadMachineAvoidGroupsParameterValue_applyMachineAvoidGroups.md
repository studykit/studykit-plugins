...
"cadMachineAvoidGroupsParameterValue\_var" is a variable referencing a [CadMachineAvoidGroupsParameterValue](CadMachineAvoidGroupsParameterValue.htm) object.```` ``` returnValue = cadMachineAvoidGroupsParameterValue_var.applyMachineAvoidGroups(machineAvoidSelectionGroups) ``` ```` |

"cadMachineAvoidGroupsParameterValue\_var" is a variable referencing a [CadMachineAvoidGroupsParameterValue](CadMachineAvoidGroupsParameterValue.htm) object. |
...
| machineAvoidSelectionGroups | [MachineAvoidGroups](MachineAvoidGroups.htm) |  |
