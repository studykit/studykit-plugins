# CurvatureCombAnalysis.name Property
...
"curvatureCombAnalysis\_var" is a variable referencing a CurvatureCombAnalysis object. ```` ``` #include <Fusion/Fusion/CurvatureCombAnalysis.h>  // Get the value of the property. string propertyValue = curvatureCombAnalysis_var->name();  // Set the value of the property, where value_var is a string. bool returnValue = curvatureCombAnalysis_var->name(value_var); ``` ```` |
