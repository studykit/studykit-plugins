# CustomFeatureDependencies.item Method![](../images/TestTubeLarge.png)
...
"customFeatureDependencies\_var" is a variable referencing a [CustomFeatureDependencies](CustomFeatureDependencies.htm) object.```` ``` returnValue = customFeatureDependencies_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [CustomFeatureDependency](CustomFeatureDependency.htm) | Returns the specified item or null if an invalid index was specified. |
