# DropDownCommandInput.parentCommandInput Property
...
"dropDownCommandInput\_var" is a variable referencing a DropDownCommandInput object. ```` ``` #include <Core/UserInterface/DropDownCommandInput.h>  // Get the value of the property. Ptr<CommandInput> propertyValue = dropDownCommandInput_var->parentCommandInput(); ``` ```` |
