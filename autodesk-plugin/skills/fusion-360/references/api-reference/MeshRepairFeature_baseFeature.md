# MeshRepairFeature.baseFeature Property![](../images/TestTubeLarge.png)
...
"meshRepairFeature\_var" is a variable referencing a MeshRepairFeature object. ```` ``` #include <Fusion/MeshBody/MeshRepairFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = meshRepairFeature_var->baseFeature(); ``` ```` |
