# IntegerSliderCommandInput.toolClipFilename Property
...
"integerSliderCommandInput\_var" is a variable referencing an IntegerSliderCommandInput object. ```` ``` #include <Core/UserInterface/IntegerSliderCommandInput.h>  // Get the value of the property. string propertyValue = integerSliderCommandInput_var->toolClipFilename();  // Set the value of the property, where value_var is a string. bool returnValue = integerSliderCommandInput_var->toolClipFilename(value_var); ``` ```` |
