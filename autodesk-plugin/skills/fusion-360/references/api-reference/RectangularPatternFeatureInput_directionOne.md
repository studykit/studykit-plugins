# RectangularPatternFeatureInput.directionOne Property
...
"rectangularPatternFeatureInput\_var" is a variable referencing a RectangularPatternFeatureInput object. ```` ``` #include <Fusion/Features/RectangularPatternFeatureInput.h>  // Get the value of the property. Ptr<Vector3D> propertyValue = rectangularPatternFeatureInput_var->directionOne(); ``` ```` |
