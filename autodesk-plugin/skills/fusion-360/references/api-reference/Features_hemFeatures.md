# Features.hemFeatures Property![](../images/TestTubeLarge.png)
...
"features\_var" is a variable referencing a Features object. ```` ``` #include <Fusion/Features/Features.h>  // Get the value of the property. Ptr<HemFeatures> propertyValue = features_var->hemFeatures(); ``` ```` |

## Property Value

This is a read only property whose value is a [HemFeatures](HemFeatures.htm).
