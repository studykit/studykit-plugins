...
"combineFeature\_var" is a variable referencing a CombineFeature object. ```` ``` #include <Fusion/Features/CombineFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = combineFeature_var->linkedFeatures(); ``` ```` |
