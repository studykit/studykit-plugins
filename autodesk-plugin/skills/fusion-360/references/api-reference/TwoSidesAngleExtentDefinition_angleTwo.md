...
"twoSidesAngleExtentDefinition\_var" is a variable referencing a TwoSidesAngleExtentDefinition object. ```` ``` #include <Fusion/Features/TwoSidesAngleExtentDefinition.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = twoSidesAngleExtentDefinition_var->angleTwo(); ``` ```` |
