...
"recognizedHoleGroup\_var" is a variable referencing a [RecognizedHoleGroup](RecognizedHoleGroup.htm) object.```` ``` returnValue = recognizedHoleGroup_var.item(index) ``` ```` |

"recognizedHoleGroup\_var" is a variable referencing a [RecognizedHoleGroup](RecognizedHoleGroup.htm) object. |
