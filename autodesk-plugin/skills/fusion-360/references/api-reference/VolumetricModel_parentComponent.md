# VolumetricModel.parentComponent Property![](../images/TestTubeLarge.png)
...
"volumetricModel\_var" is a variable referencing a VolumetricModel object. ```` ``` #include <Volume/Volumetric/VolumetricModel.h>  // Get the value of the property. Ptr<Component> propertyValue = volumetricModel_var->parentComponent(); ``` ```` |
