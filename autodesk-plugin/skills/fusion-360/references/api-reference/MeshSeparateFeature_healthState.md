# MeshSeparateFeature.healthState Property![](../images/TestTubeLarge.png)
...
"meshSeparateFeature\_var" is a variable referencing a MeshSeparateFeature object. ```` ``` #include <Fusion/MeshBody/MeshSeparateFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = meshSeparateFeature_var->healthState(); ``` ```` |
