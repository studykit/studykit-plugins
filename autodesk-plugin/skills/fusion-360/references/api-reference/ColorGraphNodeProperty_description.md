# ColorGraphNodeProperty.description Property![](../images/TestTubeLarge.png)
...
"colorGraphNodeProperty\_var" is a variable referencing a ColorGraphNodeProperty object. ```` ``` #include <Volume/Volumetric/ColorGraphNodeProperty.h>  // Get the value of the property. string propertyValue = colorGraphNodeProperty_var->description(); ``` ```` |
