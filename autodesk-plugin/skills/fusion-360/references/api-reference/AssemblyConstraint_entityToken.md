# AssemblyConstraint.entityToken Property![](../images/TestTubeLarge.png)
...
"assemblyConstraint\_var" is a variable referencing an AssemblyConstraint object. ```` ``` #include <Fusion/Components/AssemblyConstraint.h>  // Get the value of the property. string propertyValue = assemblyConstraint_var->entityToken(); ``` ```` |
