# GraphNode.getOutputPinCount Method![](../images/TestTubeLarge.png)
...
"graphNode\_var" is a variable referencing a [GraphNode](GraphNode.htm) object.```` ``` returnValue = graphNode_var.getOutputPinCount() ``` ```` |
