...
"bRepShell\_var" is a variable referencing a BRepShell object. ```` ``` #include <Fusion/BRep/BRepShell.h>  // Get the value of the property. Ptr<BRepVertices> propertyValue = bRepShell_var->vertices(); ``` ```` |
