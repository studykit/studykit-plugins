# TransformRefGraphNodeProperty.name Property![](../images/TestTubeLarge.png)
...
"transformRefGraphNodeProperty\_var" is a variable referencing a TransformRefGraphNodeProperty object. ```` ``` #include <Volume/Volumetric/TransformRefGraphNodeProperty.h>  // Get the value of the property. string propertyValue = transformRefGraphNodeProperty_var->name(); ``` ```` |
