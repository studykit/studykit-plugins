...
"sphereFeature\_var" is a variable referencing a SphereFeature object. ```` ``` #include <Fusion/Features/SphereFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = sphereFeature_var->linkedFeatures(); ``` ```` |
