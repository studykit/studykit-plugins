...
"mirrorFeature\_var" is a variable referencing a MirrorFeature object. ```` ``` #include <Fusion/Features/MirrorFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = mirrorFeature_var->assemblyContext(); ``` ```` |
