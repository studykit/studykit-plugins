...
"jointOriginInput\_var" is a variable referencing a JointOriginInput object. ```` ``` #include <Fusion/Components/JointOriginInput.h>  // Get the value of the property. Ptr<Vector3D> propertyValue = jointOriginInput_var->thirdAxisVector(); ``` ```` |
