# SilhouetteSplitFeature.baseFeature Property
...
"silhouetteSplitFeature\_var" is a variable referencing a SilhouetteSplitFeature object. ```` ``` #include <Fusion/Features/SilhouetteSplitFeature.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = silhouetteSplitFeature_var->baseFeature(); ``` ```` |
