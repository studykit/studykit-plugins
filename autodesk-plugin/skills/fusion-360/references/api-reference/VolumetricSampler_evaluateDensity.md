# VolumetricSampler.evaluateDensity Method![](../images/TestTubeLarge.png)
...
"volumetricSampler\_var" is a variable referencing a [VolumetricSampler](VolumetricSampler.htm) object.```` ``` returnValue = volumetricSampler_var.evaluateDensity() ``` ```` |
...
| --- | --- |
| Type | Description |
| [VolumetricScalarSample](VolumetricScalarSample.htm)[] | An array of VolumetricScalarSample objects that contain the results of sampling the volumetric model. |
