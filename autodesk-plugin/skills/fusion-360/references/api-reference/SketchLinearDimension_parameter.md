# SketchLinearDimension.parameter Property
...
"sketchLinearDimension\_var" is a variable referencing a SketchLinearDimension object. ```` ``` #include <Fusion/Sketch/SketchLinearDimension.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = sketchLinearDimension_var->parameter(); ``` ```` |
