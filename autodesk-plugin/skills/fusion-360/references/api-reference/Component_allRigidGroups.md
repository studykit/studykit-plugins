...
"component\_var" is a variable referencing a Component object. ```` ``` #include <Fusion/Components/Component.h>  // Get the value of the property. std::vector<Ptr<RigidGroup>> propertyValue = component_var->allRigidGroups(); ``` ```` |
