# UserParameter.textValue Property![](../images/TestTubeLarge.png)
...
"userParameter\_var" is a variable referencing a UserParameter object. ```` ``` #include <Fusion/Fusion/UserParameter.h>  // Get the value of the property. string propertyValue = userParameter_var->textValue();  // Set the value of the property, where value_var is a string. bool returnValue = userParameter_var->textValue(value_var); ``` ```` |
