...
"sketchEllipticalArc\_var" is a variable referencing a SketchEllipticalArc object. ```` ``` #include <Fusion/Sketch/SketchEllipticalArc.h>  // Get the value of the property. boolean propertyValue = sketchEllipticalArc_var->isDeletable(); ``` ```` |
