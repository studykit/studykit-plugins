...
"renderFuture\_var" is a variable referencing a RenderFuture object. ```` ``` #include <Fusion/Render/RenderFuture.h>  // Get the value of the property. LocalRenderStates propertyValue = renderFuture_var->renderState(); ``` ```` |

## Property Value

This is a read only property whose value is a [LocalRenderStates](LocalRenderStates.htm).
