# GeometrySelection.error Property
...
"geometrySelection\_var" is a variable referencing a GeometrySelection object. ```` ``` #include <Cam/GeometrySelections/GeometrySelection.h>  // Get the value of the property. string propertyValue = geometrySelection_var->error(); ``` ```` |
