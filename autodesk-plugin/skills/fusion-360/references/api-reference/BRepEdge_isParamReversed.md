...
"bRepEdge\_var" is a variable referencing a BRepEdge object. ```` ``` #include <Fusion/BRep/BRepEdge.h>  // Get the value of the property. boolean propertyValue = bRepEdge_var->isParamReversed(); ``` ```` |
