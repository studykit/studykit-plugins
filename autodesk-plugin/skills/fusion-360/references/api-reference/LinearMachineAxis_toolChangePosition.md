# LinearMachineAxis.toolChangePosition Property![](../images/TestTubeLarge.png)
...
"linearMachineAxis\_var" is a variable referencing a LinearMachineAxis object. ```` ``` #include <Cam/Machine/LinearMachineAxis.h>  // Get the value of the property. double propertyValue = linearMachineAxis_var->toolChangePosition();  // Set the value of the property, where value_var is a double. bool returnValue = linearMachineAxis_var->toolChangePosition(value_var); ``` ```` |
