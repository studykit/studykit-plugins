# SketchConicCurve.endSketchPoint Property
...
"sketchConicCurve\_var" is a variable referencing a SketchConicCurve object. ```` ``` #include <Fusion/Sketch/SketchConicCurve.h>  // Get the value of the property. Ptr<SketchPoint> propertyValue = sketchConicCurve_var->endSketchPoint(); ``` ```` |
