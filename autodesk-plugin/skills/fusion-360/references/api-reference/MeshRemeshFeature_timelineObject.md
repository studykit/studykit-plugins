# MeshRemeshFeature.timelineObject Property![](../images/TestTubeLarge.png)
...
"meshRemeshFeature\_var" is a variable referencing a MeshRemeshFeature object. ```` ``` #include <Fusion/MeshBody/MeshRemeshFeature.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = meshRemeshFeature_var->timelineObject(); ``` ```` |
