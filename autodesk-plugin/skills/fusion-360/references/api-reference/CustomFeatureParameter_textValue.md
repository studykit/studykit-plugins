# CustomFeatureParameter.textValue Property![](../images/TestTubeLarge.png)
...
"customFeatureParameter\_var" is a variable referencing a CustomFeatureParameter object. ```` ``` #include <Fusion/Features/CustomFeatureParameter.h>  // Get the value of the property. string propertyValue = customFeatureParameter_var->textValue();  // Set the value of the property, where value_var is a string. bool returnValue = customFeatureParameter_var->textValue(value_var); ``` ```` |
