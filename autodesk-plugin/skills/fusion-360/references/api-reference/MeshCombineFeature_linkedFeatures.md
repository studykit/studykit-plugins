# MeshCombineFeature.linkedFeatures Property![](../images/TestTubeLarge.png)
...
"meshCombineFeature\_var" is a variable referencing a MeshCombineFeature object. ```` ``` #include <Fusion/MeshBody/MeshCombineFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = meshCombineFeature_var->linkedFeatures(); ``` ```` |
