# MeshShellFeatureInput.mesh Property![](../images/TestTubeLarge.png)
...
"meshShellFeatureInput\_var" is a variable referencing a MeshShellFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshShellFeatureInput.h>  // Get the value of the property. Ptr<Base> propertyValue = meshShellFeatureInput_var->mesh();  // Set the value of the property, where value_var is a Base. bool returnValue = meshShellFeatureInput_var->mesh(value_var); ``` ```` |
