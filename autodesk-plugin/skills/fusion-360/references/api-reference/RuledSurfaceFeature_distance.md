...
"ruledSurfaceFeature\_var" is a variable referencing a RuledSurfaceFeature object. ```` ``` #include <Fusion/Features/RuledSurfaceFeature.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = ruledSurfaceFeature_var->distance(); ``` ```` |
