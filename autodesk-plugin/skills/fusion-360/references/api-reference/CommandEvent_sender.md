...
"commandEvent\_var" is a variable referencing a CommandEvent object. ```` ``` #include <Core/UserInterface/CommandEvent.h>  // Get the value of the property. Ptr<Base> propertyValue = commandEvent_var->sender(); ``` ```` |
