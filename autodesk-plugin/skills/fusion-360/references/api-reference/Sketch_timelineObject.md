# Sketch.timelineObject Property
...
"sketch\_var" is a variable referencing a Sketch object. ```` ``` #include <Fusion/Sketch/Sketch.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = sketch_var->timelineObject(); ``` ```` |
