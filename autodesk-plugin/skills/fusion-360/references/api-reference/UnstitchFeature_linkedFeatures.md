...
"unstitchFeature\_var" is a variable referencing a UnstitchFeature object. ```` ``` #include <Fusion/Features/UnstitchFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = unstitchFeature_var->linkedFeatures(); ``` ```` |
