# BossFeature.timelineObject Property
...
"bossFeature\_var" is a variable referencing a BossFeature object. ```` ``` #include <Fusion/Plastic/BossFeature.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = bossFeature_var->timelineObject(); ``` ```` |
