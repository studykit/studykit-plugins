...
"configurationInsertColumn\_var" is a variable referencing a [ConfigurationInsertColumn](ConfigurationInsertColumn.htm) object.```` ``` returnValue = configurationInsertColumn_var.getCellByRowId(rowId) ``` ```` |
