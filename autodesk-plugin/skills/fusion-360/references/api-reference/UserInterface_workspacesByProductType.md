...
"userInterface\_var" is a variable referencing a [UserInterface](UserInterface.htm) object.```` ``` returnValue = userInterface_var.workspacesByProductType(productType) ``` ```` |
...
| --- | --- |
| Type | Description |
| [WorkspaceList](WorkspaceList.htm) | Returns a list of the associated work spaces. |
