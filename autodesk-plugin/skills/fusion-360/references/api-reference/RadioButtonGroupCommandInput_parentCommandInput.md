# RadioButtonGroupCommandInput.parentCommandInput Property
...
"radioButtonGroupCommandInput\_var" is a variable referencing a RadioButtonGroupCommandInput object. ```` ``` #include <Core/UserInterface/RadioButtonGroupCommandInput.h>  // Get the value of the property. Ptr<CommandInput> propertyValue = radioButtonGroupCommandInput_var->parentCommandInput(); ``` ```` |
