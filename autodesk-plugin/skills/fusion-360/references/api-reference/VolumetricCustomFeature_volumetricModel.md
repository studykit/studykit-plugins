# VolumetricCustomFeature.volumetricModel Property![](../images/TestTubeLarge.png)
...
"volumetricCustomFeature\_var" is a variable referencing a VolumetricCustomFeature object. ```` ``` #include <Fusion/Features/VolumetricCustomFeature.h>  // Get the value of the property. Ptr<Base> propertyValue = volumetricCustomFeature_var->volumetricModel(); ``` ```` |
