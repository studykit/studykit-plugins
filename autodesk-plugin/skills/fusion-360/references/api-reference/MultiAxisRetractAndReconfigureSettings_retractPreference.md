# MultiAxisRetractAndReconfigureSettings.retractPreference Property![](../images/TestTubeLarge.png)
...
"multiAxisRetractAndReconfigureSettings\_var" is a variable referencing a MultiAxisRetractAndReconfigureSettings object. ```` ``` #include <Cam/Machine/MultiAxisRetractAndReconfigureSettings.h>  // Get the value of the property. MultiAxisRetractPreference propertyValue = multiAxisRetractAndReconfigureSettings_var->retractPreference();  // Set the value of the property, where value_var is a MultiAxisRetractPreference. bool returnValue = multiAxisRetractAndReconfigureSettings_var->retractPreference(value_var); ``` ```` |

## Property Value

This is a read/write property whose value is a [MultiAxisRetractPreference](MultiAxisRetractPreference.htm).
