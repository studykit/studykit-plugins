# SmoothConstraint.curveTwo Property
...
"smoothConstraint\_var" is a variable referencing a SmoothConstraint object. ```` ``` #include <Fusion/Sketch/SmoothConstraint.h>  // Get the value of the property. Ptr<SketchCurve> propertyValue = smoothConstraint_var->curveTwo(); ``` ```` |
