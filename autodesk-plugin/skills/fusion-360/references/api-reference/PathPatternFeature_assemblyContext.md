...
"pathPatternFeature\_var" is a variable referencing a PathPatternFeature object. ```` ``` #include <Fusion/Features/PathPatternFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = pathPatternFeature_var->assemblyContext(); ``` ```` |
