# FusionUnitsManager.distanceDisplayUnits Property
...
"fusionUnitsManager\_var" is a variable referencing a FusionUnitsManager object. ```` ``` #include <Fusion/Fusion/FusionUnitsManager.h>  // Get the value of the property. DistanceUnits propertyValue = fusionUnitsManager_var->distanceDisplayUnits();  // Set the value of the property, where value_var is a DistanceUnits. bool returnValue = fusionUnitsManager_var->distanceDisplayUnits(value_var); ``` ```` |
