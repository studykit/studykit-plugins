...
"patchFeature\_var" is a variable referencing a PatchFeature object. ```` ``` #include <Fusion/Features/PatchFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = patchFeature_var->linkedFeatures(); ``` ```` |
