# BeamNetwork.beams Property![](../images/TestTubeLarge.png)
...
"beamNetwork\_var" is a variable referencing a BeamNetwork object. ```` ``` #include <Volume/Volumetric/BeamNetwork.h>  // Get the value of the property. std::vector<uinteger> propertyValue = beamNetwork_var->beams();  // Set the value of the property, where value_var is a uinteger. bool returnValue = beamNetwork_var->beams(value_var); ``` ```` |
