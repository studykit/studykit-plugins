# CustomFeatureDefinition.defaultName Property![](../images/TestTubeLarge.png)
...
"customFeatureDefinition\_var" is a variable referencing a CustomFeatureDefinition object. ```` ``` #include <Fusion/Features/CustomFeatureDefinition.h>  // Get the value of the property. string propertyValue = customFeatureDefinition_var->defaultName();  // Set the value of the property, where value_var is a string. bool returnValue = customFeatureDefinition_var->defaultName(value_var); ``` ```` |
