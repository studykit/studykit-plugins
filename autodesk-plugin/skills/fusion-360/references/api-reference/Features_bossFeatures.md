# Features.bossFeatures Property
...
"features\_var" is a variable referencing a Features object. ```` ``` #include <Fusion/Features/Features.h>  // Get the value of the property. Ptr<BossFeatures> propertyValue = features_var->bossFeatures(); ``` ```` |

## Property Value

This is a read only property whose value is a [BossFeatures](BossFeatures.htm).
