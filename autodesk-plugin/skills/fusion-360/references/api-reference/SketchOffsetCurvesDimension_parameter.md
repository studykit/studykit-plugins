# SketchOffsetCurvesDimension.parameter Property
...
"sketchOffsetCurvesDimension\_var" is a variable referencing a SketchOffsetCurvesDimension object. ```` ``` #include <Fusion/Sketch/SketchOffsetCurvesDimension.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = sketchOffsetCurvesDimension_var->parameter(); ``` ```` |
