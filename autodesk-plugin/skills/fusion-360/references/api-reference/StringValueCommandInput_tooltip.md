# StringValueCommandInput.tooltip Property
...
"stringValueCommandInput\_var" is a variable referencing a StringValueCommandInput object. ```` ``` #include <Core/UserInterface/StringValueCommandInput.h>  // Get the value of the property. string propertyValue = stringValueCommandInput_var->tooltip();  // Set the value of the property, where value_var is a string. bool returnValue = stringValueCommandInput_var->tooltip(value_var); ``` ```` |
