...
"profileCurve\_var" is a variable referencing a ProfileCurve object. ```` ``` #include <Fusion/Sketch/ProfileCurve.h>  // Get the value of the property. Ptr<BoundingBox3D> propertyValue = profileCurve_var->boundingBox(); ``` ```` |
