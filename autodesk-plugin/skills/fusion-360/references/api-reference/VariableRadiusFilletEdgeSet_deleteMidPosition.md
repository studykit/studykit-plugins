...
"variableRadiusFilletEdgeSet\_var" is a variable referencing a [VariableRadiusFilletEdgeSet](VariableRadiusFilletEdgeSet.htm) object.```` ``` returnValue = variableRadiusFilletEdgeSet_var.deleteMidPosition(positionIndex) ``` ```` |

"variableRadiusFilletEdgeSet\_var" is a variable referencing a [VariableRadiusFilletEdgeSet](VariableRadiusFilletEdgeSet.htm) object.  ```` ``` #include <Fusion/Features/VariableRadiusFilletEdgeSet.h>  returnValue = variableRadiusFilletEdgeSet_var->deleteMidPosition(positionIndex); ``` ```` |
