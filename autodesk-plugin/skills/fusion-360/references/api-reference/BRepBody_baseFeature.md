...
"bRepBody\_var" is a variable referencing a BRepBody object. ```` ``` #include <Fusion/BRep/BRepBody.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = bRepBody_var->baseFeature(); ``` ```` |
