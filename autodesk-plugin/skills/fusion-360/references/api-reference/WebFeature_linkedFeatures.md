...
"webFeature\_var" is a variable referencing a WebFeature object. ```` ``` #include <Fusion/Features/WebFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = webFeature_var->linkedFeatures(); ``` ```` |
