# MeshShellFeatureInput.targetBaseFeature Property![](../images/TestTubeLarge.png)
...
"meshShellFeatureInput\_var" is a variable referencing a MeshShellFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshShellFeatureInput.h>  // Get the value of the property. Ptr<BaseFeature> propertyValue = meshShellFeatureInput_var->targetBaseFeature();  // Set the value of the property, where value_var is a BaseFeature. bool returnValue = meshShellFeatureInput_var->targetBaseFeature(value_var); ``` ```` |
