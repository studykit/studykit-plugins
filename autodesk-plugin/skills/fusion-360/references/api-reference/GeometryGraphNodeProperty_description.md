# GeometryGraphNodeProperty.description Property![](../images/TestTubeLarge.png)
...
"geometryGraphNodeProperty\_var" is a variable referencing a GeometryGraphNodeProperty object. ```` ``` #include <Volume/Volumetric/GeometryGraphNodeProperty.h>  // Get the value of the property. string propertyValue = geometryGraphNodeProperty_var->description(); ``` ```` |
