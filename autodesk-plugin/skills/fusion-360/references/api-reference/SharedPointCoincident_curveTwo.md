# SharedPointCoincident.curveTwo Property
...
"sharedPointCoincident\_var" is a variable referencing a SharedPointCoincident object. ```` ``` #include <Fusion/Sketch/SharedPointCoincident.h>  // Get the value of the property. Ptr<SketchCurve> propertyValue = sharedPointCoincident_var->curveTwo(); ``` ```` |
