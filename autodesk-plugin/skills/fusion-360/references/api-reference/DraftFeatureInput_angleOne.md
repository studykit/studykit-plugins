...
"draftFeatureInput\_var" is a variable referencing a DraftFeatureInput object. ```` ``` #include <Fusion/Features/DraftFeatureInput.h>  // Get the value of the property. Ptr<ValueInput> propertyValue = draftFeatureInput_var->angleOne(); ``` ```` |
