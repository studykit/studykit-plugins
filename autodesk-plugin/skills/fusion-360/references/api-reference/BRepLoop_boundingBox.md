...
"bRepLoop\_var" is a variable referencing a BRepLoop object. ```` ``` #include <Fusion/BRep/BRepLoop.h>  // Get the value of the property. Ptr<BoundingBox3D> propertyValue = bRepLoop_var->boundingBox(); ``` ```` |
