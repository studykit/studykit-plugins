# UnitAndValuePreferences.areAbbreviationsForUnitDisplayed Property
...
"unitAndValuePreferences\_var" is a variable referencing a UnitAndValuePreferences object. ```` ``` #include <Core/Application/UnitAndValuePreferences.h>  // Get the value of the property. boolean propertyValue = unitAndValuePreferences_var->areAbbreviationsForUnitDisplayed();  // Set the value of the property, where value_var is a boolean. bool returnValue = unitAndValuePreferences_var->areAbbreviationsForUnitDisplayed(value_var); ``` ```` |
