# MeshCombineFeatureInput.toolBodies Property![](../images/TestTubeLarge.png)
...
"meshCombineFeatureInput\_var" is a variable referencing a MeshCombineFeatureInput object. ```` ``` #include <Fusion/MeshBody/MeshCombineFeatureInput.h>  // Get the value of the property. std::vector<Ptr<MeshBody>> propertyValue = meshCombineFeatureInput_var->toolBodies();  // Set the value of the property, where value_var is a MeshBody. bool returnValue = meshCombineFeatureInput_var->toolBodies(value_var); ``` ```` |
