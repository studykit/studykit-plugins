# FlatPatternComponent.dataComponent Property![](../images/TestTubeLarge.png)
...
"flatPatternComponent\_var" is a variable referencing a FlatPatternComponent object. ```` ``` #include <Fusion/SheetMetal/FlatPatternComponent.h>  // Get the value of the property. Ptr<DataComponent> propertyValue = flatPatternComponent_var->dataComponent(); ``` ```` |
