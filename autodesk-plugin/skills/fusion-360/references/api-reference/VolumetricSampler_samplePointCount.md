# VolumetricSampler.samplePointCount Method![](../images/TestTubeLarge.png)
...
"volumetricSampler\_var" is a variable referencing a [VolumetricSampler](VolumetricSampler.htm) object.```` ``` returnValue = volumetricSampler_var.samplePointCount() ``` ```` |
