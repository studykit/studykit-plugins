...
"cAMAdditiveContainer\_var" is a variable referencing a CAMAdditiveContainer object. ```` ``` #include <Cam/CAM/CAMAdditiveContainer.h>  // Get the value of the property. boolean propertyValue = cAMAdditiveContainer_var->isVisible(); ``` ```` |
