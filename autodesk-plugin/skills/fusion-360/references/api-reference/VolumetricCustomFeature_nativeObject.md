# VolumetricCustomFeature.nativeObject Property![](../images/TestTubeLarge.png)
...
"volumetricCustomFeature\_var" is a variable referencing a VolumetricCustomFeature object. ```` ``` #include <Fusion/Features/VolumetricCustomFeature.h>  // Get the value of the property. Ptr<VolumetricCustomFeature> propertyValue = volumetricCustomFeature_var->nativeObject(); ``` ```` |

## Property Value

This is a read only property whose value is a [VolumetricCustomFeature](VolumetricCustomFeature.htm).
