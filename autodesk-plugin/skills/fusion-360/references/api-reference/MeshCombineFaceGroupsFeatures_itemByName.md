# MeshCombineFaceGroupsFeatures.itemByName Method![](../images/TestTubeLarge.png)
...
"meshCombineFaceGroupsFeatures\_var" is a variable referencing a [MeshCombineFaceGroupsFeatures](MeshCombineFaceGroupsFeatures.htm) object.```` ``` returnValue = meshCombineFaceGroupsFeatures_var.itemByName(name) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshCombineFaceGroupsFeature](MeshCombineFaceGroupsFeature.htm) | Returns the specified item or null if the specified name was not found. |
