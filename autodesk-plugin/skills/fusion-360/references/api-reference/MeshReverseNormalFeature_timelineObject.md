# MeshReverseNormalFeature.timelineObject Property![](../images/TestTubeLarge.png)
...
"meshReverseNormalFeature\_var" is a variable referencing a MeshReverseNormalFeature object. ```` ``` #include <Fusion/MeshBody/MeshReverseNormalFeature.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = meshReverseNormalFeature_var->timelineObject(); ``` ```` |
