# VolumetricModelToMeshFeatureInput.refinementType Property![](../images/TestTubeLarge.png)
...
"volumetricModelToMeshFeatureInput\_var" is a variable referencing a VolumetricModelToMeshFeatureInput object. ```` ``` #include <Fusion/Features/VolumetricModelToMeshFeatureInput.h>  // Get the value of the property. VolumetricMeshRefinementTypes propertyValue = volumetricModelToMeshFeatureInput_var->refinementType();  // Set the value of the property, where value_var is a VolumetricMeshRefinementTypes. bool returnValue = volumetricModelToMeshFeatureInput_var->refinementType(value_var); ``` ```` |

## Property Value

This is a read/write property whose value is a [VolumetricMeshRefinementTypes](VolumetricMeshRefinementTypes.htm).
