# UnstitchFeature.parentComponent Property
...
"unstitchFeature\_var" is a variable referencing a UnstitchFeature object. ```` ``` #include <Fusion/Features/UnstitchFeature.h>  // Get the value of the property. Ptr<Component> propertyValue = unstitchFeature_var->parentComponent(); ``` ```` |
