# MachineToolStation.maxToolDiameter Property![](../images/TestTubeLarge.png)
...
"machineToolStation\_var" is a variable referencing a MachineToolStation object. ```` ``` #include <Cam/Machine/MachineToolStation.h>  // Get the value of the property. double propertyValue = machineToolStation_var->maxToolDiameter();  // Set the value of the property, where value_var is a double. bool returnValue = machineToolStation_var->maxToolDiameter(value_var); ``` ```` |
