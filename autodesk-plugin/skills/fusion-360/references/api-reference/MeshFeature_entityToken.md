# MeshFeature.entityToken Property![](../images/TestTubeLarge.png)
...
"meshFeature\_var" is a variable referencing a MeshFeature object. ```` ``` #include <Fusion/MeshBody/MeshFeature.h>  // Get the value of the property. string propertyValue = meshFeature_var->entityToken(); ``` ```` |
