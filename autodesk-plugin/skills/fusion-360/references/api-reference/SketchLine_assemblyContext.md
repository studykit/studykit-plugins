...
"sketchLine\_var" is a variable referencing a SketchLine object. ```` ``` #include <Fusion/Sketch/SketchLine.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchLine_var->assemblyContext(); ``` ```` |
