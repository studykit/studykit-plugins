# PostProcessingMachineElement.elementId Property![](../images/TestTubeLarge.png)
...
"postProcessingMachineElement\_var" is a variable referencing a PostProcessingMachineElement object. ```` ``` #include <Cam/Machine/PostProcessingMachineElement.h>  // Get the value of the property. string propertyValue = postProcessingMachineElement_var->elementId(); ``` ```` |
