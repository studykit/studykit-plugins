# MeshShellFeature.dissolve Method![](../images/TestTubeLarge.png)
...
"meshShellFeature\_var" is a variable referencing a [MeshShellFeature](MeshShellFeature.htm) object.```` ``` returnValue = meshShellFeature_var.dissolve() ``` ```` |
