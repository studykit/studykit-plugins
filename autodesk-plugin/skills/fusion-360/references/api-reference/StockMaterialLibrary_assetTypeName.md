# StockMaterialLibrary.assetTypeName Property![](../images/TestTubeLarge.png)
...
"stockMaterialLibrary\_var" is a variable referencing a StockMaterialLibrary object. ```` ``` #include <Cam/StockMaterials/StockMaterialLibrary.h>  // Get the value of the property. string propertyValue = stockMaterialLibrary_var->assetTypeName(); ``` ```` |
