...
"canvas\_var" is a variable referencing a Canvas object. ```` ``` #include <Fusion/Image/Canvas.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = canvas_var->assemblyContext(); ``` ```` |
