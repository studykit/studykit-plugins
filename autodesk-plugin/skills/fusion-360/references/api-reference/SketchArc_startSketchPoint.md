...
"sketchArc\_var" is a variable referencing a SketchArc object. ```` ``` #include <Fusion/Sketch/SketchArc.h>  // Get the value of the property. Ptr<SketchPoint> propertyValue = sketchArc_var->startSketchPoint(); ``` ```` |
