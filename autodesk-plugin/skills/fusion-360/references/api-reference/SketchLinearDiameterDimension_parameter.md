# SketchLinearDiameterDimension.parameter Property
...
"sketchLinearDiameterDimension\_var" is a variable referencing a SketchLinearDiameterDimension object. ```` ``` #include <Fusion/Sketch/SketchLinearDiameterDimension.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = sketchLinearDiameterDimension_var->parameter(); ``` ```` |
