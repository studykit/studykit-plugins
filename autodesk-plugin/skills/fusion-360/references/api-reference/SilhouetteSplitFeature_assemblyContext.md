...
"silhouetteSplitFeature\_var" is a variable referencing a SilhouetteSplitFeature object. ```` ``` #include <Fusion/Features/SilhouetteSplitFeature.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = silhouetteSplitFeature_var->assemblyContext(); ``` ```` |
