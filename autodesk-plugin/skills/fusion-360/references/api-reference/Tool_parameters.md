...
"tool\_var" is a variable referencing a Tool object. ```` ``` #include <Cam/Tools/Tool.h>  // Get the value of the property. Ptr<CAMParameters> propertyValue = tool_var->parameters(); ``` ```` |
