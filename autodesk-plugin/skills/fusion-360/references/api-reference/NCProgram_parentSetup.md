# NCProgram.parentSetup Property
...
"nCProgram\_var" is a variable referencing a NCProgram object. ```` ``` #include <Cam/NCProgram/NCProgram.h>  // Get the value of the property. Ptr<Setup> propertyValue = nCProgram_var->parentSetup(); ``` ```` |
