...
"customGraphicsMesh\_var" is a variable referencing a [CustomGraphicsMesh](CustomGraphicsMesh.htm) object.```` ``` returnValue = customGraphicsMesh_var.setOpacity(opacity, isOverride) ``` ```` |

"customGraphicsMesh\_var" is a variable referencing a [CustomGraphicsMesh](CustomGraphicsMesh.htm) object. |
