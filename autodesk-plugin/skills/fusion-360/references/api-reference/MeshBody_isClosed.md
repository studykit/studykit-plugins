# MeshBody.isClosed Property![](../images/TestTubeLarge.png)
...
"meshBody\_var" is a variable referencing a MeshBody object. ```` ``` #include <Fusion/MeshBody/MeshBody.h>  // Get the value of the property. boolean propertyValue = meshBody_var->isClosed(); ``` ```` |
