...
"toolbarTab\_var" is a variable referencing a ToolbarTab object. ```` ``` #include <Core/UserInterface/ToolbarTab.h>  // Get the value of the property. boolean propertyValue = toolbarTab_var->isActive(); ``` ```` |
