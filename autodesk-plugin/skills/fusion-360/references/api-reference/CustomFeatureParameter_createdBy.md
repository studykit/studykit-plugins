# CustomFeatureParameter.createdBy Property![](../images/TestTubeLarge.png)
...
"customFeatureParameter\_var" is a variable referencing a CustomFeatureParameter object. ```` ``` #include <Fusion/Features/CustomFeatureParameter.h>  // Get the value of the property. Ptr<Base> propertyValue = customFeatureParameter_var->createdBy(); ``` ```` |
