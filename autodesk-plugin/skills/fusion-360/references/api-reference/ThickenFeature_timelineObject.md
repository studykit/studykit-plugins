# ThickenFeature.timelineObject Property
...
"thickenFeature\_var" is a variable referencing a ThickenFeature object. ```` ``` #include <Fusion/Features/ThickenFeature.h>  // Get the value of the property. Ptr<TimelineObject> propertyValue = thickenFeature_var->timelineObject(); ``` ```` |
