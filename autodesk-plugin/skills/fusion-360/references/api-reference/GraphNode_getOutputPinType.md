# GraphNode.getOutputPinType Method![](../images/TestTubeLarge.png)
...
"graphNode\_var" is a variable referencing a [GraphNode](GraphNode.htm) object.```` ``` returnValue = graphNode_var.getOutputPinType(pinIndex) ``` ```` |
...
| --- | --- |
| Type | Description |
| [NodePinTypes](NodePinTypes.htm) | The pin type enum. |
