# UntrimFeature.healthState Property
...
"untrimFeature\_var" is a variable referencing a UntrimFeature object. ```` ``` #include <Fusion/Features/UntrimFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = untrimFeature_var->healthState(); ``` ```` |
