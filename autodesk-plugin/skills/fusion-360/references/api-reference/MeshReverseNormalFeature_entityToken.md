# MeshReverseNormalFeature.entityToken Property![](../images/TestTubeLarge.png)
...
"meshReverseNormalFeature\_var" is a variable referencing a MeshReverseNormalFeature object. ```` ``` #include <Fusion/MeshBody/MeshReverseNormalFeature.h>  // Get the value of the property. string propertyValue = meshReverseNormalFeature_var->entityToken(); ``` ```` |
