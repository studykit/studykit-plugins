# DocumentStockMaterialLibrary.count Property![](../images/TestTubeLarge.png)
...
"documentStockMaterialLibrary\_var" is a variable referencing a DocumentStockMaterialLibrary object. ```` ``` #include <Cam/StockMaterials/DocumentStockMaterialLibrary.h>  // Get the value of the property. uinteger propertyValue = documentStockMaterialLibrary_var->count(); ``` ```` |
