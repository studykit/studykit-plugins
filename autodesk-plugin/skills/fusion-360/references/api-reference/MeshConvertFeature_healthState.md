# MeshConvertFeature.healthState Property![](../images/TestTubeLarge.png)
...
"meshConvertFeature\_var" is a variable referencing a MeshConvertFeature object. ```` ``` #include <Fusion/MeshBody/MeshConvertFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = meshConvertFeature_var->healthState(); ``` ```` |
