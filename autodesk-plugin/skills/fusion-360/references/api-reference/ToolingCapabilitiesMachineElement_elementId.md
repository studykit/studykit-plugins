# ToolingCapabilitiesMachineElement.elementId Property![](../images/TestTubeLarge.png)
...
"toolingCapabilitiesMachineElement\_var" is a variable referencing a ToolingCapabilitiesMachineElement object. ```` ``` #include <Cam/Machine/ToolingCapabilitiesMachineElement.h>  // Get the value of the property. string propertyValue = toolingCapabilitiesMachineElement_var->elementId(); ``` ```` |
