# MeshGenerateFaceGroupsFeature.linkedFeatures Property![](../images/TestTubeLarge.png)
...
"meshGenerateFaceGroupsFeature\_var" is a variable referencing a MeshGenerateFaceGroupsFeature object. ```` ``` #include <Fusion/MeshBody/MeshGenerateFaceGroupsFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = meshGenerateFaceGroupsFeature_var->linkedFeatures(); ``` ```` |
