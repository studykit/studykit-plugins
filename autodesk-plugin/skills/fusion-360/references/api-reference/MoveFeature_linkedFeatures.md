...
"moveFeature\_var" is a variable referencing a MoveFeature object. ```` ``` #include <Fusion/Features/MoveFeature.h>  // Get the value of the property. Ptr<FeatureList> propertyValue = moveFeature_var->linkedFeatures(); ``` ```` |
