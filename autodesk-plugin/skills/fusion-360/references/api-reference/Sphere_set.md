...
"sphere\_var" is a variable referencing a [Sphere](Sphere.htm) object.```` ``` returnValue = sphere_var.set(origin, radius) ``` ```` |
...
| origin | [Point3D](Point3D.htm) | The origin point (center) of the sphere. |
