# MachineElement.typeId Property
...
"machineElement\_var" is a variable referencing a MachineElement object. ```` ``` #include <Cam/Machine/MachineElement.h>  // Get the value of the property. string propertyValue = machineElement_var->typeId(); ``` ```` |
