...
"operationBase\_var" is a variable referencing an OperationBase object. ```` ``` #include <Cam/Operations/OperationBase.h>  // Get the value of the property. integer propertyValue = operationBase_var->operationId(); ``` ```` |
