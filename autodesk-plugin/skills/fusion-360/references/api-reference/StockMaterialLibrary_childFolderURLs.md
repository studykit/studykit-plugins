# StockMaterialLibrary.childFolderURLs Method![](../images/TestTubeLarge.png)
...
"stockMaterialLibrary\_var" is a variable referencing a [StockMaterialLibrary](StockMaterialLibrary.htm) object.```` ``` returnValue = stockMaterialLibrary_var.childFolderURLs(url) ``` ```` |
