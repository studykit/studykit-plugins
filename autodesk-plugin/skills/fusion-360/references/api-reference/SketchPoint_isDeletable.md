...
"sketchPoint\_var" is a variable referencing a SketchPoint object. ```` ``` #include <Fusion/Sketch/SketchPoint.h>  // Get the value of the property. boolean propertyValue = sketchPoint_var->isDeletable(); ``` ```` |
