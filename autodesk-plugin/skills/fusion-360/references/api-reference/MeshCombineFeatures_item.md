# MeshCombineFeatures.item Method![](../images/TestTubeLarge.png)
...
"meshCombineFeatures\_var" is a variable referencing a [MeshCombineFeatures](MeshCombineFeatures.htm) object.```` ``` returnValue = meshCombineFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [MeshCombineFeature](MeshCombineFeature.htm) | Returns the specified item or null if an invalid index was specified. |
