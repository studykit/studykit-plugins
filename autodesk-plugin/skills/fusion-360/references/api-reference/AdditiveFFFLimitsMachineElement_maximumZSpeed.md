# AdditiveFFFLimitsMachineElement.maximumZSpeed Property
...
"additiveFFFLimitsMachineElement\_var" is a variable referencing an AdditiveFFFLimitsMachineElement object. ```` ``` #include <Cam/Machine/AdditiveFFFLimitsMachineElement.h>  // Get the value of the property. double propertyValue = additiveFFFLimitsMachineElement_var->maximumZSpeed();  // Set the value of the property, where value_var is a double. bool returnValue = additiveFFFLimitsMachineElement_var->maximumZSpeed(value_var); ``` ```` |
