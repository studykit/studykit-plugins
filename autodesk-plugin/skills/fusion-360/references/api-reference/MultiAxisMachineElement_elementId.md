# MultiAxisMachineElement.elementId Property![](../images/TestTubeLarge.png)
...
"multiAxisMachineElement\_var" is a variable referencing a MultiAxisMachineElement object. ```` ``` #include <Cam/Machine/MultiAxisMachineElement.h>  // Get the value of the property. string propertyValue = multiAxisMachineElement_var->elementId(); ``` ```` |
