...
"drawingDocument\_var" is a variable referencing a [DrawingDocument](DrawingDocument.htm) object.```` ``` returnValue = drawingDocument_var.saveMilestone(milestoneName, versionDescription) ``` ```` |
