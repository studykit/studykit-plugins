# CustomFeature.deleteMe Method![](../images/TestTubeLarge.png)
...
"customFeature\_var" is a variable referencing a [CustomFeature](CustomFeature.htm) object.```` ``` returnValue = customFeature_var.deleteMe() ``` ```` |
