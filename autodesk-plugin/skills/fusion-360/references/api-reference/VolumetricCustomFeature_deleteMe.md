# VolumetricCustomFeature.deleteMe Method![](../images/TestTubeLarge.png)
...
"volumetricCustomFeature\_var" is a variable referencing a [VolumetricCustomFeature](VolumetricCustomFeature.htm) object.```` ``` returnValue = volumetricCustomFeature_var.deleteMe() ``` ```` |
