# JointGeometry.secondaryAxisVector Property
...
"jointGeometry\_var" is a variable referencing a JointGeometry object. ```` ``` #include <Fusion/Components/JointGeometry.h>  // Get the value of the property. Ptr<Vector3D> propertyValue = jointGeometry_var->secondaryAxisVector(); ``` ```` |
