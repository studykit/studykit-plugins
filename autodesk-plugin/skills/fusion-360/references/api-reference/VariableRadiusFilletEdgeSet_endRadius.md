...
"variableRadiusFilletEdgeSet\_var" is a variable referencing a VariableRadiusFilletEdgeSet object. ```` ``` #include <Fusion/Features/VariableRadiusFilletEdgeSet.h>  // Get the value of the property. Ptr<ModelParameter> propertyValue = variableRadiusFilletEdgeSet_var->endRadius(); ``` ```` |
