# VolumetricVectorSample.point Property![](../images/TestTubeLarge.png)
...
"volumetricVectorSample\_var" is a variable referencing a VolumetricVectorSample object. ```` ``` #include <Volume/Volumetric/VolumetricVectorSample.h>  // Get the value of the property. Ptr<Point3D> propertyValue = volumetricVectorSample_var->point(); ``` ```` |
