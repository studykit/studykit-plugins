...
"sketchEllipticalArc\_var" is a variable referencing a SketchEllipticalArc object. ```` ``` #include <Fusion/Sketch/SketchEllipticalArc.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = sketchEllipticalArc_var->assemblyContext(); ``` ```` |
