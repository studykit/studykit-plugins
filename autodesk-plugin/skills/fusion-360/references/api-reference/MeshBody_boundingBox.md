# MeshBody.boundingBox Property![](../images/TestTubeLarge.png)
...
"meshBody\_var" is a variable referencing a MeshBody object. ```` ``` #include <Fusion/MeshBody/MeshBody.h>  // Get the value of the property. Ptr<BoundingBox3D> propertyValue = meshBody_var->boundingBox(); ``` ```` |
