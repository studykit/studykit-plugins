# CustomFeature.healthState Property![](../images/TestTubeLarge.png)
...
"customFeature\_var" is a variable referencing a CustomFeature object. ```` ``` #include <Fusion/Features/CustomFeature.h>  // Get the value of the property. FeatureHealthStates propertyValue = customFeature_var->healthState(); ``` ```` |
