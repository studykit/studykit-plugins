...
"loftPointTangentEndCondition\_var" is a variable referencing a LoftPointTangentEndCondition object. ```` ``` #include <Fusion/Features/LoftPointTangentEndCondition.h>  // Get the value of the property. Ptr<Base> propertyValue = loftPointTangentEndCondition_var->weight(); ``` ```` |
