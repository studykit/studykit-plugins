# MultiAxisRetractAndReconfigureSettings.safeRetractDistance Property![](../images/TestTubeLarge.png)
...
"multiAxisRetractAndReconfigureSettings\_var" is a variable referencing a MultiAxisRetractAndReconfigureSettings object. ```` ``` #include <Cam/Machine/MultiAxisRetractAndReconfigureSettings.h>  // Get the value of the property. double propertyValue = multiAxisRetractAndReconfigureSettings_var->safeRetractDistance();  // Set the value of the property, where value_var is a double. bool returnValue = multiAxisRetractAndReconfigureSettings_var->safeRetractDistance(value_var); ``` ```` |
