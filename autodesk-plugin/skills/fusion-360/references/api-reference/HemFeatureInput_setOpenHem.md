# HemFeatureInput.setOpenHem Method![](../images/TestTubeLarge.png)
...
"hemFeatureInput\_var" is a variable referencing a [HemFeatureInput](HemFeatureInput.htm) object.```` ``` returnValue = hemFeatureInput_var.setOpenHem(edge, length, gap, isFlipped, bendPositionType) ``` ```` |
