# DataFile.isConfiguredDesign Property![](../images/TestTubeLarge.png)
...
"dataFile\_var" is a variable referencing a DataFile object. ```` ``` #include <Core/Dashboard/DataFile.h>  // Get the value of the property. boolean propertyValue = dataFile_var->isConfiguredDesign(); ``` ```` |
