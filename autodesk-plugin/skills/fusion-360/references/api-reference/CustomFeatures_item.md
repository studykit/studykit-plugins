# CustomFeatures.item Method![](../images/TestTubeLarge.png)
...
"customFeatures\_var" is a variable referencing a [CustomFeatures](CustomFeatures.htm) object.```` ``` returnValue = customFeatures_var.item(index) ``` ```` |
...
| --- | --- |
| Type | Description |
| [CustomFeature](CustomFeature.htm) | Returns the specified item or null if an invalid index was specified. |
