...
"coincidentToSurfaceConstraint\_var" is a variable referencing a CoincidentToSurfaceConstraint object. ```` ``` #include <Fusion/Sketch/CoincidentToSurfaceConstraint.h>  // Get the value of the property. Ptr<Occurrence> propertyValue = coincidentToSurfaceConstraint_var->assemblyContext(); ``` ```` |
