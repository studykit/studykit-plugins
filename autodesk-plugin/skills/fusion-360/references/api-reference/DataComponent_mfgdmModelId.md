# DataComponent.mfgdmModelId Property![](../images/TestTubeLarge.png)
...
"dataComponent\_var" is a variable referencing a DataComponent object. ```` ``` #include <Core/Dashboard/DataComponent.h>  // Get the value of the property. string propertyValue = dataComponent_var->mfgdmModelId(); ``` ```` |
