...
"loftDirectionEndCondition\_var" is a variable referencing a LoftDirectionEndCondition object. ```` ``` #include <Fusion/Features/LoftDirectionEndCondition.h>  // Get the value of the property. Ptr<Base> propertyValue = loftDirectionEndCondition_var->angle(); ``` ```` |
