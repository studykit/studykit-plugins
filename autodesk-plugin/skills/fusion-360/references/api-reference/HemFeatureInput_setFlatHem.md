# HemFeatureInput.setFlatHem Method![](../images/TestTubeLarge.png)
...
"hemFeatureInput\_var" is a variable referencing a [HemFeatureInput](HemFeatureInput.htm) object.```` ``` returnValue = hemFeatureInput_var.setFlatHem(edge, length, isFlipped, bendPositionType) ``` ```` |
