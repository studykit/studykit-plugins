# ScalarGraphNodeProperty.name Property![](../images/TestTubeLarge.png)
...
"scalarGraphNodeProperty\_var" is a variable referencing a ScalarGraphNodeProperty object. ```` ``` #include <Volume/Volumetric/ScalarGraphNodeProperty.h>  // Get the value of the property. string propertyValue = scalarGraphNodeProperty_var->name(); ``` ```` |
