# DirectEditDeleteOperation.Delete Method

Parent Object: [DirectEditDeleteOperation](../DirectEditDeleteOperation/DirectEditDeleteOperation.md)
...
DirectEditDeleteOperation.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
