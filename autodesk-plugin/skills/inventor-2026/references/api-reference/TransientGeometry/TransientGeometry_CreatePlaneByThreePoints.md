...
TransientGeometry.**CreatePlaneByThreePoints**( ***PointOne*** As [Point](../Point/Point.md), ***PointTwo*** As [Point](../Point/Point.md), ***PointThree*** As [Point](../Point/Point.md) ) As [Plane](../Plane/Plane.md)
