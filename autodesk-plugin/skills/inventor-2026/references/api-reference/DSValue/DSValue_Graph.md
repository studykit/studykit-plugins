...
Parent Object: [DSValue](../DSValue/DSValue.md)
...
DSValue.**Graph**() As [DSValueGraph](../DSValueGraph/DSValueGraph.md)

## Property Value

This is a read only property whose value is a [DSValueGraph](../DSValueGraph/DSValueGraph.md).
