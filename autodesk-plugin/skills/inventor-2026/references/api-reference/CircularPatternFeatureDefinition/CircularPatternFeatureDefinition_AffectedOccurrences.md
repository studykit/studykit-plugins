# CircularPatternFeatureDefinition.AffectedOccurrences Property
...
CircularPatternFeatureDefinition.**AffectedOccurrences**() As [ObjectCollection](../ObjectCollection/ObjectCollection.md)
