# HoleFeatures.AddCSinkByToFaceExtent2 Method
...
HoleFeatures.**AddCSinkByToFaceExtent2**( ***PlacementDefinition*** As Object, ***DiameterOrTapInfo*** As Variant, ***ToFace*** As Object, ***ExtendToFace*** As Boolean, ***CSinkDiameter*** As Variant, ***CSinkAngle*** As Variant, [***DrillPointType***] As Variant, [***BottomTipAngle***] As Variant ) As [HoleFeature](../HoleFeature/HoleFeature.md)
