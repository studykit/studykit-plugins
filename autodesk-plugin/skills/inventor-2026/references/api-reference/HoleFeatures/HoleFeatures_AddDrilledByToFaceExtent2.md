# HoleFeatures.AddDrilledByToFaceExtent2 Method
...
HoleFeatures.**AddDrilledByToFaceExtent2**( ***PlacementDefinition*** As Object, ***DiameterOrTapInfo*** As Variant, ***ToFace*** As Object, ***ExtendToFace*** As Boolean, [***DrillPointType***] As Variant, [***BottomTipAngle***] As Variant ) As [HoleFeature](../HoleFeature/HoleFeature.md)
