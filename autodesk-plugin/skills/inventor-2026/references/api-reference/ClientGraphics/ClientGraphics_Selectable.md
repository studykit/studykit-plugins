...
ClientGraphics.**Selectable**() As [GraphicsSelectabilityEnum](../GraphicsSelectabilityEnum.md)

## Property Value

This is a read/write property whose value is a [GraphicsSelectabilityEnum](../GraphicsSelectabilityEnum.md).
