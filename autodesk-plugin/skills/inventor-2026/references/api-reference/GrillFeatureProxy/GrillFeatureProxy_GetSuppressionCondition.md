# GrillFeatureProxy.GetSuppressionCondition Method

Parent Object: [GrillFeatureProxy](../GrillFeatureProxy/GrillFeatureProxy.md)
...
GrillFeatureProxy.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
