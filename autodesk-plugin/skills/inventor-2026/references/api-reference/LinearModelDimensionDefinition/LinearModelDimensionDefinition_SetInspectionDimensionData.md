# LinearModelDimensionDefinition.SetInspectionDimensionData Method
...
LinearModelDimensionDefinition.**SetInspectionDimensionData**( [***Shape***] As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), [***Label***] As String, [***Rate***] As String )
