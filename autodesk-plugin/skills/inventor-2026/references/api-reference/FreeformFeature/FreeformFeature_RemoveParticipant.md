# FreeformFeature.RemoveParticipant Method
...
FreeformFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
