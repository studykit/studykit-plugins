# PunchToolFeature.RemoveParticipant Method
...
PunchToolFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
