# Document.PutInternalNameAndRevisionId Method
...
Document.**PutInternalNameAndRevisionId**( ***InternalNameToken*** As String, ***RevisionIdToken*** As String, ***InternalName*** As String, ***RevisionId*** As String )
