# BoundaryPatchFeature.RemoveParticipant Method
...
BoundaryPatchFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
