# ExtendFeature.GetSuppressionCondition Method

Parent Object: [ExtendFeature](../ExtendFeature/ExtendFeature.md)
...
ExtendFeature.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
