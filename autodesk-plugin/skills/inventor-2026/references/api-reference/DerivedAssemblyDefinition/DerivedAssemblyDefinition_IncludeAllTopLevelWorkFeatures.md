# DerivedAssemblyDefinition.IncludeAllTopLevelWorkFeatures Property
...
DerivedAssemblyDefinition.**IncludeAllTopLevelWorkFeatures**() As [DerivedComponentOptionEnum](../DerivedComponentOptionEnum.md)
