# SketchCircleProxy.SetCustomLineType Method
...
SketchCircleProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
