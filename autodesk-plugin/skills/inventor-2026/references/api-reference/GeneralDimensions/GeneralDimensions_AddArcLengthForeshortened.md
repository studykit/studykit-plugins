# GeneralDimensions.AddArcLengthForeshortened Method
...
GeneralDimensions.**AddArcLengthForeshortened**( ***TextOrigin*** As [Point2d](../Point2d/Point2d.md), ***IntentOne*** As [GeometryIntent](../GeometryIntent/GeometryIntent.md), [***IntentTwo***] As Variant, [***IntentThree***] As Variant, [***VirtualArcPosition***] As Variant, [***HideSecondArrowhead***] As Boolean, [***UseQuadrant***] As Boolean, [***OppositeAngle***] As Boolean, [***DimensionStyle***] As Variant, [***Layer***] As Variant ) As [LinearGeneralDimension](../LinearGeneralDimension/LinearGeneralDimension.md)
...
| VirtualArcPosition | Variant | Optional input GeometryIntent object that specifies the virtual arc’s position for dimension. The GeometryIntent object can be created using the CreateGeometryIntent method on the Sheet object.   This is an optional argument whose default value is null. |
