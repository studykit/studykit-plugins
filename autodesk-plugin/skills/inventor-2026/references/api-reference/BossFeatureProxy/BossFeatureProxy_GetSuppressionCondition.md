# BossFeatureProxy.GetSuppressionCondition Method

Parent Object: [BossFeatureProxy](../BossFeatureProxy/BossFeatureProxy.md)
...
BossFeatureProxy.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
