# SketchOffsetSplineProxy.SetCustomLineType Method
...
SketchOffsetSplineProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
