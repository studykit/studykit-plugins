# ComponentOccurrence.ReferencedDocumentDescriptor Property
...
ComponentOccurrence.**ReferencedDocumentDescriptor**() As [DocumentDescriptor](../DocumentDescriptor/DocumentDescriptor.md)
