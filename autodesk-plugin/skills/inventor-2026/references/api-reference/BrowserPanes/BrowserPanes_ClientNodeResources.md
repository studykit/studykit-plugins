...
BrowserPanes.**ClientNodeResources**() As [ClientNodeResources](../ClientNodeResources/ClientNodeResources.md)

## Property Value

This is a read only property whose value is a [ClientNodeResources](../ClientNodeResources/ClientNodeResources.md).
