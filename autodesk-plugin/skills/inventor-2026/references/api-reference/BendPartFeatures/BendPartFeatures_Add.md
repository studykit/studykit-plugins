...
BendPartFeatures.**Add**( ***BendLine*** As [SketchLine](../SketchLine/SketchLine.md), ***BendPartType*** As [BendPartTypeEnum](../BendPartTypeEnum.md), ***InputOne*** As Variant, ***InputTwo*** As Variant, ***BendSide*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), ***BendInSketchNormalDirection*** As Boolean, [***Body***] As Variant, [***BendMinimum***] As Boolean ) As [BendPartFeature](../BendPartFeature/BendPartFeature.md)
...
| BendPartType | [BendPartTypeEnum](../BendPartTypeEnum.md) | Input constant that indicates the type of the bend part feature. See Note 1. |
...
| BendSide | [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md) | Input constant that indicates which side of the model to bend. See Note 4 |
...
| Body | Variant | Optional input SurfaceBody object that specifies the solid body to bend. If not specified, a default body is chosen in the case of multi solid body parts. |
...
![](../images/bendpartfeatures_add.png)
