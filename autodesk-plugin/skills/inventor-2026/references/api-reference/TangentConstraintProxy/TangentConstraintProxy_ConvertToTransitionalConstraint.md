# TangentConstraintProxy.ConvertToTransitionalConstraint Method
...
TangentConstraintProxy.**ConvertToTransitionalConstraint**( ***FaceOne*** As [Face](../Face/Face.md), ***FaceTwo*** As [Face](../Face/Face.md), [***BiasPointOne***] As Variant, [***BiasPointTwo***] As Variant ) As [TransitionalConstraint](../TransitionalConstraint/TransitionalConstraint.md)
