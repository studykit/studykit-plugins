# PresentationEdge.CalculateStrokesWithOptions Method
...
PresentationEdge.**CalculateStrokesWithOptions**( ***ChordalTolerance*** As Double, ***Options*** As [NameValueMap](../NameValueMap/NameValueMap.md), ***VertexCount*** As Long, ***VertexCoordinates***() As Double, ***PolylineCount*** As Long, ***PolylineLengths***() As Long )
