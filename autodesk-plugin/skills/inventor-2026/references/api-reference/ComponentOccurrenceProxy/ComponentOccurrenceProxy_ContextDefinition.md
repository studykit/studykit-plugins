# ComponentOccurrenceProxy.ContextDefinition Property
...
ComponentOccurrenceProxy.**ContextDefinition**() As [ComponentDefinition](../ComponentDefinition/ComponentDefinition.md)
