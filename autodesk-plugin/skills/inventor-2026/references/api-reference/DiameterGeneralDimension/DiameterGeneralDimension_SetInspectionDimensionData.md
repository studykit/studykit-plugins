# DiameterGeneralDimension.SetInspectionDimensionData Method
...
DiameterGeneralDimension.**SetInspectionDimensionData**( [***Shape***] As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), [***Label***] As String, [***Rate***] As String )
