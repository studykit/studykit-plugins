# HelicalCurves.CreateConstantShapeDefinition Method
...
HelicalCurves.**CreateConstantShapeDefinition**( ***ShapeDefinitionType*** As [HelicalShapeDefinitionTypeEnum](../HelicalShapeDefinitionTypeEnum.md), ***AxisStartPoint*** As [Point](../Point/Point.md), ***AxisEndPoint*** As [Point](../Point/Point.md), ***CurveStartPoint*** As [Point](../Point/Point.md), ***Diameter*** As Variant, [***Pitch***] As Variant, [***Revolution***] As Variant, [***Height***] As Variant ) As [HelicalCurveConstantShapeDefinition](../HelicalCurveConstantShapeDefinition/HelicalCurveConstantShapeDefinition.md)
...
| ShapeDefinitionType | [HelicalShapeDefinitionTypeEnum](../HelicalShapeDefinitionTypeEnum.md) | Input HelicalShapeDefinitionTypeEnum that defines the helical curve shape definition type. Valid value includes: kPitchAndRevolutionShapeType, kPitchAndHeightShapeType, kRevolutionAndHeightShapeType and kSpiralShapeType. |
