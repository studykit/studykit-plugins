...
PositionalRepresentation.**IsGroundingOverridden**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md), ***Grounded*** As Boolean ) As Boolean
