# RotateTranslateConstraintProxy.AffectedOccurrenceTwo Property
...
RotateTranslateConstraintProxy.**AffectedOccurrenceTwo**() As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md)
