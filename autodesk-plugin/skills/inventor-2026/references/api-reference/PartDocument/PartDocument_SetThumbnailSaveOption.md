# PartDocument.SetThumbnailSaveOption Method
...
PartDocument.**SetThumbnailSaveOption**( ***SaveOption*** As [ThumbnailSaveOptionEnum](../ThumbnailSaveOptionEnum.md), [***ImageFullFileName***] As String )
