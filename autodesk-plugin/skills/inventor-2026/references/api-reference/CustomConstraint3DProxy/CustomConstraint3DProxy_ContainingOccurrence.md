# CustomConstraint3DProxy.ContainingOccurrence Property
...
CustomConstraint3DProxy.**ContainingOccurrence**() As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md)
