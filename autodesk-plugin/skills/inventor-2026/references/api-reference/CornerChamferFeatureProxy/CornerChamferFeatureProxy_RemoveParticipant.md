# CornerChamferFeatureProxy.RemoveParticipant Method
...
CornerChamferFeatureProxy.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
