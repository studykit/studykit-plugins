...
HemFeatures.**Item**( ***Index*** As Variant ) As [HemFeature](../HemFeature/HemFeature.md)

## Property Value

This is a read only property whose value is a [HemFeature](../HemFeature/HemFeature.md).
