# TriangleGraphics.GetTransformBehavior Method
...
TriangleGraphics.**GetTransformBehavior**( ***TextAnchor*** As [Point](../Point/Point.md), ***BehaviorType*** As [DisplayTransformBehaviorEnum](../DisplayTransformBehaviorEnum.md), ***PixelScale*** As Double )
