# SketchSplineHandleProxy.SetCustomLineType Method
...
SketchSplineHandleProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
