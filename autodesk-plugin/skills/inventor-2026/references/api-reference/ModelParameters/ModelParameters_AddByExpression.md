# ModelParameters.AddByExpression Method
...
ModelParameters.**AddByExpression**( ***Expression*** As String, ***UnitsSpecifier*** As Variant, [***Name***] As String ) As [ModelParameter](../ModelParameter/ModelParameter.md)
