...
Parent Object: [iPartTableColumns](../iPartTableColumns/iPartTableColumns.md)
...
iPartTableColumns.**Item**( ***Index*** As Long ) As [iPartTableColumn](../iPartTableColumn/iPartTableColumn.md)

## Property Value

This is a read only property whose value is an [iPartTableColumn](../iPartTableColumn/iPartTableColumn.md).
