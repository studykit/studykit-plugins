# MouseEvents.OnMouseDown Event

Parent Object: [MouseEvents](../MouseEvents/MouseEvents.md)

## Description

Event that occurs then the user presses a mouse button and begins to hold it down for a perceptible time.

## Syntax

MouseEvents.**OnMouseDown**( ***Button*** As [MouseButtonEnum](../MouseButtonEnum.md), ***ShiftKeys*** As [ShiftStateEnum](../ShiftStateEnum.md), ***ModelPosition*** As [Point](../Point/Point.md), ***ViewPosition*** As [Point2d](../Point2d/Point2d.md), ***View*** As [View](../View/View.md) )
