...
Parent Object: [ContourRollFeatures](../ContourRollFeatures/ContourRollFeatures.md)
...
ContourRollFeatures.**Item**( ***Index*** As Variant ) As [ContourRollFeature](../ContourRollFeature/ContourRollFeature.md)

## Property Value

This is a read only property whose value is a [ContourRollFeature](../ContourRollFeature/ContourRollFeature.md).
