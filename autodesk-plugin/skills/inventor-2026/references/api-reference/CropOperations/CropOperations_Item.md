...
CropOperations.**Item**( ***Index*** As Long ) As [CropOperation](../CropOperation/CropOperation.md)

## Property Value

This is a read only property whose value is a [CropOperation](../CropOperation/CropOperation.md).
