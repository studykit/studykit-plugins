# SketchFixedSpline3DProxy.Edit Method
...
SketchFixedSpline3DProxy.**Edit**( ***SplineCurve*** As [BSplineCurve](../BSplineCurve/BSplineCurve.md), [***StartPoint***] As Variant, [***EndPoint***] As Variant )
