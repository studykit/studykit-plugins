# SheetMetalComponentDefinition.UnfoldMethods Property
...
SheetMetalComponentDefinition.**UnfoldMethods**() As [UnfoldMethods](../UnfoldMethods/UnfoldMethods.md)

## Property Value

This is a read only property whose value is a [UnfoldMethods](../UnfoldMethods/UnfoldMethods.md).
