# ModelHoleThreadNoteDefinition.GetHolePropertyTolerancePrecision Method
...
ModelHoleThreadNoteDefinition.**GetHolePropertyTolerancePrecision**( ***HolePropEnum*** As [HolePropertyEnum](../HolePropertyEnum.md) ) As Long
