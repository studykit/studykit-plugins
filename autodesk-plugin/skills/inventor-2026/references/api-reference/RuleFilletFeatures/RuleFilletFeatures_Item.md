...
Parent Object: [RuleFilletFeatures](../RuleFilletFeatures/RuleFilletFeatures.md)
...
RuleFilletFeatures.**Item**( ***Index*** As Variant ) As [RuleFilletFeature](../RuleFilletFeature/RuleFilletFeature.md)
