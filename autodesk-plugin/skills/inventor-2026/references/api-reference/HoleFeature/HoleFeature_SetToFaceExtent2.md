# HoleFeature.SetToFaceExtent2 Method
...
HoleFeature.**SetToFaceExtent2**( ***ToFace*** As Object, ***ExtendToFace*** As Boolean, [***DrillPointType***] As Variant, [***BottomTipAngle***] As Variant )
