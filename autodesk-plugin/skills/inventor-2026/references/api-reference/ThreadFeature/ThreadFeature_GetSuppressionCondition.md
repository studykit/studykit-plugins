# ThreadFeature.GetSuppressionCondition Method

Parent Object: [ThreadFeature](../ThreadFeature/ThreadFeature.md)
...
ThreadFeature.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
