...
GraphicsNodeProxy.**ItemById**( ***DataSetId*** As Long ) As [GraphicsPrimitive](../GraphicsPrimitive/GraphicsPrimitive.md)

## Property Value

This is a read only property whose value is a [GraphicsPrimitive](../GraphicsPrimitive/GraphicsPrimitive.md).
