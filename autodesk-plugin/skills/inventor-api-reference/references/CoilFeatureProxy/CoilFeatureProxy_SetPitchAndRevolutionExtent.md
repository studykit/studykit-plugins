# CoilFeatureProxy.SetPitchAndRevolutionExtent Method
...
CoilFeatureProxy.**SetPitchAndRevolutionExtent**( ***Pitch*** As Variant, ***Revolution*** As Variant, [***TaperAngle***] As Variant )
