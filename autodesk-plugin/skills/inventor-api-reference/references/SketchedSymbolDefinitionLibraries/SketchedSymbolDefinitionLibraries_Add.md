...
SketchedSymbolDefinitionLibraries.**Add**( ***Name*** As String ) As [SketchedSymbolDefinitionLibrary](../SketchedSymbolDefinitionLibrary/SketchedSymbolDefinitionLibrary.md)
