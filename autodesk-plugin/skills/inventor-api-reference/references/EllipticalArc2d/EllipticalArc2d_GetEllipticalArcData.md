...
EllipticalArc2d.**GetEllipticalArcData**( ***Center***() As Double, ***MajorAxis***() As Double, ***MajorRadius*** As Double, ***MinorRadius*** As Double, ***StartAngle*** As Double, ***SweepAngle*** As Double )
