...
WorkPointProxy.**DefinitionType**() As [WorkPointDefinitionEnum](../WorkPointDefinitionEnum.md)

## Property Value

This is a read only property whose value is a [WorkPointDefinitionEnum](../WorkPointDefinitionEnum.md).
