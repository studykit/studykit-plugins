# SurfaceGraphicsEdge.SetCustomLineType Method
...
SurfaceGraphicsEdge.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
