# SectionDrawingView.BreakOutOperations Property
...
SectionDrawingView.**BreakOutOperations**() As [BreakOutOperations](../BreakOutOperations/BreakOutOperations.md)

## Property Value

This is a read only property whose value is a [BreakOutOperations](../BreakOutOperations/BreakOutOperations.md).
