# SectionDrawingView.GetHiddenLinesStatus Method
...
SectionDrawingView.**GetHiddenLinesStatus**( ***Component*** As Object ) As [HiddenLinesStatusEnum](../HiddenLinesStatusEnum.md)
