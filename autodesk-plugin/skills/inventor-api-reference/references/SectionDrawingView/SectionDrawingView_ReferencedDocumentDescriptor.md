# SectionDrawingView.ReferencedDocumentDescriptor Property
...
SectionDrawingView.**ReferencedDocumentDescriptor**() As [DocumentDescriptor](../DocumentDescriptor/DocumentDescriptor.md)
