# CommandControls.AddButtonPopup Method
...
CommandControls.**AddButtonPopup**( ***ButtonDefinitions*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), [***UseLargeIcon***] As Boolean, [***ShowText***] As Boolean, [***TargetControlInternalName***] As String, [***InsertBeforeTargetControl***] As Boolean ) As [CommandControl](../CommandControl/CommandControl.md)
