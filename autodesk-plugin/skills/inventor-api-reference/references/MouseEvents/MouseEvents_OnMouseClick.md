# MouseEvents.OnMouseClick Event

Parent Object: [MouseEvents](../MouseEvents/MouseEvents.md)

## Description

Event that occurs when the user presses and then releases a mouse button.

## Syntax

MouseEvents.**OnMouseClick**( ***Button*** As [MouseButtonEnum](../MouseButtonEnum.md), ***ShiftKeys*** As [ShiftStateEnum](../ShiftStateEnum.md), ***ModelPosition*** As [Point](../Point/Point.md), ***ViewPosition*** As [Point2d](../Point2d/Point2d.md), ***View*** As [View](../View/View.md) )
