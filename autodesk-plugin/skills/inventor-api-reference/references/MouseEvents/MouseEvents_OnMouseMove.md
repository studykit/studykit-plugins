# MouseEvents.OnMouseMove Event

Parent Object: [MouseEvents](../MouseEvents/MouseEvents.md)

## Description

Event that occurs when the user moves the mouse. The position moved to is described by the arguments of this event.

## Syntax

MouseEvents.**OnMouseMove**( ***Button*** As [MouseButtonEnum](../MouseButtonEnum.md), ***ShiftKeys*** As [ShiftStateEnum](../ShiftStateEnum.md), ***ModelPosition*** As [Point](../Point/Point.md), ***ViewPosition*** As [Point2d](../Point2d/Point2d.md), ***View*** As [View](../View/View.md) )
