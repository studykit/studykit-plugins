# PartComponentDefinition.RepositionObject Method
...
PartComponentDefinition.**RepositionObject**( ***TargetObject*** As Object, ***Before*** As Boolean, ***StartObject*** As Object, [***EndObject***] As Variant )
