# HoleThreadNote.SetInspectionDimensionData Method
...
HoleThreadNote.**SetInspectionDimensionData**( [***Shape***] As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), [***Label***] As String, [***Rate***] As String )
