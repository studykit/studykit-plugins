# DirectEditFeature.Delete Method
...
DirectEditFeature.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
