# DirectEditFeature.GetSuppressionCondition Method
...
DirectEditFeature.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
