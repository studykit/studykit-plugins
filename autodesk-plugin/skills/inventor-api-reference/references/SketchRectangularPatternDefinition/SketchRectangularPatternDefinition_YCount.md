# SketchRectangularPatternDefinition.YCount Property
...
Gets and sets the number of instances in the Y direction.

## Syntax

SketchRectangularPatternDefinition.**YCount**() As Variant
