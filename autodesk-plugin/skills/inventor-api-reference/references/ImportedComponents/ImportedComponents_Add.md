...
ImportedComponents.**Add**( ***Definition*** As [ImportedComponentDefinition](../ImportedComponentDefinition/ImportedComponentDefinition.md) ) As [ImportedComponent](../ImportedComponent/ImportedComponent.md)
...
| Definition | [ImportedComponentDefinition](../ImportedComponentDefinition/ImportedComponentDefinition.md) | Input ImportedComponentDefinition object that defines the imported component. |
