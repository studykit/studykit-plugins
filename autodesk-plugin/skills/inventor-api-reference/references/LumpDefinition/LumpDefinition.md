...
| --- | --- |
| Name | Description |
| [Application](../LumpDefinition/LumpDefinition_Application.md) | Returns the top-level parent application object. When used the context of Inventor, an Application object is returned. When used in the context of Apprentice, an ApprenticeServer object is returned. |
| [FaceShellDefinitions](../LumpDefinition/LumpDefinition_FaceShellDefinitions.md) | Property that returns the collection of FaceShellDefinitionobjects associated with this LumpDefinition object. |
| [Type](../LumpDefinition/LumpDefinition_Type.md) | Returns an ObjectTypeEnum indicating this object's type. |

## Accessed From

[LumpDefinitions.Add](../LumpDefinitions/LumpDefinitions_Add.md), [LumpDefinitions.Item](../LumpDefinitions/LumpDefinitions_Item.md)
