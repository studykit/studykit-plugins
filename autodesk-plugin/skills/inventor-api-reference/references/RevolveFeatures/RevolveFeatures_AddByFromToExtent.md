# RevolveFeatures.AddByFromToExtent Method
...
RevolveFeatures.**AddByFromToExtent**( ***Profile*** As [Profile](../Profile/Profile.md), ***AxisEntity*** As Object, ***FromFace*** As Object, ***ExtendFromFace*** As Boolean, ***ToFace*** As Object, ***ExtendToFace*** As Boolean, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), ***MinimumSolution*** As Boolean, ***Operation*** As [PartFeatureOperationEnum](../PartFeatureOperationEnum.md) ) As [RevolveFeature](../RevolveFeature/RevolveFeature.md)
