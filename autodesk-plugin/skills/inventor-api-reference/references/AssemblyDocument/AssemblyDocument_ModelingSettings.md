...
AssemblyDocument.**ModelingSettings**() As [ModelingSettings](../ModelingSettings/ModelingSettings.md)

## Property Value

This is a read only property whose value is a [ModelingSettings](../ModelingSettings/ModelingSettings.md).
