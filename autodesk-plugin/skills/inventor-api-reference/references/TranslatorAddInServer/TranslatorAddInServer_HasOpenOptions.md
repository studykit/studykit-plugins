...
TranslatorAddInServer.**HasOpenOptions**( ***SourceData*** As [DataMedium](../DataMedium/DataMedium.md), ***Context*** As [TranslationContext](../TranslationContext/TranslationContext.md), ***DefaultOptions*** As [NameValueMap](../NameValueMap/NameValueMap.md) ) As Boolean
