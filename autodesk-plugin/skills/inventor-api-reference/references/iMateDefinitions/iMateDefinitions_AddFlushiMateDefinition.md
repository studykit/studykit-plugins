...
iMateDefinitions.**AddFlushiMateDefinition**( ***Entity*** As Object, ***Offset*** As Variant, [***BiasPoint***] As Variant, [***Name***] As String, [***MatchList***] As Variant ) As [FlushiMateDefinition](../FlushiMateDefinition/FlushiMateDefinition.md)
