...
Application.**AssetLibraries**() As [AssetLibraries](../AssetLibraries/AssetLibraries.md)

## Property Value

This is a read only property whose value is an [AssetLibraries](../AssetLibraries/AssetLibraries.md).
