# DimensionConstraints3D.AddLineLength Method
...
DimensionConstraints3D.**AddLineLength**( ***Line*** As [SketchLine3D](../SketchLine3D/SketchLine3D.md), [***TextPoint***] As Variant, [***Driven***] As Boolean ) As [LineLengthDimConstraint3D](../LineLengthDimConstraint3D/LineLengthDimConstraint3D.md)
