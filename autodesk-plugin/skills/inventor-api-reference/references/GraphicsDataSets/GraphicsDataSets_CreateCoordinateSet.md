# GraphicsDataSets.CreateCoordinateSet Method
...
GraphicsDataSets.**CreateCoordinateSet**( ***DataSetId*** As Long ) As [GraphicsCoordinateSet](../GraphicsCoordinateSet/GraphicsCoordinateSet.md)
