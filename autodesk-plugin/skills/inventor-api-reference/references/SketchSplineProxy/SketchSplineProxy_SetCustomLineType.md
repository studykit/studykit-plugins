# SketchSplineProxy.SetCustomLineType Method
...
SketchSplineProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
