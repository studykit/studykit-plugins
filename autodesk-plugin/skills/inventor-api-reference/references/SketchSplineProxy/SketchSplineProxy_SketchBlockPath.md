# SketchSplineProxy.SketchBlockPath Property
...
SketchSplineProxy.**SketchBlockPath**() As [SketchBlocksEnumerator](../SketchBlocksEnumerator/SketchBlocksEnumerator.md)
