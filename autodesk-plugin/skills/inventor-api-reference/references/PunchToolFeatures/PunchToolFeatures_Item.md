...
PunchToolFeatures.**Item**( ***Index*** As Variant ) As [PunchToolFeature](../PunchToolFeature/PunchToolFeature.md)

## Property Value

This is a read only property whose value is a [PunchToolFeature](../PunchToolFeature/PunchToolFeature.md).
