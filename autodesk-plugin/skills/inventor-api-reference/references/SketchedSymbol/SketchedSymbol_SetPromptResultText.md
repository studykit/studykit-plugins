...
SketchedSymbol.**SetPromptResultText**( ***DefinitionText*** As [TextBox](../TextBox/TextBox.md), ***NewValue*** As String )
...
| DefinitionText | [TextBox](../TextBox/TextBox.md) | Input TextBox object from the referenced sketched symbol object. This text box is used to specify which prompted text box to set the text for. |
