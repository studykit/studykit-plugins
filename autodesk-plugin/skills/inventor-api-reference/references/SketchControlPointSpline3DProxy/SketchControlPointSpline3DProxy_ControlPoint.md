# SketchControlPointSpline3DProxy.ControlPoint Property
...
SketchControlPointSpline3DProxy.**ControlPoint**( ***Index*** As Long ) As [SketchPoint3D](../SketchPoint3D/SketchPoint3D.md)
