# PresentationDocument.SetMissingAddInBehavior Method
...
PresentationDocument.**SetMissingAddInBehavior**( ***ClientId*** As String, ***DisabledCommandTypesEnum*** As [CommandTypesEnum](../CommandTypesEnum.md), [***DisabledCommands***] As Variant )
