# PresentationDocument.SetThumbnailSaveOption Method
...
PresentationDocument.**SetThumbnailSaveOption**( ***SaveOption*** As [ThumbnailSaveOptionEnum](../ThumbnailSaveOptionEnum.md), [***ImageFullFileName***] As String )
