# PresentationDocument.FindWhereUsed Method
...
PresentationDocument.**FindWhereUsed**( ***FullFileName*** As String ) As [DocumentsEnumerator](../DocumentsEnumerator/DocumentsEnumerator.md)
