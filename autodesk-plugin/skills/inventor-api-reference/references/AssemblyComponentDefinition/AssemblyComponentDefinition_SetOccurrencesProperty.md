...
AssemblyComponentDefinition.**SetOccurrencesProperty**( ***pOccurrences*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), ***PropertyName*** As String, ***Value*** As Variant )
