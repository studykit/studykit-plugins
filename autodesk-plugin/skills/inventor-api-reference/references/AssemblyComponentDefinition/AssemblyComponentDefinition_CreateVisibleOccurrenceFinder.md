# AssemblyComponentDefinition.CreateVisibleOccurrenceFinder Method
...
AssemblyComponentDefinition.**CreateVisibleOccurrenceFinder**( ***Visible*** As Boolean, ***PercentageVisible*** As Double, ***Compact*** As Boolean ) As [VisibleOccurrenceFinder](../VisibleOccurrenceFinder/VisibleOccurrenceFinder.md)
