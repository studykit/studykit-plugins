# DerivedAssemblyDefinition.IncludeAllTopLeveliMateDefinitions Property
...
DerivedAssemblyDefinition.**IncludeAllTopLeveliMateDefinitions**() As [DerivedComponentOptionEnum](../DerivedComponentOptionEnum.md)
