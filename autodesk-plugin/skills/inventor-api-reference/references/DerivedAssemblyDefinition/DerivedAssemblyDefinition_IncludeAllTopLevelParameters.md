# DerivedAssemblyDefinition.IncludeAllTopLevelParameters Property
...
DerivedAssemblyDefinition.**IncludeAllTopLevelParameters**() As [DerivedComponentOptionEnum](../DerivedComponentOptionEnum.md)
