...
EmbossFeatureProxy.**SetEngraveFromFace**( ***Distance*** As Variant, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), [***WrapFace***] As Variant )
