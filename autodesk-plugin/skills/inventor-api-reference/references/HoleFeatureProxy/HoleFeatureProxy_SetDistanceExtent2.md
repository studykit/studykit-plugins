# HoleFeatureProxy.SetDistanceExtent2 Method
...
HoleFeatureProxy.**SetDistanceExtent2**( ***Depth*** As Variant, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), [***DrillPointType***] As Variant, [***BottomTipAngle***] As Variant )
