...
GeometricConstraints.**AddGround**( ***Entity*** As [SketchEntity](../SketchEntity/SketchEntity.md) ) As [GroundConstraint](../GroundConstraint/GroundConstraint.md)
...
| Entity | [SketchEntity](../SketchEntity/SketchEntity.md) | Input sketch entity. |
