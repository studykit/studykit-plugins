# PartDocument.GetMissingAddInBehavior Method
...
PartDocument.**GetMissingAddInBehavior**( ***ClientId*** As String, ***DisabledCommandTypesEnum*** As [CommandTypesEnum](../CommandTypesEnum.md), ***DisabledCommands*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md) )
