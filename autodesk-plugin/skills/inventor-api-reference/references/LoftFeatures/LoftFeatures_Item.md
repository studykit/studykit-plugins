...
LoftFeatures.**Item**( ***Index*** As Variant ) As [LoftFeature](../LoftFeature/LoftFeature.md)

## Property Value

This is a read only property whose value is a [LoftFeature](../LoftFeature/LoftFeature.md).
