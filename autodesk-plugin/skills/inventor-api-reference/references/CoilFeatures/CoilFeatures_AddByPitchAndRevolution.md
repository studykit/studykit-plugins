# CoilFeatures.AddByPitchAndRevolution Method
...
| FlatStartType | Boolean | Optional input Boolean that indicates the coil end type. The default is False indicating a natural end type. True indicates a flat start type.   This is an optional argument whose default value is False. |
...
| FlatEndType | Boolean | Optional input Boolean that indicates the coil end type. The default is False indicating a natural end type. True indicates a flat end type.   This is an optional argument whose default value is False. |
