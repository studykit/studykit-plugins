# TranslateTranslateConstraint.ConvertToRotateTranslateConstraint Method
...
TranslateTranslateConstraint.**ConvertToRotateTranslateConstraint**( ***EntityOne*** As Object, ***EntityTwo*** As Object, ***Ratio*** As Variant, ***ForwardDirection*** As Boolean, [***BiasPointOne***] As Variant, [***BiasPointTwo***] As Variant ) As [RotateTranslateConstraint](../RotateTranslateConstraint/RotateTranslateConstraint.md)
