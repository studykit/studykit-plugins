...
PositionalRepresentation.**SetPatternRowOffsetOverride**( ***Pattern*** As [RectangularOccurrencePattern](../RectangularOccurrencePattern/RectangularOccurrencePattern.md), ***RowOffset*** As String )
