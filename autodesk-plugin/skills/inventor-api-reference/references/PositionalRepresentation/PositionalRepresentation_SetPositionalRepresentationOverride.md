...
PositionalRepresentation.**SetPositionalRepresentationOverride**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md), ***Representation*** As String )
