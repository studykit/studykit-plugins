...
PositionalRepresentation.**IsPatternColumnOffsetOverridden**( ***Pattern*** As [RectangularOccurrencePattern](../RectangularOccurrencePattern/RectangularOccurrencePattern.md), ***ColumnOffset*** As String ) As Boolean
...
| Pattern | [RectangularOccurrencePattern](../RectangularOccurrencePattern/RectangularOccurrencePattern.md) | Input RectangularOccurrencePattern object that specifies the pattern to be queried for the override. |
