...
PointCloudCrops.**Item**( ***Index*** As Variant ) As [PointCloudCrop](../PointCloudCrop/PointCloudCrop.md)

## Property Value

This is a read only property whose value is a [PointCloudCrop](../PointCloudCrop/PointCloudCrop.md).
