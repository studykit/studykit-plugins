# DrawingView.SetAutomatedCenterlineSettings Method
...
DrawingView.**SetAutomatedCenterlineSettings**( [***AutomatedCenterlineSettings***] As Variant ) As [ObjectsEnumerator](../ObjectsEnumerator/ObjectsEnumerator.md)
