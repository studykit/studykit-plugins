# DirectEditFeatureProxy.RemoveParticipant Method
...
DirectEditFeatureProxy.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
