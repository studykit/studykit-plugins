# SplitFeatureProxy.SetToTrimSolid Method
...
SplitFeatureProxy.**SetToTrimSolid**( ***SplitTool*** As Object, ***Body*** As [SurfaceBody](../SurfaceBody/SurfaceBody.md), [***RemovePositiveSide***] As Boolean )
