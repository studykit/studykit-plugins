# NonParametricBaseFeatureDefinition.BRepEntities Property
...
NonParametricBaseFeatureDefinition.**BRepEntities**() As [ObjectCollection](../ObjectCollection/ObjectCollection.md)
