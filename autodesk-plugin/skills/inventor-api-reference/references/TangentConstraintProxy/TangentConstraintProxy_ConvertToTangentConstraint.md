# TangentConstraintProxy.ConvertToTangentConstraint Method
...
TangentConstraintProxy.**ConvertToTangentConstraint**( ***EntityOne*** As Object, ***EntityTwo*** As Object, ***InsideTangency*** As Boolean, ***Offset*** As Variant, [***BiasPointOne***] As Variant, [***BiasPointTwo***] As Variant ) As [TangentConstraint](../TangentConstraint/TangentConstraint.md)
