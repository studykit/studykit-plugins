...
Point2d.**IsEqualTo**( ***Point*** As [Point2d](../Point2d/Point2d.md), [***Tolerance***] As Double ) As Boolean
...
| Point | [Point2d](../Point2d/Point2d.md) | Input Point2d object that specifies the coordinate to compare. |
