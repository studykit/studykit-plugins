# LipFeatureProxy.GetSuppressionCondition Method

Parent Object: [LipFeatureProxy](../LipFeatureProxy/LipFeatureProxy.md)
...
LipFeatureProxy.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
