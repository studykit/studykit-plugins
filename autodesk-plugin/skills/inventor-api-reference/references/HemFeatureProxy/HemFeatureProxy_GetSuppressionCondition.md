# HemFeatureProxy.GetSuppressionCondition Method

Parent Object: [HemFeatureProxy](../HemFeatureProxy/HemFeatureProxy.md)
...
HemFeatureProxy.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
