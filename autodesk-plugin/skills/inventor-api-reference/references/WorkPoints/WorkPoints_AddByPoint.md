...
WorkPoints.**AddByPoint**( ***Point*** As Object, [***Construction***] As Boolean ) As [WorkPoint](../WorkPoint/WorkPoint.md)
...
| Point | Object | Input object that represents a point. This object can be a Vertex or SketchPoint object. |
