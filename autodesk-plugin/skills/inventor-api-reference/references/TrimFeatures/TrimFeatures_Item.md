...
Parent Object: [TrimFeatures](../TrimFeatures/TrimFeatures.md)
...
TrimFeatures.**Item**( ***Index*** As Variant ) As [TrimFeature](../TrimFeature/TrimFeature.md)

## Property Value

This is a read only property whose value is a [TrimFeature](../TrimFeature/TrimFeature.md).
