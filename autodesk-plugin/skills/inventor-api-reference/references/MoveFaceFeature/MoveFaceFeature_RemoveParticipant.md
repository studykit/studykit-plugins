# MoveFaceFeature.RemoveParticipant Method
...
MoveFaceFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
