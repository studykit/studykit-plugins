...
iMateResultProxy.**SetInputs**( ***iMateDefinition*** As [iMateDefinition](../iMateDefinition/iMateDefinition.md), ***Entity*** As Object, [***EntityBiasPoint***] As Variant, [***SolutionType***] As [AngleConstraintSolutionTypeEnum](../AngleConstraintSolutionTypeEnum.md) )
