...
AssemblyConstraints.**AddFlushConstraint**( ***EntityOne*** As Object, ***EntityTwo*** As Object, ***Offset*** As Variant, [***BiasPointOne***] As Variant, [***BiasPointTwo***] As Variant ) As [FlushConstraint](../FlushConstraint/FlushConstraint.md)
...
| EntityOne | Object | Input object that defines the first object. The input object must be either a planar object or WorkPlane object. |
| EntityTwo | Object | Input object that defines the second object. The input object must be either a planar object or WorkPlane object |
