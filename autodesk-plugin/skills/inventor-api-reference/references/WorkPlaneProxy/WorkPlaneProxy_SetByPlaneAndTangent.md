# WorkPlaneProxy.SetByPlaneAndTangent Method
...
WorkPlaneProxy.**SetByPlaneAndTangent**( ***Plane*** As Object, ***Face*** As [Face](../Face/Face.md), ***ProximityPoint*** As [Point](../Point/Point.md) )
