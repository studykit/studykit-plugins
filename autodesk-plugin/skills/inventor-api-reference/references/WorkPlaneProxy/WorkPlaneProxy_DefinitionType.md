...
WorkPlaneProxy.**DefinitionType**() As [WorkPlaneDefinitionEnum](../WorkPlaneDefinitionEnum.md)

## Property Value

This is a read only property whose value is a [WorkPlaneDefinitionEnum](../WorkPlaneDefinitionEnum.md).
