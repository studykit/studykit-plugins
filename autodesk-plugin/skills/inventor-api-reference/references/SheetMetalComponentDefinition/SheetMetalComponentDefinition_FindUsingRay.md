# SheetMetalComponentDefinition.FindUsingRay Method
...
SheetMetalComponentDefinition.**FindUsingRay**( ***RayStartPoint*** As [Point](../Point/Point.md), ***RayDirection*** As [UnitVector](../UnitVector/UnitVector.md), ***Radius*** As Double, ***FoundEntities*** As [ObjectsEnumerator](../ObjectsEnumerator/ObjectsEnumerator.md), ***LocationPoints*** As [ObjectsEnumerator](../ObjectsEnumerator/ObjectsEnumerator.md), [***FindFirstOnly***] As Boolean )
