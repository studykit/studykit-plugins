# SheetMetalComponentDefinition.RepositionObject Method
...
SheetMetalComponentDefinition.**RepositionObject**( ***TargetObject*** As Object, ***Before*** As Boolean, ***StartObject*** As Object, [***EndObject***] As Variant )
