...
SheetMetalComponentDefinition.**SetBodySheetMetalStyle**( ***Body*** As [SurfaceBody](../SurfaceBody/SurfaceBody.md), ***Value*** As [SheetMetalStyle](../SheetMetalStyle/SheetMetalStyle.md) )
