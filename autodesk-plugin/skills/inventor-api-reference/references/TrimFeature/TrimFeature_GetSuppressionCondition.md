# TrimFeature.GetSuppressionCondition Method

Parent Object: [TrimFeature](../TrimFeature/TrimFeature.md)
...
TrimFeature.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
