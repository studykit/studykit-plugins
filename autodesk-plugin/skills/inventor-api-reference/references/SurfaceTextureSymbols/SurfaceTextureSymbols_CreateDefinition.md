...
SurfaceTextureSymbols.**CreateDefinition**( [***SurfaceTextureStyle***] As Variant ) As [SurfaceTextureSymbolDefinition](../SurfaceTextureSymbolDefinition/SurfaceTextureSymbolDefinition.md)
