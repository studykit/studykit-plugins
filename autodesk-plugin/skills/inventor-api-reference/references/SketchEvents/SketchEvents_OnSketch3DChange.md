...
SketchEvents.**OnSketch3DChange**( ***DocumentObject*** As [Document](../Document/Document.md), ***Sketch3D*** As [Sketch3D](../Sketch3D/Sketch3D.md), ***BeforeOrAfter*** As [EventTimingEnum](../EventTimingEnum.md), ***Context*** As [NameValueMap](../NameValueMap/NameValueMap.md), ***HandlingCode*** As [HandlingCodeEnum](../HandlingCodeEnum.md) )
...
| Sketch3D | [Sketch3D](../Sketch3D/Sketch3D.md) | The 3D sketch that is changing. |
