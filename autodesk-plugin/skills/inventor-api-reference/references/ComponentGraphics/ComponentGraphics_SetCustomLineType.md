# ComponentGraphics.SetCustomLineType Method
...
ComponentGraphics.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
