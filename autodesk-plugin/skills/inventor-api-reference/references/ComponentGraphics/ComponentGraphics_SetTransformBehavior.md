# ComponentGraphics.SetTransformBehavior Method
...
ComponentGraphics.**SetTransformBehavior**( ***Anchor*** As [Point](../Point/Point.md), ***BehaviorType*** As [DisplayTransformBehaviorEnum](../DisplayTransformBehaviorEnum.md), [***PixelScale***] As Double )
