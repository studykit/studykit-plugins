# DiameterGeneralDimension.GetInspectionDimensionData Method
...
DiameterGeneralDimension.**GetInspectionDimensionData**( ***Shape*** As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), ***Label*** As String, ***Rate*** As String )
