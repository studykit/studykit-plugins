...
LinearModelDimensions.**Item**( ***Index*** As Variant ) As [LinearModelDimension](../LinearModelDimension/LinearModelDimension.md)

## Property Value

This is a read only property whose value is a [LinearModelDimension](../LinearModelDimension/LinearModelDimension.md).
