# SketchBlockDefinitionProxy.SketchBlocks Property
...
SketchBlockDefinitionProxy.**SketchBlocks**() As [SketchBlocks](../SketchBlocks/SketchBlocks.md)

## Property Value

This is a read only property whose value is a [SketchBlocks](../SketchBlocks/SketchBlocks.md).
