# SketchBlockDefinitionProxy.RotateSketchObjects Method
...
SketchBlockDefinitionProxy.**RotateSketchObjects**( ***SketchObjects*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), ***CenterPoint*** As [Point2d](../Point2d/Point2d.md), ***Angle*** As Double, [***Copy***] As Boolean, [***RemoveConstraints***] As Boolean ) As [ObjectsEnumerator](../ObjectsEnumerator/ObjectsEnumerator.md)
