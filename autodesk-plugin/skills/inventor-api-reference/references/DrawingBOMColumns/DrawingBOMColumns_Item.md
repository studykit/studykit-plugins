...
Parent Object: [DrawingBOMColumns](../DrawingBOMColumns/DrawingBOMColumns.md)
...
DrawingBOMColumns.**Item**( ***Index*** As Variant ) As [DrawingBOMColumn](../DrawingBOMColumn/DrawingBOMColumn.md)

## Property Value

This is a read only property whose value is a [DrawingBOMColumn](../DrawingBOMColumn/DrawingBOMColumn.md).
