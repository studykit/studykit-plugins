# FaceProxy.CalculateFacets Method

Parent Object: [FaceProxy](../FaceProxy/FaceProxy.md)

## Description

Obtain the facetted representation for the given chord-height tolerance.

## Syntax

FaceProxy.**CalculateFacets**( ***Tolerance*** As Double, ***VertexCount*** As Long, ***FacetCount*** As Long, ***VertexCoordinates***() As Double, ***NormalVectors***() As Double, ***VertexIndices***() As Long )
