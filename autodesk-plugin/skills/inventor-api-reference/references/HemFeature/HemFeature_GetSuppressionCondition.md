# HemFeature.GetSuppressionCondition Method

Parent Object: [HemFeature](../HemFeature/HemFeature.md)
...
HemFeature.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
