# RegionProperties.CentroidMomentsOfInertia Method

Parent Object: [RegionProperties](../RegionProperties/RegionProperties.md)

## Description

Method that returns the moments of inertia about the centroid of the section.

## Syntax

RegionProperties.**CentroidMomentsOfInertia**( ***Ixx*** As Double, ***Iyy*** As Double, ***Izz*** As Double, ***Ixy*** As Double, ***Iyz*** As Double, ***Ixz*** As Double )
