...
PlanarSketchProxy.**AddStraightSlotBySlotCenter**( ***CenterPoint*** As Object, ***EndPoint*** As Object, ***Width*** As Double ) As [SketchEntitiesEnumerator](../SketchEntitiesEnumerator/SketchEntitiesEnumerator.md)
