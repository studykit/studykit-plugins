...
ProjectToSurfaceCurves.**Add**( ***Faces*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), ***Curves*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), [***ProjectionType***] As Variant, [***ProjectDirection***] As Variant ) As [ProjectToSurfaceCurve](../ProjectToSurfaceCurve/ProjectToSurfaceCurve.md)
