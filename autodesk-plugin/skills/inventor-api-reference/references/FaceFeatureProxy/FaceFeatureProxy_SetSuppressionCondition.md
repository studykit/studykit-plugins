# FaceFeatureProxy.SetSuppressionCondition Method
...
FaceFeatureProxy.**SetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant )
