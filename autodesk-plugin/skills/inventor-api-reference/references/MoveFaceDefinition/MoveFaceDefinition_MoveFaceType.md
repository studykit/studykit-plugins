...
MoveFaceDefinition.**MoveFaceType**() As [MoveFaceTypeEnum](../MoveFaceTypeEnum.md)

## Property Value

This is a read only property whose value is a [MoveFaceTypeEnum](../MoveFaceTypeEnum.md).
