# GeneralDimension.GetInspectionDimensionData Method
...
GeneralDimension.**GetInspectionDimensionData**( ***Shape*** As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), ***Label*** As String, ***Rate*** As String )
