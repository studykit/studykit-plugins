...
RefoldFeatures.**Item**( ***Index*** As Variant ) As [RefoldFeature](../RefoldFeature/RefoldFeature.md)

## Property Value

This is a read only property whose value is a [RefoldFeature](../RefoldFeature/RefoldFeature.md).
