# ModelDimensionDefinition.SetInspectionDimensionData Method
...
ModelDimensionDefinition.**SetInspectionDimensionData**( [***Shape***] As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), [***Label***] As String, [***Rate***] As String )
