...
CustomParameterGroups.**Item**( ***Index*** As Variant ) As [CustomParameterGroup](../CustomParameterGroup/CustomParameterGroup.md)

## Property Value

This is a read only property whose value is a [CustomParameterGroup](../CustomParameterGroup/CustomParameterGroup.md).
