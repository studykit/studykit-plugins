# CosmeticBendFeature.RemoveParticipant Method
...
CosmeticBendFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
