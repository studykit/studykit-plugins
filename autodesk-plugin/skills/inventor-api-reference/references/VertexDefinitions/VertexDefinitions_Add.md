...
VertexDefinitions.**Add**( ***Position*** As [Point](../Point/Point.md) ) As [VertexDefinition](../VertexDefinition/VertexDefinition.md)
...
| Position | [Point](../Point/Point.md) | Input Point object that specifies the position of the vertex. |
