...
ControlDefinition.**Classification**() As [CommandTypesEnum](../CommandTypesEnum.md)

## Property Value

This is a read only property whose value is a [CommandTypesEnum](../CommandTypesEnum.md).
