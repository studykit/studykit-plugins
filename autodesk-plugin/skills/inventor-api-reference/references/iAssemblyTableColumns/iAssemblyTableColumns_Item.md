...
Parent Object: [iAssemblyTableColumns](../iAssemblyTableColumns/iAssemblyTableColumns.md)
...
iAssemblyTableColumns.**Item**( ***Index*** As Variant ) As [iAssemblyTableColumn](../iAssemblyTableColumn/iAssemblyTableColumn.md)

## Property Value

This is a read only property whose value is an [iAssemblyTableColumn](../iAssemblyTableColumn/iAssemblyTableColumn.md).
