...
CombineFeatureProxy.**Edit**( ***BaseBody*** As [SurfaceBody](../SurfaceBody/SurfaceBody.md), ***ToolBodies*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), ***Operation*** As [PartFeatureOperationEnum](../PartFeatureOperationEnum.md) )
