...
FaceShellDefinition.**FaceDefinitions**() As [FaceDefinitions](../FaceDefinitions/FaceDefinitions.md)

## Property Value

This is a read only property whose value is a [FaceDefinitions](../FaceDefinitions/FaceDefinitions.md).
