...
Parent Object: [FaceShellDefinition](../FaceShellDefinition/FaceShellDefinition.md)
...
FaceShellDefinition.**WireDefinitions**() As [WireDefinitions](../WireDefinitions/WireDefinitions.md)

## Property Value

This is a read only property whose value is a [WireDefinitions](../WireDefinitions/WireDefinitions.md).
