...
Parent Object: [ThroughAllExtent](../ThroughAllExtent/ThroughAllExtent.md)
...
ThroughAllExtent.**Direction**() As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md)
