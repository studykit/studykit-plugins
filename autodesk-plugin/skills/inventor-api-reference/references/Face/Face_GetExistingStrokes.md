# Face.GetExistingStrokes Method
...
Face.**GetExistingStrokes**( ***ToleranceIndex*** As Double, ***VertexCount*** As Long, ***VertexCoordinates***() As Double, ***PolylineCount*** As Long, ***PolylineLengths***() As Long )
