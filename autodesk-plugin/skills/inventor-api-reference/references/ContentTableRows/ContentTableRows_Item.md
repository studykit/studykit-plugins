...
ContentTableRows.**Item**( ***Index*** As Variant ) As [ContentTableRow](../ContentTableRow/ContentTableRow.md)

## Property Value

This is a read only property whose value is a [ContentTableRow](../ContentTableRow/ContentTableRow.md).
