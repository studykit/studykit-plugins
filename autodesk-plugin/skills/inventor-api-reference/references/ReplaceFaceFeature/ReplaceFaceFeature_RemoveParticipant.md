# ReplaceFaceFeature.RemoveParticipant Method
...
ReplaceFaceFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
