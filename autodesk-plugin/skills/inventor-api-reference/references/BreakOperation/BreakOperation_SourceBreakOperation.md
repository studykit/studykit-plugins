...
BreakOperation.**SourceBreakOperation**() As [BreakOperation](../BreakOperation/BreakOperation.md)

## Property Value

This is a read only property whose value is a [BreakOperation](../BreakOperation/BreakOperation.md).
