...
CurveEvaluator.**GetParamAtPoint**( ***Points***() As Double, ***GuessParams***() As Double, ***MaxDeviations***() As Double, ***Params***() As Double, ***SolTypes***() As [SolutionNatureEnum](../SolutionNatureEnum.md) )
