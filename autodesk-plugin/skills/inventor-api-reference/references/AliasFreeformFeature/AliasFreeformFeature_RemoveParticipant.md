# AliasFreeformFeature.RemoveParticipant Method
...
AliasFreeformFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
