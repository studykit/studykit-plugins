...
ViewTabGroup.**MoveToNewViewFrame**( [***ViewFrameWidth***] As Variant, [***ViewFrameHeight***] As Variant, [***ViewFrameLeft***] As Variant, [***ViewFrameTop***] As Variant ) As [ViewFrame](../ViewFrame/ViewFrame.md)
