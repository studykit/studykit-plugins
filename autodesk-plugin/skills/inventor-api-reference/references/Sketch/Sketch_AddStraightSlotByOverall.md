# Sketch.AddStraightSlotByOverall Method
...
Sketch.**AddStraightSlotByOverall**( ***StartPoint*** As Object, ***EndPoint*** As Object, ***Width*** As Double ) As [SketchEntitiesEnumerator](../SketchEntitiesEnumerator/SketchEntitiesEnumerator.md)
