...
| --- | --- |
| Name | Description |
| [UpdateAddInList](../ApplicationAddIns/ApplicationAddIns_UpdateAddInList.md) | This method searches for new Add-ins installed since Inventor started. If a new add-in is found, it is added to the add-in list and is loaded if appropriate. |
...
| --- | --- |
| Name | Description |
| [Count](../ApplicationAddIns/ApplicationAddIns_Count.md) | Property that returns the number of items in this collection. |
| [Item](../ApplicationAddIns/ApplicationAddIns_Item.md) | Allows integer-indexed access to items in the collection. |
| [ItemById](../ApplicationAddIns/ApplicationAddIns_ItemById.md) | Returns the specified ApplicationAddIn object from the collection. Retrieves an ApplicationAddIn object based on the Client Id. |
| [Type](../ApplicationAddIns/ApplicationAddIns_Type.md) | Returns an ObjectTypeEnum indicating this object's type. |

## Accessed From

[Application.ApplicationAddIns](../Application/Application_ApplicationAddIns.md), [ApprenticeServer.ApplicationAddIns](../ApprenticeServer/ApprenticeServer_ApplicationAddIns.md), [ApprenticeServerComponent.ApplicationAddIns](../ApprenticeServerComponent/ApprenticeServerComponent_ApplicationAddIns.md), [InventorServer.ApplicationAddIns](InventorServer_ApplicationAddIns.md), [InventorServerObject.ApplicationAddIns](InventorServerObject_ApplicationAddIns.md)
