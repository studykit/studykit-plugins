# DirectEditScaleOperationProxy.Delete Method
...
DirectEditScaleOperationProxy.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
