...
Parent Object: [HelpEvents](../HelpEvents/HelpEvents.md)
...
HelpEvents.**OnApplicationHelp**( ***Context*** As [NameValueMap](../NameValueMap/NameValueMap.md), ***HandlingCode*** As [HandlingCodeEnum](../HandlingCodeEnum.md) )
