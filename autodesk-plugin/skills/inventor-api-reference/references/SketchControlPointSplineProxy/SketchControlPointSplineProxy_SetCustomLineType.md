# SketchControlPointSplineProxy.SetCustomLineType Method
...
SketchControlPointSplineProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
