# SketchControlPointSplineProxy.SketchBlockPath Property
...
SketchControlPointSplineProxy.**SketchBlockPath**() As [SketchBlocksEnumerator](../SketchBlocksEnumerator/SketchBlocksEnumerator.md)
