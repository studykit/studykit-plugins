# SketchControlPointSplineProxy.ControlPolygonSide Property
...
SketchControlPointSplineProxy.**ControlPolygonSide**( ***Index*** As Long ) As [SketchLine](../SketchLine/SketchLine.md)
