# ImportedDWGComponent.ReferencedDocumentDescriptor Property
...
ImportedDWGComponent.**ReferencedDocumentDescriptor**() As [DocumentDescriptor](../DocumentDescriptor/DocumentDescriptor.md)
