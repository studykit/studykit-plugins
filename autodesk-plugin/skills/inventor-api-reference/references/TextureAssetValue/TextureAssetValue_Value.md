...
TextureAssetValue.**Value**() As [AssetTexture](../AssetTexture/AssetTexture.md)

## Property Value

This is a read only property whose value is an [AssetTexture](../AssetTexture/AssetTexture.md).
