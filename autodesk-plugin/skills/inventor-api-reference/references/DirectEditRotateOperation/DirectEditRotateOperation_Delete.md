# DirectEditRotateOperation.Delete Method

Parent Object: [DirectEditRotateOperation](../DirectEditRotateOperation/DirectEditRotateOperation.md)
...
DirectEditRotateOperation.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
