# ComponentOccurrenceProxy.ReferencedDocumentDescriptor Property
...
ComponentOccurrenceProxy.**ReferencedDocumentDescriptor**() As [DocumentDescriptor](../DocumentDescriptor/DocumentDescriptor.md)
