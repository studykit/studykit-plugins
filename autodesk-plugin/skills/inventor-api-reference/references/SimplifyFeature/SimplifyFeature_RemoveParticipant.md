# SimplifyFeature.RemoveParticipant Method
...
SimplifyFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
