# HoleFeatures.AddCBoreByToFaceExtent2 Method
...
HoleFeatures.**AddCBoreByToFaceExtent2**( ***PlacementDefinition*** As Object, ***DiameterOrTapInfo*** As Variant, ***ToFace*** As Object, ***ExtendToFace*** As Boolean, ***CBoreDiameter*** As Variant, ***CBoreDepth*** As Variant, [***DrillPointType***] As Variant, [***BottomTipAngle***] As Variant ) As [HoleFeature](../HoleFeature/HoleFeature.md)
