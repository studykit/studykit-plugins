# HoleFeatures.AddCBoreByThroughAllExtent Method
...
HoleFeatures.**AddCBoreByThroughAllExtent**( ***PlacementDefinition*** As Object, ***DiameterOrTapInfo*** As Variant, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), ***CBoreDiameter*** As Variant, ***CBoreDepth*** As Variant ) As [HoleFeature](../HoleFeature/HoleFeature.md)
