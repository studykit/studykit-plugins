# HoleFeatures.AddSpotFaceByDistanceExtent2 Method
...
HoleFeatures.**AddSpotFaceByDistanceExtent2**( ***PlacementDefinition*** As Object, ***DiameterOrTapInfo*** As Variant, ***Depth*** As Variant, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), ***SpotFaceDiameter*** As Variant, ***SpotFaceDepth*** As Variant, [***DrillPointType***] As Variant, [***BottomTipAngle***] As Variant ) As [HoleFeature](../HoleFeature/HoleFeature.md)
