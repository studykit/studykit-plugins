...
DrawingViews.**AddOverlayView**( ***ParentView*** As [DrawingView](../DrawingView/DrawingView.md), ***PositionalRepresentation*** As String, ***DesignViewRepresentation*** As String, ***DesignViewAssociative*** As Boolean, ***ViewStyle*** As [DrawingViewStyleEnum](../DrawingViewStyleEnum.md), [***ShowLabel***] As Boolean, [***Name***] As String ) As [DrawingView](../DrawingView/DrawingView.md)
