...
Ribbon.**RibbonTabs**() As [RibbonTabs](../RibbonTabs/RibbonTabs.md)

## Property Value

This is a read only property whose value is a [RibbonTabs](../RibbonTabs/RibbonTabs.md).
