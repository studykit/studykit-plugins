# SketchBlockDefinition.SketchToModelSpace Method
...
SketchBlockDefinition.**SketchToModelSpace**( ***SketchCoordinate*** As [Point2d](../Point2d/Point2d.md) ) As [Point](../Point/Point.md)
