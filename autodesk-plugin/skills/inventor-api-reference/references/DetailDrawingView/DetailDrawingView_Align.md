# DetailDrawingView.Align Method
...
DetailDrawingView.**Align**( ***DrawingView*** As [DrawingView](../DrawingView/DrawingView.md), ***AlignmentType*** As [DrawingViewAlignmentEnum](../DrawingViewAlignmentEnum.md) )
