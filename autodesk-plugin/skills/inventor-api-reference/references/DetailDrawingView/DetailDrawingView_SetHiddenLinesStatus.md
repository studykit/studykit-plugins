# DetailDrawingView.SetHiddenLinesStatus Method
...
DetailDrawingView.**SetHiddenLinesStatus**( ***Component*** As Object, ***visibleStatus*** As [HiddenLinesStatusEnum](../HiddenLinesStatusEnum.md) )
