# DetailDrawingView.SetActiveModelState Method
...
DetailDrawingView.**SetActiveModelState**( ***ModelState*** As String, [***UpdatePartsList***] As Boolean, [***KeepOverrides***] As Boolean )
