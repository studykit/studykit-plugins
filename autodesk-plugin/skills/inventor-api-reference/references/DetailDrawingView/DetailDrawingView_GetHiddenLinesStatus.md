# DetailDrawingView.GetHiddenLinesStatus Method
...
DetailDrawingView.**GetHiddenLinesStatus**( ***Component*** As Object ) As [HiddenLinesStatusEnum](../HiddenLinesStatusEnum.md)
