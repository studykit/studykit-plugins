# DetailDrawingView.GetWeldmentState Method
...
DetailDrawingView.**GetWeldmentState**( ***WeldmentState*** As [WeldmentStateEnum](../WeldmentStateEnum.md), ***Component*** As Object )
