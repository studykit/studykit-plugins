# MiniToolbar.OnEndMove Event

Parent Object: [MiniToolbar](../MiniToolbar/MiniToolbar.md)

## Description

Event that fires when a drag or a reposition of this MiniToolbar ends.

## Syntax

MiniToolbar.**OnEndMove**( ***Context*** As [NameValueMap](../NameValueMap/NameValueMap.md), ***HandlingCode*** As [HandlingCodeEnum](../HandlingCodeEnum.md) )
