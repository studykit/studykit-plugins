# MiniToolbar.OnMove Event

Parent Object: [MiniToolbar](../MiniToolbar/MiniToolbar.md)

## Description

Event that fires when this MiniToolbar moves as a result of a drag.

## Syntax

MiniToolbar.**OnMove**( ***Context*** As [NameValueMap](../NameValueMap/NameValueMap.md), ***HandlingCode*** As [HandlingCodeEnum](../HandlingCodeEnum.md) )
