# RectangularPatternFeature.Delete Method
...
RectangularPatternFeature.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
