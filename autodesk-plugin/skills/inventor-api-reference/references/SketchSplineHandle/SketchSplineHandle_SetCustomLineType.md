# SketchSplineHandle.SetCustomLineType Method
...
SketchSplineHandle.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
