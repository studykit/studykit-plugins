# MiniToolbarTextBox.AddItem Method

Parent Object: [MiniToolbarTextBox](../MiniToolbarTextBox/MiniToolbarTextBox.md)
...
MiniToolbarTextBox.**AddItem**( ***Text*** As String, ***ToolTipText*** As String, [***InternalName***] As String, [***AllowDelete***] As Boolean, [***StandardIcon***] As Variant, [***LargeIcon***] As Variant, [***Index***] As Long ) As [MiniToolbarListItem](../MiniToolbarListItem/MiniToolbarListItem.md)
...
| InternalName | String | Input String that specifies an internal name for the control. You can provide this for convenience in identifying the item at a later time. If provided, it must be unique with respect to all other items in this text box list. |
| AllowDelete | Boolean | Optional input Boolean that specifies whether the user can delete this item from the text box list.   This is an optional argument whose default value is False. |
