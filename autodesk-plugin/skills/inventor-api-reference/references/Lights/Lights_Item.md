...
Parent Object: [Lights](../Lights/Lights.md)
...
Lights.**Item**( ***Index*** As Variant ) As [Light](../Light/Light.md)

## Property Value

This is a read only property whose value is a [Light](../Light/Light.md).
