# SketchEllipseProxy.SetCustomLineType Method
...
SketchEllipseProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
