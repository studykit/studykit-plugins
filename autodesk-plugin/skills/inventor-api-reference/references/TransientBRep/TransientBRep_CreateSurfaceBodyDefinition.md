# TransientBRep.CreateSurfaceBodyDefinition Method
...
TransientBRep.**CreateSurfaceBodyDefinition**() As [SurfaceBodyDefinition](../SurfaceBodyDefinition/SurfaceBodyDefinition.md)
