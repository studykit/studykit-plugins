...
TransientBRep.**CreateRuledSurface**( ***SectionOne*** As [Wire](../Wire/Wire.md), ***SectionTwo*** As [Wire](../Wire/Wire.md) ) As [SurfaceBody](../SurfaceBody/SurfaceBody.md)
...
| SectionOne | [Wire](../Wire/Wire.md) | Input Wire that defines the shape of the first section. |
| SectionTwo | [Wire](../Wire/Wire.md) | Input Wire that defines the shape of the second section. |
