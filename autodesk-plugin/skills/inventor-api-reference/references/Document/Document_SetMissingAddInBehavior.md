# Document.SetMissingAddInBehavior Method
...
Document.**SetMissingAddInBehavior**( ***ClientId*** As String, ***DisabledCommandTypesEnum*** As [CommandTypesEnum](../CommandTypesEnum.md), [***DisabledCommands***] As Variant )
