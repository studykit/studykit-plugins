# CornerChamferFeature.RemoveParticipant Method
...
CornerChamferFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
