...
SketchedSymbolDefinition.**CopyTo**( ***TargetDocument*** As [DrawingDocument](../DrawingDocument/DrawingDocument.md), [***ReplaceExisting***] As Boolean ) As [SketchedSymbolDefinition](../SketchedSymbolDefinition/SketchedSymbolDefinition.md)
