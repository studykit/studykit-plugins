...
RevolveFeatureProxy.**SetFromToExtent**( ***FromFace*** As Object, ***ExtendFromFace*** As Boolean, ***ToFace*** As Object, ***ExtendToFace*** As Boolean, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md), ***MinimumSolution*** As Boolean )
