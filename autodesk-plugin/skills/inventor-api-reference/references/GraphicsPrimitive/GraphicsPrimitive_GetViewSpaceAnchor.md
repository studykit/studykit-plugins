# GraphicsPrimitive.GetViewSpaceAnchor Method
...
GraphicsPrimitive.**GetViewSpaceAnchor**( ***Origin*** As [Point](../Point/Point.md), ***Anchor*** As [Point2d](../Point2d/Point2d.md), ***AnchorRelativeTo*** As [ViewLayoutEnum](../ViewLayoutEnum.md) )
