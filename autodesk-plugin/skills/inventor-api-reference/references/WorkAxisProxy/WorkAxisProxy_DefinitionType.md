...
WorkAxisProxy.**DefinitionType**() As [WorkAxisDefinitionEnum](../WorkAxisDefinitionEnum.md)

## Property Value

This is a read only property whose value is a [WorkAxisDefinitionEnum](../WorkAxisDefinitionEnum.md).
