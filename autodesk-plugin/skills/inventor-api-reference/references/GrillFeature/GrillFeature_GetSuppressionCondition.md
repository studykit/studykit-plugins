# GrillFeature.GetSuppressionCondition Method

Parent Object: [GrillFeature](../GrillFeature/GrillFeature.md)
...
GrillFeature.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
