...
FilletDefinition.**SetbackVertexItem**( ***Index*** As Long ) As [FilletSetbackVertex](../FilletSetbackVertex/FilletSetbackVertex.md)

## Property Value

This is a read only property whose value is a [FilletSetbackVertex](../FilletSetbackVertex/FilletSetbackVertex.md).
