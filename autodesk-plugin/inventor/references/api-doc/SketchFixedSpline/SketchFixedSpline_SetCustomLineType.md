# SketchFixedSpline.SetCustomLineType Method
...
SketchFixedSpline.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
