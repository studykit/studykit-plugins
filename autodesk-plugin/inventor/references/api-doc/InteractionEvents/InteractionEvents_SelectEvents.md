...
InteractionEvents.**SelectEvents**() As [SelectEvents](../SelectEvents/SelectEvents.md)

## Property Value

This is a read only property whose value is a [SelectEvents](../SelectEvents/SelectEvents.md).
