...
CustomTable.**Sort**( ***PrimaryColumnTitle*** As String, [***PrimaryColumnAscending***] As Boolean, [***SecondaryColumnTitle***] As String, [***SecondaryColumnAscending***] As Boolean, [***TertiaryColumnTitle***] As String, [***TertiaryColumnAscending***] As Boolean )
