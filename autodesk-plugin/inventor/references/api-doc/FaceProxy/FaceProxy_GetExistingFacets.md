# FaceProxy.GetExistingFacets Method
...
FaceProxy.**GetExistingFacets**( ***ToleranceIndex*** As Double, ***VertexCount*** As Long, ***FacetCount*** As Long, ***VertexCoordinates***() As Double, ***NormalVectors***() As Double, ***VertexIndices***() As Long )
