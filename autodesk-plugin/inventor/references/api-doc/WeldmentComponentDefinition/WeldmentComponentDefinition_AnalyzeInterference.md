...
WeldmentComponentDefinition.**AnalyzeInterference**( ***Set1*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), [***Set2***] As Variant ) As [InterferenceResults](../InterferenceResults/InterferenceResults.md)
