...
Sketch.**CopyEntitiesTo**( ***SketchEntities*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), ***TargetSketch*** As [Sketch](../Sketch/Sketch.md), [***Position***] As Variant )
