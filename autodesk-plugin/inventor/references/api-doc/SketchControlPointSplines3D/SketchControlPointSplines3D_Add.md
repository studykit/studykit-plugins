...
SketchControlPointSplines3D.**Add**( ***ControlPoints*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md) ) As [SketchControlPointSpline3D](../SketchControlPointSpline3D/SketchControlPointSpline3D.md)
...
| ControlPoints | [ObjectCollection](../ObjectCollection/ObjectCollection.md) | A collection of the points that defines the position of the control points. The inputs can be combination of Point and SketchPoint3D objects. |
