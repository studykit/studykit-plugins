# SketchOffsetSpline.SetCustomLineType Method
...
SketchOffsetSpline.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
