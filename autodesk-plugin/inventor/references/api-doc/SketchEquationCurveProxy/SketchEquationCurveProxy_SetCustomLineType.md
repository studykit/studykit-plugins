# SketchEquationCurveProxy.SetCustomLineType Method
...
SketchEquationCurveProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
