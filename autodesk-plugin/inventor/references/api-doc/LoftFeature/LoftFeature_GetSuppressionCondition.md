# LoftFeature.GetSuppressionCondition Method

Parent Object: [LoftFeature](../LoftFeature/LoftFeature.md)
...
LoftFeature.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
