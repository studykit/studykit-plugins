# SurfaceBody.GetExistingFacetsAndTextureMap Method
...
SurfaceBody.**GetExistingFacetsAndTextureMap**( ***ToleranceIndex*** As Double, ***VertexCount*** As Long, ***FacetCount*** As Long, ***VertexCoordinates***() As Double, ***NormalVectors***() As Double, ***VertexIndices***() As Long, ***TextureCoordinates***() As Double )
