...
Application.**ActiveAppearanceLibrary**() As [AssetLibrary](../AssetLibrary/AssetLibrary.md)

## Property Value

This is a read/write property whose value is an [AssetLibrary](../AssetLibrary/AssetLibrary.md).
