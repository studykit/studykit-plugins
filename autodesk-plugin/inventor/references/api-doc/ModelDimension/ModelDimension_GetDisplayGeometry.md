# ModelDimension.GetDisplayGeometry Method
...
ModelDimension.**GetDisplayGeometry**( ***Camera*** As [Camera](../Camera/Camera.md), ***GroupCount*** As Long, ***PolylinesPerGroup***() As Long, ***FilledGroups***() As Boolean, ***PolylineCount*** As Long, ***PolylineLengths***() As Long, ***VertexCount*** As Long, ***VertexCoordinates***() As Double )
