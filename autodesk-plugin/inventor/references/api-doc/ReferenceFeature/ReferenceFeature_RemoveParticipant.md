# ReferenceFeature.RemoveParticipant Method
...
ReferenceFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
