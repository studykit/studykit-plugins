# SketchEquationCurve.SetCustomLineType Method
...
SketchEquationCurve.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
