# SectionDrawingView.GetWeldmentState Method
...
SectionDrawingView.**GetWeldmentState**( ***WeldmentState*** As [WeldmentStateEnum](../WeldmentStateEnum.md), ***Component*** As Object )
