# SectionDrawingView.SetWeldmentState Method
...
SectionDrawingView.**SetWeldmentState**( ***WeldmentState*** As [WeldmentStateEnum](../WeldmentStateEnum.md), [***Component***] As Variant )
