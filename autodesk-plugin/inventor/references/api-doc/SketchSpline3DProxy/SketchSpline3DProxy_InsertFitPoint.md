# SketchSpline3DProxy.InsertFitPoint Method
...
SketchSpline3DProxy.**InsertFitPoint**( ***FitPoint*** As Object, [***TargetIndex***] As Long, [***InsertBefore***] As Boolean ) As [SketchPoint3D](../SketchPoint3D/SketchPoint3D.md)
