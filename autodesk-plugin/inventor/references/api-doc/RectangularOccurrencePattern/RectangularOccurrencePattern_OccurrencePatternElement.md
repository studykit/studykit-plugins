...
RectangularOccurrencePattern.**OccurrencePatternElement**( ***Row*** As Long, ***Column*** As Long ) As [OccurrencePatternElement](../OccurrencePatternElement/OccurrencePatternElement.md)
