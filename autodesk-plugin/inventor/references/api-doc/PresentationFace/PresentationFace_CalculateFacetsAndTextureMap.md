# PresentationFace.CalculateFacetsAndTextureMap Method
...
PresentationFace.**CalculateFacetsAndTextureMap**( ***Tolerance*** As Double, ***VertexCount*** As Long, ***FacetCount*** As Long, ***VertexCoordinates***() As Double, ***NormalVectors***() As Double, ***VertexIndices***() As Long, ***TextureCoordinates***() As Double )
