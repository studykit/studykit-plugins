...
EmbossFeatures.**Item**( ***Index*** As Variant ) As [EmbossFeature](../EmbossFeature/EmbossFeature.md)

## Property Value

This is a read only property whose value is an [EmbossFeature](../EmbossFeature/EmbossFeature.md).
