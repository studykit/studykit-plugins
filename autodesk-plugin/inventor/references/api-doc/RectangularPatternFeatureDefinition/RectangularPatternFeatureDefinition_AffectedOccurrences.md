# RectangularPatternFeatureDefinition.AffectedOccurrences Property
...
RectangularPatternFeatureDefinition.**AffectedOccurrences**() As [ObjectCollection](../ObjectCollection/ObjectCollection.md)
