# DerivedPartUniformScaleDef.IncludeAllSolids Property
...
DerivedPartUniformScaleDef.**IncludeAllSolids**() As [DerivedComponentOptionEnum](../DerivedComponentOptionEnum.md)
