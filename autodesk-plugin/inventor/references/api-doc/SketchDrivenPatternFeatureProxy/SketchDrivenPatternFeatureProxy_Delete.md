# SketchDrivenPatternFeatureProxy.Delete Method
...
SketchDrivenPatternFeatureProxy.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
