# DetailDrawingView.SetAutomatedCenterlineSettings Method
...
DetailDrawingView.**SetAutomatedCenterlineSettings**( [***AutomatedCenterlineSettings***] As Variant ) As [ObjectsEnumerator](../ObjectsEnumerator/ObjectsEnumerator.md)
