# DetailDrawingView.ReferencedDocumentDescriptor Property
...
DetailDrawingView.**ReferencedDocumentDescriptor**() As [DocumentDescriptor](../DocumentDescriptor/DocumentDescriptor.md)
