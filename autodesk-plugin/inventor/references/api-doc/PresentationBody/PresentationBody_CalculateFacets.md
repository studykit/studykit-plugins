# PresentationBody.CalculateFacets Method
...
PresentationBody.**CalculateFacets**( ***Tolerance*** As Double, ***VertexCount*** As Long, ***FacetCount*** As Long, ***VertexCoordinates***() As Double, ***NormalVectors***() As Double, ***VertexIndices***() As Long )
