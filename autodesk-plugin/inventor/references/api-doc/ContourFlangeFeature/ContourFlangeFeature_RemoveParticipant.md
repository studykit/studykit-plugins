# ContourFlangeFeature.RemoveParticipant Method
...
ContourFlangeFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
