...
ContentTableRow.**Item**( ***Index*** As Variant ) As [ContentTableCell](../ContentTableCell/ContentTableCell.md)

## Property Value

This is a read only property whose value is a [ContentTableCell](../ContentTableCell/ContentTableCell.md).
