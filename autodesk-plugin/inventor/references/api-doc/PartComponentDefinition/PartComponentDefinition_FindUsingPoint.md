# PartComponentDefinition.FindUsingPoint Method
...
PartComponentDefinition.**FindUsingPoint**( ***Point*** As [Point](../Point/Point.md), ***ObjectTypes***() As [SelectionFilterEnum](../SelectionFilterEnum.md), [***ProximityTolerance***] As Variant, [***VisibleObjectsOnly***] As Boolean ) As [ObjectsEnumerator](../ObjectsEnumerator/ObjectsEnumerator.md)
