# SketchDrivenPatternDefinition.AffectedOccurrences Property
...
SketchDrivenPatternDefinition.**AffectedOccurrences**() As [ObjectCollection](../ObjectCollection/ObjectCollection.md)
