# SketchEllipticalArcProxy.SetCustomLineType Method
...
SketchEllipticalArcProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
