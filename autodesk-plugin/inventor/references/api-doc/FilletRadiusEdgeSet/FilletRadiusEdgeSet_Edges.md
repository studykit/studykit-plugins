...
Parent Object: [FilletRadiusEdgeSet](../FilletRadiusEdgeSet/FilletRadiusEdgeSet.md)
...
FilletRadiusEdgeSet.**Edges**() As [EdgeCollection](../EdgeCollection/EdgeCollection.md)
