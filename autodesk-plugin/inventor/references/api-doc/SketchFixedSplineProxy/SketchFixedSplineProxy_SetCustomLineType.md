# SketchFixedSplineProxy.SetCustomLineType Method
...
SketchFixedSplineProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
