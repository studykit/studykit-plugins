# CircularPatternFeatureDefinition.AffectedBodies Property
...
CircularPatternFeatureDefinition.**AffectedBodies**() As [ObjectCollection](../ObjectCollection/ObjectCollection.md)
