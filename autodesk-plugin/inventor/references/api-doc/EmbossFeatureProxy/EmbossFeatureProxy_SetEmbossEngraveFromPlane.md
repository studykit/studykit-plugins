# EmbossFeatureProxy.SetEmbossEngraveFromPlane Method
...
EmbossFeatureProxy.**SetEmbossEngraveFromPlane**( ***Taper*** As Variant, ***ExtentDirection*** As [PartFeatureExtentDirectionEnum](../PartFeatureExtentDirectionEnum.md) )
