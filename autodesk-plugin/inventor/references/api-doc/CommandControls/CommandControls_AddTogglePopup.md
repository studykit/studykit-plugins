# CommandControls.AddTogglePopup Method
...
| ButtonDefinitions | [ObjectCollection](../ObjectCollection/ObjectCollection.md) | Input ObjectCollection containing the ButtonDefinition objects hosted by this control. Use the ButtonDefinition.Pressed property to query whether the toggle is checked or unchecked. |
