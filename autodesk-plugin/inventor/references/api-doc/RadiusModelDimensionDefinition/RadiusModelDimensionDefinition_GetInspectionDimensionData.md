# RadiusModelDimensionDefinition.GetInspectionDimensionData Method
...
RadiusModelDimensionDefinition.**GetInspectionDimensionData**( ***Shape*** As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), ***Label*** As String, ***Rate*** As String )
