...
iPartTableColumn.**Item**( ***Index*** As Variant ) As [iPartTableCell](../iPartTableCell/iPartTableCell.md)

## Property Value

This is a read only property whose value is an [iPartTableCell](../iPartTableCell/iPartTableCell.md).
