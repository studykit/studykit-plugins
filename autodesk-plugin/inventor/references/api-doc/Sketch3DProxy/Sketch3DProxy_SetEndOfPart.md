# Sketch3DProxy.SetEndOfPart Method
...
Sketch3DProxy.**SetEndOfPart**( ***Before*** As Boolean )
...
| Before | Boolean | Input Boolean that indicates if the end of part marker should be immediately before or after this 3D sketch A value of True indicates before and False indicates after. |
