# RuleFilletFeatureProxy.GetSuppressionCondition Method
...
RuleFilletFeatureProxy.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
