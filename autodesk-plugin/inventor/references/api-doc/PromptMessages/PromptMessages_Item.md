...
PromptMessages.**Item**( ***Index*** As Variant ) As [PromptMessage](../PromptMessage/PromptMessage.md)

## Property Value

This is a read only property whose value is a [PromptMessage](../PromptMessage/PromptMessage.md).
