# MiniToolbarControls.AddButton Method
...
MiniToolbarControls.**AddButton**( ***InternalName*** As String, ***DisplayName*** As String, ***ToolTipText*** As String, [***StandardIcon***] As Variant, [***LargeIcon***] As Variant ) As [MiniToolbarButton](../MiniToolbarButton/MiniToolbarButton.md)
...
| LargeIcon | Variant | Optional input IPictureDisp that specifies the icon to use for the control. A standard size icon is 24 pixels wide and 24 pixels high.   This is an optional argument whose default value is null. |
