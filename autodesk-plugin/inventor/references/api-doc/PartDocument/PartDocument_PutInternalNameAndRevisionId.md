# PartDocument.PutInternalNameAndRevisionId Method
...
PartDocument.**PutInternalNameAndRevisionId**( ***InternalNameToken*** As String, ***RevisionIdToken*** As String, ***InternalName*** As String, ***RevisionId*** As String )
