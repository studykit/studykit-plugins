# DecalFeature.GetSuppressionCondition Method

Parent Object: [DecalFeature](../DecalFeature/DecalFeature.md)
...
DecalFeature.**GetSuppressionCondition**( ***Parameter*** As [Parameter](../Parameter/Parameter.md), ***ComparisonType*** As [ComparisonTypeEnum](../ComparisonTypeEnum.md), ***Expression*** As Variant ) As Boolean
