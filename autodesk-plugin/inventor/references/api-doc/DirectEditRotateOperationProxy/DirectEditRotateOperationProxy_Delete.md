# DirectEditRotateOperationProxy.Delete Method
...
DirectEditRotateOperationProxy.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
