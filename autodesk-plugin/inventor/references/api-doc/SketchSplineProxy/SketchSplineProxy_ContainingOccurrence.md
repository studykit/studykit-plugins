# SketchSplineProxy.ContainingOccurrence Property
...
SketchSplineProxy.**ContainingOccurrence**() As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md)
