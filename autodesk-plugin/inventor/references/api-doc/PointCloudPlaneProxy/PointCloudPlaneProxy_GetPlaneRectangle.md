...
PointCloudPlaneProxy.**GetPlaneRectangle**( ***Plane*** As [Plane](../Plane/Plane.md), ***LengthDirection*** As [UnitVector](../UnitVector/UnitVector.md), ***Length*** As Double, ***Height*** As Double )
