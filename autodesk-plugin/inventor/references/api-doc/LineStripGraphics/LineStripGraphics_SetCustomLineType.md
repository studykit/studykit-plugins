# LineStripGraphics.SetCustomLineType Method
...
LineStripGraphics.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
