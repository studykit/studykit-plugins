...
UserParameter.**ParameterType**() As [ParameterTypeEnum](../ParameterTypeEnum.md)

## Property Value

This is a read only property whose value is a [ParameterTypeEnum](../ParameterTypeEnum.md).
