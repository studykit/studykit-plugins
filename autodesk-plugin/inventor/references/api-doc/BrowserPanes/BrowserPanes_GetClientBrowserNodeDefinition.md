...
BrowserPanes.**GetClientBrowserNodeDefinition**( ***ClientId*** As String, ***Id*** As Long ) As [ClientBrowserNodeDefinition](../ClientBrowserNodeDefinition/ClientBrowserNodeDefinition.md)
