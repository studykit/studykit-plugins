# CircularPatternFeature.AppearanceSourceType Property
...
CircularPatternFeature.**AppearanceSourceType**() As [AppearanceSourceTypeEnum](../AppearanceSourceTypeEnum.md)
