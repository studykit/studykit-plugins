# RadiusGeneralDimension.GetInspectionDimensionData Method
...
RadiusGeneralDimension.**GetInspectionDimensionData**( ***Shape*** As [InspectionDimensionShapeEnum](../InspectionDimensionShapeEnum.md), ***Label*** As String, ***Rate*** As String )
