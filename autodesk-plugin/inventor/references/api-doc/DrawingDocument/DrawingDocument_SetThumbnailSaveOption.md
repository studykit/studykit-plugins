# DrawingDocument.SetThumbnailSaveOption Method
...
DrawingDocument.**SetThumbnailSaveOption**( ***SaveOption*** As [ThumbnailSaveOptionEnum](../ThumbnailSaveOptionEnum.md), [***ImageFullFileName***] As String )
