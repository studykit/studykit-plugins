# SketchRectangularPatternDefinition.XCount Property
...
Gets and sets the number of instances in the X direction.

## Syntax

SketchRectangularPatternDefinition.**XCount**() As Variant
