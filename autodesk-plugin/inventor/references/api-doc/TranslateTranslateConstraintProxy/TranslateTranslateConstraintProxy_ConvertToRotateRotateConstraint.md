# TranslateTranslateConstraintProxy.ConvertToRotateRotateConstraint Method
...
TranslateTranslateConstraintProxy.**ConvertToRotateRotateConstraint**( ***EntityOne*** As Object, ***EntityTwo*** As Object, ***Ratio*** As Variant, ***ForwardDirection*** As Boolean, [***BiasPointOne***] As Variant, [***BiasPointTwo***] As Variant ) As [RotateRotateConstraint](../RotateRotateConstraint/RotateRotateConstraint.md)
