...
TranslateTranslateConstraintProxy.**ConvertToInsertConstraint**( ***EntityOne*** As Object, ***EntityTwo*** As Object, ***AxesOpposed*** As Boolean, ***Distance*** As Variant, [***BiasPointOne***] As Variant, [***BiasPointTwo***] As Variant ) As [InsertConstraint](../InsertConstraint/InsertConstraint.md)
