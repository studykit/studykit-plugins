# DirectEditSizeOperationProxy.Delete Method
...
DirectEditSizeOperationProxy.**Delete**( [***RetainConsumedSketches***] As Boolean, [***RetainDependentFeaturesAndSketches***] As Boolean, [***RetainDependentWorkFeatures***] As Boolean )
