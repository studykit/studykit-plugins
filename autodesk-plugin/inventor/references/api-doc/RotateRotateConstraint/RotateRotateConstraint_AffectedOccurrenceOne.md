# RotateRotateConstraint.AffectedOccurrenceOne Property
...
RotateRotateConstraint.**AffectedOccurrenceOne**() As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md)
