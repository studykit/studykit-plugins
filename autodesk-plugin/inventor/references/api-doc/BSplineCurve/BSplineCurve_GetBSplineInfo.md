...
BSplineCurve.**GetBSplineInfo**( ***Order*** As Long, ***NumPoles*** As Long, ***NumKnots*** As Long, ***IsRational*** As Boolean, ***IsPeriodic*** As Boolean, ***IsClosed*** As Boolean, ***IsPlanar*** As Boolean, ***PlaneVector***() As Double )
