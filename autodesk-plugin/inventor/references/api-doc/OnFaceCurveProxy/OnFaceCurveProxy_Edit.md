...
OnFaceCurveProxy.**Edit**( ***Faces*** As [NameValueMap](../NameValueMap/NameValueMap.md), ***FitPoints*** As [NameValueMap](../NameValueMap/NameValueMap.md) )
