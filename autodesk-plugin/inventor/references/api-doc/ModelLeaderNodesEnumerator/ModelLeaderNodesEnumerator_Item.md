...
Parent Object: [ModelLeaderNodesEnumerator](../ModelLeaderNodesEnumerator/ModelLeaderNodesEnumerator.md)
...
ModelLeaderNodesEnumerator.**Item**( ***Index*** As Variant ) As [ModelLeaderNode](../ModelLeaderNode/ModelLeaderNode.md)

## Property Value

This is a read only property whose value is a [ModelLeaderNode](../ModelLeaderNode/ModelLeaderNode.md).
