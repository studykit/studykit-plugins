# NonParametricBaseFeatureProxy.AppearanceSourceType Property
...
NonParametricBaseFeatureProxy.**AppearanceSourceType**() As [AppearanceSourceTypeEnum](../AppearanceSourceTypeEnum.md)
