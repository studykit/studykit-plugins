# RotateTranslateConstraint.ConvertToCustomConstraint Method
...
RotateTranslateConstraint.**ConvertToCustomConstraint**( ***EntityOne*** As Object, ***EntityTwo*** As Object, ***ClientId*** As String ) As [CustomConstraint](CustomConstraint.md)
