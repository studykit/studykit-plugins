# RuledSurfaceFeature.RemoveParticipant Method
...
RuledSurfaceFeature.**RemoveParticipant**( ***Occurrence*** As [ComponentOccurrence](../ComponentOccurrence/ComponentOccurrence.md) )
