# SearchBoxEvents.OnStartSearch Event

Parent Object: [SearchBoxEvents](../SearchBoxEvents/SearchBoxEvents.md)

## Description

Event that fires just after the search is started.

## Syntax

SearchBoxEvents.**OnStartSearch**( ***HandlingCode*** As [HandlingCodeEnum](../HandlingCodeEnum.md) )
