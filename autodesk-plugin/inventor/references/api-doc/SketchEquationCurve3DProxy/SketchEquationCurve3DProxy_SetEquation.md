# SketchEquationCurve3DProxy.SetEquation Method
...
SketchEquationCurve3DProxy.**SetEquation**( ***CoordinateSystemType*** As [CoordinateSystemTypeEnum](../CoordinateSystemTypeEnum.md), ***XValueOrRadius*** As String, ***YValueOrTheta*** As String, ***ZValueOrPhi*** As String, ***MinValue*** As Variant, ***MaxValue*** As Variant )
