...
Parent Object: [DrawingBOMRows](../DrawingBOMRows/DrawingBOMRows.md)
...
DrawingBOMRows.**Item**( ***Index*** As Long ) As [DrawingBOMRow](../DrawingBOMRow/DrawingBOMRow.md)

## Property Value

This is a read only property whose value is a [DrawingBOMRow](../DrawingBOMRow/DrawingBOMRow.md).
