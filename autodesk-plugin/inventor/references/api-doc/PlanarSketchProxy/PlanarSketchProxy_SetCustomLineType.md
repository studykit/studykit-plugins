# PlanarSketchProxy.SetCustomLineType Method
...
PlanarSketchProxy.**SetCustomLineType**( ***FullFileName*** As String, ***LineTypeName*** As String, ***ReplaceExisting*** As Boolean )
