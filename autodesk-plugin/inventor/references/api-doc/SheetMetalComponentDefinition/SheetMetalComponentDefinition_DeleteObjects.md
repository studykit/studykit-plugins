...
SheetMetalComponentDefinition.**DeleteObjects**( ***Objects*** As [ObjectCollection](../ObjectCollection/ObjectCollection.md), [***RetainConsumedSketches***] As Boolean, [***RetainDepFeatsAndSketches***] As Boolean, [***RetainDepWorkFeats***] As Boolean )
