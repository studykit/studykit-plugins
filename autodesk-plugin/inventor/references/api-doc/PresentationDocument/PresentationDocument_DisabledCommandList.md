# PresentationDocument.DisabledCommandList Property
...
PresentationDocument.**DisabledCommandList**() As [DisabledCommandList](../DisabledCommandList/DisabledCommandList.md)

## Property Value

This is a read only property whose value is a [DisabledCommandList](../DisabledCommandList/DisabledCommandList.md).
