    ...
    def _apply_state_transition(
        ...
        if not transition_name:
            raise ProviderOperationError(
                ...
                f"providers.issues.state_transitions.{verb} is confirmed into .spectrack/config.yml."
            )
        ...
        if transition_id is None:
            raise ProviderOperationError(
                ...
                f"configure providers.issues.state_transitions.{verb} in .spectrack/config.yml."
            )
...
def create_remote_link(
    ...
    *,
    ...
    if application_type or application_name:
        payload["application"] = {
            "type": application_type or "studykit.spectrack",
